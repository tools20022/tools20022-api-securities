...
/**
 * <b>Scope</b><br>
 * The PortfolioTransferInstruction message is sent by an instructing party, for
 * example, a (new) plan manager (transferee), to the executing party, for
 ...
 * financial instruments from the client’s account at the old plan manager
 ...
 * messageDefinitionIdentifier} = {@code sese.012.001.08}</li>
 * <li>{@linkplain com.tools20022.metamodel.MMRepositoryConcept#getConstraint
 * constraint} =
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintNomineeAccountServicerRule#for_sese_PortfolioTransferInstructionV08
 * ConstraintNomineeAccountServicerRule.for_sese_PortfolioTransferInstructionV08
 * }</li>
 * <li>
 ...
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintInvestorRule#for_sese_PortfolioTransferInstructionV08
 * ConstraintInvestorRule.for_sese_PortfolioTransferInstructionV08}</li>
 * <li>
...
@XmlType(name = "PortfolioTransferInstructionV08", propOrder = {"messageReference", "poolReference", "previousReference", "relatedReference", "primaryIndividualInvestor", "secondaryIndividualInvestor", "otherIndividualInvestor",
...
public class PortfolioTransferInstructionV08 {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, MessageIdentification1> mmMessageReference = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, MessageIdentification1>() {
		{
			xmlTag = "MsgRef";
		...
		@Override
		public MessageIdentification1 getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getMessageReference();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, MessageIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<AdditionalReference9>> mmPoolReference = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<AdditionalReference9>>() {
		{
			xmlTag = "PoolRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "PoolReference";
		...
		@Override
		public Optional<AdditionalReference9> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getPoolReference();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, Optional<AdditionalReference9> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<AdditionalReference8>> mmPreviousReference = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<AdditionalReference8>>() {
		{
			xmlTag = "PrvsRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<AdditionalReference8> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getPreviousReference();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, Optional<AdditionalReference8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<AdditionalReference8>> mmRelatedReference = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<AdditionalReference8>>() {
		{
			xmlTag = "RltdRef";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<IndividualPerson8>> mmPrimaryIndividualInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<IndividualPerson8>>() {
		{
		...
		@Override
		public Optional<IndividualPerson8> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getPrimaryIndividualInvestor();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, Optional<IndividualPerson8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<IndividualPerson8>> mmSecondaryIndividualInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<IndividualPerson8>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<IndividualPerson8>> mmOtherIndividualInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<IndividualPerson8>>() {
		{
		...
		@Override
		public List<IndividualPerson8> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getOtherIndividualInvestor();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, List<IndividualPerson8> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<Organisation31>> mmPrimaryCorporateInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<Organisation31>>() {
		{
		...
		@Override
		public Optional<Organisation31> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getPrimaryCorporateInvestor();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, Optional<Organisation31> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<Organisation31>> mmSecondaryCorporateInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<Organisation31>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<Organisation31>> mmOtherCorporateInvestor = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<Organisation31>>() {
		{
		...
		@Override
		public List<Organisation31> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getOtherCorporateInvestor();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, List<Organisation31> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Account24> mmTransferorAccount = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Account24>() {
		{
			xmlTag = "TrfrAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Account24 getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getTransferorAccount();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, Account24 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<Account24>> mmNomineeAccount = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<Account24>>() {
		{
			xmlTag = "NmneeAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "NomineeAccount";
		...
		@Override
		public Optional<Account24> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getNomineeAccount();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, Optional<Account24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, PartyIdentification113> mmTransferee = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, PartyIdentification113>() {
		{
			xmlTag = "Trfee";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Transferee";
		...
		@Override
		public PartyIdentification113 getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getTransferee();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, PartyIdentification113 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<Intermediary41>> mmIntermediaryInformation = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<Intermediary41>>() {
		{
			xmlTag = "IntrmyInf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public List<Intermediary41> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getIntermediaryInformation();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, List<Intermediary41> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<CashAccount201>> mmCashAccount = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<CashAccount201>>() {
		{
			xmlTag = "CshAcct";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "CashAccount";
		...
		@Override
		public Optional<CashAccount201> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getCashAccount();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, Optional<CashAccount201> value) {
			obj.setCashAccount(value.orElse(null));
		}
	};
	@XmlElement(name = "PdctTrf", required = true)
	protected List<ISATransfer29> productTransfer;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMMessageBuildingBlock#getComplexType
	 * complexType} = {@linkplain com.tools20022.repository.msg.ISATransfer29
	 * ISATransfer29}</li>
	 * <li>{@linkplain com.tools20022.metamodel.MMMessageConstruct#getXmlTag
	 * xmlTag} = "PdctTrf"</li>
	 * <li>
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<ISATransfer29>> mmProductTransfer = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<ISATransfer29>>() {
		{
			xmlTag = "PdctTrf";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			...
			definition = "Provides information related to the asset(s) transferred.";
			minOccurs = 1;
			complexType_lazy = () -> ISATransfer29.mmObject();
		}

		@Override
		public List<ISATransfer29> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getProductTransfer();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, List<ISATransfer29> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<MarketPracticeVersion1>> mmMarketPracticeVersion = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, Optional<MarketPracticeVersion1>>() {
		{
			xmlTag = "MktPrctcVrsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
		...
		@Override
		public Optional<MarketPracticeVersion1> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getMarketPracticeVersion();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, Optional<MarketPracticeVersion1> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<Extension1>> mmExtension = new MMMessageBuildingBlock<PortfolioTransferInstructionV08, List<Extension1>>() {
		{
			xmlTag = "Xtnsn";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Extension";
		...
		@Override
		public List<Extension1> getValue(PortfolioTransferInstructionV08 obj) {
			return obj.getExtension();
		}

		@Override
		public void setValue(PortfolioTransferInstructionV08 obj, List<Extension1> value) {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintNomineeAccountServicerRule.for_sese_PortfolioTransferInstructionV08,
						com.tools20022.repository.constraints.ConstraintPortfolioRule.for_sese_PortfolioTransferInstructionV08, com.tools20022.repository.constraints.ConstraintInvestorRule.for_sese_PortfolioTransferInstructionV08,
						com.tools20022.repository.constraints.ConstraintCorporateRule.for_sese_PortfolioTransferInstructionV08, com.tools20022.repository.constraints.ConstraintDesignationRule.for_sese_PortfolioTransferInstructionV08,
						com.tools20022.repository.constraints.ConstraintISARule.for_sese_PortfolioTransferInstructionV08);
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmMessageReference, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmPoolReference,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmPreviousReference, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmRelatedReference,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmPrimaryIndividualInvestor, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmSecondaryIndividualInvestor,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmOtherIndividualInvestor, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmPrimaryCorporateInvestor,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmSecondaryCorporateInvestor, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmOtherCorporateInvestor,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmTransferorAccount, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmNomineeAccount,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmTransferee, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmIntermediaryInformation,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmCashAccount, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmProductTransfer,
						com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmMarketPracticeVersion, com.tools20022.repository.area.sese.PortfolioTransferInstructionV08.mmExtension);
			...
			public Class<?> getInstanceClass() {
				return PortfolioTransferInstructionV08.class;
			}
		});
	...
	public PortfolioTransferInstructionV08 setMessageReference(MessageIdentification1 messageReference) {
	...
	public PortfolioTransferInstructionV08 setPoolReference(AdditionalReference9 poolReference) {
	...
	public PortfolioTransferInstructionV08 setPreviousReference(AdditionalReference8 previousReference) {
	...
	public PortfolioTransferInstructionV08 setRelatedReference(AdditionalReference8 relatedReference) {
	...
	public PortfolioTransferInstructionV08 setPrimaryIndividualInvestor(IndividualPerson8 primaryIndividualInvestor) {
	...
	public PortfolioTransferInstructionV08 setSecondaryIndividualInvestor(IndividualPerson8 secondaryIndividualInvestor) {
	...
	public PortfolioTransferInstructionV08 setOtherIndividualInvestor(List<IndividualPerson8> otherIndividualInvestor) {
	...
	public PortfolioTransferInstructionV08 setPrimaryCorporateInvestor(Organisation31 primaryCorporateInvestor) {
	...
	public PortfolioTransferInstructionV08 setSecondaryCorporateInvestor(Organisation31 secondaryCorporateInvestor) {
	...
	public PortfolioTransferInstructionV08 setOtherCorporateInvestor(List<Organisation31> otherCorporateInvestor) {
	...
	public PortfolioTransferInstructionV08 setTransferorAccount(Account24 transferorAccount) {
	...
	public PortfolioTransferInstructionV08 setNomineeAccount(Account24 nomineeAccount) {
	...
	public PortfolioTransferInstructionV08 setTransferee(PartyIdentification113 transferee) {
	...
	public PortfolioTransferInstructionV08 setIntermediaryInformation(List<Intermediary41> intermediaryInformation) {
	...
	public PortfolioTransferInstructionV08 setCashAccount(CashAccount201 cashAccount) {
		this.cashAccount = cashAccount;
		return this;
	}

	public List<ISATransfer29> getProductTransfer() {
		return productTransfer == null ? productTransfer = new ArrayList<>() : productTransfer;
	}

	public PortfolioTransferInstructionV08 setProductTransfer(List<ISATransfer29> productTransfer) {
	...
	public PortfolioTransferInstructionV08 setMarketPracticeVersion(MarketPracticeVersion1 marketPracticeVersion) {
	...
	public PortfolioTransferInstructionV08 setExtension(List<Extension1> extension) {
	...
	static public class Document {
		...
		public PortfolioTransferInstructionV08 messageBody;
	}
}