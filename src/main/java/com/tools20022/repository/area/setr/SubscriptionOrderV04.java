...
public class SubscriptionOrderV04 {
	...
	public void setMultipleOrderDetails(SubscriptionMultipleOrder6 multipleOrderDetails) {
	...
	@XmlRootElement(namespace = "urn:iso:std:iso:20022:tech:xsd:setr.010.04.04")
