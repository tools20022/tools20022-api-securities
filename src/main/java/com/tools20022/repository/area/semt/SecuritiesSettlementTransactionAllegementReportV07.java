 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.constraints.ConstraintAllegementDetailsActivityRule1#for_semt_SecuritiesSettlementTransactionAllegementReportV07
...
public class SecuritiesSettlementTransactionAllegementReportV07 {
	...
	final static public MMMessageDefinition mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageDefinition() {
			{
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAllegementDetailsActivityRule1.for_semt_SecuritiesSettlementTransactionAllegementReportV07,
						com.tools20022.repository.constraints.ConstraintAllegementDetailsActivityRule2.for_semt_SecuritiesSettlementTransactionAllegementReportV07);
