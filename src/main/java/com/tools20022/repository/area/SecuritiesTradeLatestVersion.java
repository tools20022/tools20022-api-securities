		...
		mmObject_lazy.compareAndSet(null, new MMBusinessArea() {
			{
				...
				code = "setr";
				messageDefinition_lazy = () -> Arrays.asList(SecuritiesTradeConfirmationCancellationV01.mmObject(), SecuritiesTradeConfirmationResponseV01.mmObject(), SecuritiesTradeConfirmationV03.mmObject(),
						SecuritiesTradeConfirmationStatusAdviceV02.mmObject(), SubscriptionBulkOrderConfirmationV04.mmObject(), RedemptionBulkOrderV04.mmObject(), SubscriptionBulkOrderCancellationRequestV04.mmObject(),
