...
/**
 * If the transaction is a securities borrowing and no standing settlement
 * instruction applies, then DeliveringDepository and Party1 must be present.
 */
public class ConstraintDeliveringDepositoryAndParty1Part2Rule {
	 ...
	 * name} = "DeliveringDepositoryAndParty1Part2Rule"</li>
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} =
	 * "If the transaction is a securities borrowing and no standing settlement instruction applies, then DeliveringDepository and Party1 must be present."
	 * </li>
	 * </ul>
	 */
