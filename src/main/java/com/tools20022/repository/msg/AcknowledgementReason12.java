...
public class AcknowledgementReason12 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> AcknowledgementReason12.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgementReason12.mmCode, AcknowledgementReason12.mmAdditionalReasonInformation);
	...
	public void setCode(AcknowledgementReason15Choice code) {
		this.code = code;
	}
