...
public class CommissionWaiver4 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CommissionWaiver4.mmInstructionBasis, CommissionWaiver4.mmWaivedRate);
	...
	public void setInstructionBasis(WaivingInstruction1Choice instructionBasis) {
