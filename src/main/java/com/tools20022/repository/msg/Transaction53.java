...
@XmlType(name = "Transaction53", propOrder = {"accountOwnerTransactionIdentification", "accountServicerTransactionIdentification", "marketInfrastructureTransactionIdentification", "processorTransactionIdentification",
...
public class Transaction53 {
	...
	public static final MMMessageAttribute mmAccountOwnerTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Transaction53.mmObject();
			isDerived = false;
			xmlTag = "AcctOwnrTxId";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transaction53.mmAccountOwnerTransactionIdentification, Transaction53.mmAccountServicerTransactionIdentification, Transaction53.mmMarketInfrastructureTransactionIdentification,
						Transaction53.mmProcessorTransactionIdentification, Transaction53.mmTradeIdentification, Transaction53.mmPoolIdentification, Transaction53.mmCommonIdentification, Transaction53.mmCorporateActionEventIdentification,
						Transaction53.mmTripartyAgentServiceProviderCollateralTransactionIdentification, Transaction53.mmClientTripartyCollateralTransactionIdentification, Transaction53.mmClientCollateralInstructionIdentification,
						Transaction53.mmTripartyAgentServiceProviderCollateralInstructionIdentification, Transaction53.mmTransactionDetails, Transaction53.mmStatusAndReason);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPendingReportV08.mmTransactions);
