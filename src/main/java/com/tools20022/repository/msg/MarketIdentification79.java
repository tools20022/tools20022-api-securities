...
public class MarketIdentification79 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.MarketIdentification79.mmIdentification, com.tools20022.repository.msg.MarketIdentification79.mmType);
				trace_lazy = () -> TradingMarket.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintPlaceOfTradeRule.forMarketIdentification79,
						com.tools20022.repository.constraints.ConstraintIdentificationPresenceRule.forMarketIdentification79, com.tools20022.repository.constraints.ConstraintMarketTypeAndIdentificationRule.forMarketIdentification79);
	...
	public MarketIdentification79 setIdentification(MarketIdentification3Choice identification) {
	...
	public MarketIdentification79 setType(MarketType11Choice type) {
		this.type = type;
		return this;
	}
}