...
@XmlType(name = "SettlementDetails125", propOrder = {"holdIndicator", "securitiesTransactionType", "settlementTransactionCondition", "partialSettlementIndicator", "beneficialOwnership", "cashClearingSystem", "marketClientSide",
...
public class SettlementDetails125 {
	...
	public static final MMMessageAttribute mmHoldIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementDetails125.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
	...
	protected SecuritiesTransactionType33Choice securitiesTransactionType;
	/**
	...
	public static final MMMessageAssociationEnd mmSecuritiesTransactionType = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> SecuritiesTransactionType33Choice.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails125.mmHoldIndicator, SettlementDetails125.mmSecuritiesTransactionType, SettlementDetails125.mmSettlementTransactionCondition,
						SettlementDetails125.mmPartialSettlementIndicator, SettlementDetails125.mmBeneficialOwnership, SettlementDetails125.mmCashClearingSystem, SettlementDetails125.mmMarketClientSide, SettlementDetails125.mmRegistration,
						SettlementDetails125.mmRepurchaseType, SettlementDetails125.mmSecuritiesRTGS, SettlementDetails125.mmStampDutyTaxBasis);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionAllegementNotificationV06.mmSettlementParameters);
	...
	public SecuritiesTransactionType33Choice getSecuritiesTransactionType() {
		return securitiesTransactionType;
	}

	public void setSecuritiesTransactionType(SecuritiesTransactionType33Choice securitiesTransactionType) {
	...
	public void setSettlementTransactionCondition(List<SettlementTransactionCondition17Choice> settlementTransactionCondition) {
	...
	public RepurchaseType13Choice getRepurchaseType() {
		return repurchaseType;
	}

	public void setRepurchaseType(RepurchaseType13Choice repurchaseType) {
