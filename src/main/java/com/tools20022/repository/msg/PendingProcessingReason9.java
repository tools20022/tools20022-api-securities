...
public class PendingProcessingReason9 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingProcessingReason9.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingReason9.mmCode, PendingProcessingReason9.mmAdditionalReasonInformation);
	...
	public void setCode(PendingProcessingReason11Choice code) {
		this.code = code;
	}
