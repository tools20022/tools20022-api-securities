		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionConfirmationV07.mmQuantityAndAccountDetails, SecuritiesSettlementTransactionReversalAdviceV06.mmQuantityAndAccountDetails);
