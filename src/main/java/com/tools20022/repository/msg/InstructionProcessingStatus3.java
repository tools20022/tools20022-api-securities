...
import com.tools20022.repository.codeset.Status7Code;
...
@XmlType(name = "InstructionProcessingStatus3", propOrder = {"status", "additionalInformation"})
public class InstructionProcessingStatus3 {
	 ...
	 * simpleType} = {@linkplain com.tools20022.repository.codeset.Status7Code
	 * Status7Code}</li>
	 * <li>
	...
	public InstructionProcessingStatus3 setStatus(Status7Code status) {
	...
	public InstructionProcessingStatus3 setAdditionalInformation(Max350Text additionalInformation) {
