...
public class RateTypeAndAmountAndStatus27 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RateTypeAndAmountAndStatus27.mmRateType, RateTypeAndAmountAndStatus27.mmAmount, RateTypeAndAmountAndStatus27.mmRateStatus);
	...
	public void setRateType(RateType37Choice rateType) {
