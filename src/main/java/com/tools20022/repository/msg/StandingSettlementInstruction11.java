		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingInstructionV07.mmStandingSettlementInstructionDetails, SecuritiesSettlementTransactionConfirmationV07.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionReversalAdviceV06.mmStandingSettlementInstructionDetails, SecuritiesFinancingConfirmationV07.mmStandingSettlementInstructionDetails,
						SecuritiesSettlementTransactionInstructionV07.mmStandingSettlementInstructionDetails);
