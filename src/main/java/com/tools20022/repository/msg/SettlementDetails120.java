...
@XmlType(name = "SettlementDetails120", propOrder = {"holdIndicator", "priority", "securitiesTransactionType", "settlementTransactionCondition", "partialSettlementIndicator", "beneficialOwnership", "blockTrade", "CCPEligibility",
...
public class SettlementDetails120 {
	...
	public static final MMMessageAssociationEnd mmHoldIndicator = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SettlementDetails120.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails120.mmHoldIndicator, SettlementDetails120.mmPriority, SettlementDetails120.mmSecuritiesTransactionType, SettlementDetails120.mmSettlementTransactionCondition,
						SettlementDetails120.mmPartialSettlementIndicator, SettlementDetails120.mmBeneficialOwnership, SettlementDetails120.mmBlockTrade, SettlementDetails120.mmCCPEligibility, SettlementDetails120.mmDeliveryReturnReason,
						SettlementDetails120.mmCashClearingSystem, SettlementDetails120.mmExposureType, SettlementDetails120.mmFXStandingInstruction, SettlementDetails120.mmMarketClientSide, SettlementDetails120.mmNettingEligibility,
						SettlementDetails120.mmRegistration, SettlementDetails120.mmRepurchaseType, SettlementDetails120.mmLegalRestrictions, SettlementDetails120.mmSecuritiesRTGS, SettlementDetails120.mmSettlingCapacity,
						SettlementDetails120.mmSettlementSystemMethod, SettlementDetails120.mmTaxCapacity, SettlementDetails120.mmStampDutyTaxBasis, SettlementDetails120.mmTracking, SettlementDetails120.mmAutomaticBorrowing,
						SettlementDetails120.mmLetterOfGuarantee, SettlementDetails120.mmReturnLeg, SettlementDetails120.mmModificationCancellationAllowed, SettlementDetails120.mmEligibleForCollateral,
						SettlementDetails120.mmSecuritiesSubBalanceType, SettlementDetails120.mmCashSubBalanceType);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionGenerationNotificationV07.mmSettlementParameters);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.mmdataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails120";
