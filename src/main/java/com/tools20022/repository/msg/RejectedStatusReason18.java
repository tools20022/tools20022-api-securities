...
import com.tools20022.repository.choice.RejectedReason14Choice;
...
@XmlType(name = "RejectedStatusReason18", propOrder = {"reasonCode", "additionalReasonInformation"})
public class RejectedStatusReason18 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected RejectedReason14Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectedStatusReason18.mmReasonCode, com.tools20022.repository.msg.RejectedStatusReason18.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forRejectedStatusReason18);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectedStatusReason18";
	...
	public RejectedReason14Choice getReasonCode() {
		return reasonCode;
	}

	public RejectedStatusReason18 setReasonCode(RejectedReason14Choice reasonCode) {
	...
	public RejectedStatusReason18 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
