...
public class RejectedStatusReason18 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason18.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatusReason18.mmReasonCode, RejectedStatusReason18.mmAdditionalReasonInformation);
	...
	public void setReasonCode(RejectedReason14Choice reasonCode) {
