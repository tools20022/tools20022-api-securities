		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementReversalAdviceV09.mmOtherDocumentIdentification, CorporateActionNotificationV08.mmOtherDocumentIdentification,
						CorporateActionInstructionV08.mmOtherDocumentIdentification, CorporateActionMovementConfirmationV09.mmOtherDocumentIdentification, CorporateActionMovementPreliminaryAdviceV09.mmOtherDocumentIdentification);
