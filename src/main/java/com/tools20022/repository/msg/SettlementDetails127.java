...
public class SettlementDetails127 {
	...
	public static final MMMessageAttribute mmHoldIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SettlementDetails127.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails127.mmHoldIndicator, SettlementDetails127.mmSettlementTransactionCondition, SettlementDetails127.mmSettlingCapacity, SettlementDetails127.mmStampDutyTaxBasis,
						SettlementDetails127.mmSecuritiesRTGS, SettlementDetails127.mmRegistration, SettlementDetails127.mmBeneficialOwnership, SettlementDetails127.mmCashClearingSystem, SettlementDetails127.mmTaxCapacity,
						SettlementDetails127.mmRepurchaseType, SettlementDetails127.mmMarketClientSide, SettlementDetails127.mmBlockTrade, SettlementDetails127.mmLegalRestrictions, SettlementDetails127.mmSettlementSystemMethod,
						SettlementDetails127.mmNettingEligibility, SettlementDetails127.mmCCPEligibility, SettlementDetails127.mmLetterOfGuarantee, SettlementDetails127.mmPartialSettlementIndicator);
