...
public class RejectionReason26 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionReason26.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionReason26.mmCode, RejectionReason26.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionReason24Choice code) {
		this.code = code;
	}
