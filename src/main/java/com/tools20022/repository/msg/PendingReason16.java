...
public class PendingReason16 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingReason16.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingReason16.mmCode, PendingReason16.mmAdditionalReasonInformation);
	...
	public void setCode(PendingReason28Choice code) {
		this.code = code;
	}
