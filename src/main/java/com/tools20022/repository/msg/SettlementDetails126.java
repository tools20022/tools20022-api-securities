...
@XmlType(name = "SettlementDetails126", propOrder = {"settlementTransactionCondition", "settlingCapacity", "stampDutyTaxBasis", "securitiesRTGS", "registration", "beneficialOwnership", "cashClearingSystem", "taxCapacity", "repurchaseType",
...
public class SettlementDetails126 {
	...
	public static final MMMessageAssociationEnd mmSettlementTransactionCondition = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SettlementDetails126.mmObject();
			isDerived = false;
			xmlTag = "SttlmTxCond";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails126.mmSettlementTransactionCondition, SettlementDetails126.mmSettlingCapacity, SettlementDetails126.mmStampDutyTaxBasis, SettlementDetails126.mmSecuritiesRTGS,
						SettlementDetails126.mmRegistration, SettlementDetails126.mmBeneficialOwnership, SettlementDetails126.mmCashClearingSystem, SettlementDetails126.mmTaxCapacity, SettlementDetails126.mmRepurchaseType,
						SettlementDetails126.mmMarketClientSide, SettlementDetails126.mmBlockTrade, SettlementDetails126.mmLegalRestrictions, SettlementDetails126.mmSettlementSystemMethod, SettlementDetails126.mmNettingEligibility,
						SettlementDetails126.mmCCPEligibility, SettlementDetails126.mmLetterOfGuarantee, SettlementDetails126.mmPartialSettlementIndicator);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.mmdataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails126";
