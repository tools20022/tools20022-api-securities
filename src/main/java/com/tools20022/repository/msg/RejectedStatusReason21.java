...
public class RejectedStatusReason21 {
	...
	public static final MMMessageAssociationEnd mmReasonCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectedStatusReason21.mmObject();
			isDerived = false;
			xmlTag = "RsnCd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatusReason21.mmReasonCode, RejectedStatusReason21.mmAdditionalReasonInformation);
	...
	public void setReasonCode(RejectedReason22Choice reasonCode) {
