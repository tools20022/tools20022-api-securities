 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption56#mmExemptionType
 * CashOption56.mmExemptionType}</li>
 * <li>
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption56#mmAmountDetails
 ...
 * <li>{@linkplain com.tools20022.repository.msg.CashOption56#mmPriceDetails
...
@XmlType(name = "CashOption56", propOrder = {"creditDebitIndicator", "nonEligibleProceedsIndicator", "issuerOfferorTaxabilityIndicator", "incomeType", "exemptionType", "countryOfIncomeSource", "cashAccountIdentification", "amountDetails",
...
public class CashOption56 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption56, CreditDebitCode> mmCreditDebitIndicator = new MMMessageAttribute<CashOption56, CreditDebitCode>() {
		{
			businessElementTrace_lazy = () -> ProceedsDefinition.mmCreditDebitIndicator;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption56.mmObject();
			isDerived = false;
			xmlTag = "CdtDbtInd";
		...
		@Override
		public CreditDebitCode getValue(CashOption56 obj) {
			return obj.getCreditDebitIndicator();
		}

		@Override
		public void setValue(CashOption56 obj, CreditDebitCode value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, Optional<NonEligibleProceedsIndicator3Choice>> mmNonEligibleProceedsIndicator = new MMMessageAssociationEnd<CashOption56, Optional<NonEligibleProceedsIndicator3Choice>>() {
		{
		...
		@Override
		public Optional<NonEligibleProceedsIndicator3Choice> getValue(CashOption56 obj) {
			return obj.getNonEligibleProceedsIndicator();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<NonEligibleProceedsIndicator3Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption56, Optional<IssuerOfferorTaxabilityIndicator1Choice>> mmIssuerOfferorTaxabilityIndicator = new MMMessageAttribute<CashOption56, Optional<IssuerOfferorTaxabilityIndicator1Choice>>() {
		{
		...
		@Override
		public Optional<IssuerOfferorTaxabilityIndicator1Choice> getValue(CashOption56 obj) {
			return obj.getIssuerOfferorTaxabilityIndicator();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<IssuerOfferorTaxabilityIndicator1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, Optional<GenericIdentification30>> mmIncomeType = new MMMessageAssociationEnd<CashOption56, Optional<GenericIdentification30>>() {
		{
		...
		@Override
		public Optional<GenericIdentification30> getValue(CashOption56 obj) {
			return obj.getIncomeType();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<GenericIdentification30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, List<GenericIdentification30>> mmExemptionType = new MMMessageAssociationEnd<CashOption56, List<GenericIdentification30>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption56.mmObject();
			isDerived = false;
			xmlTag = "XmptnTp";
		...
		@Override
		public List<GenericIdentification30> getValue(CashOption56 obj) {
			return obj.getExemptionType();
		}

		@Override
		public void setValue(CashOption56 obj, List<GenericIdentification30> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CashOption56, Optional<CountryCode>> mmCountryOfIncomeSource = new MMMessageAttribute<CashOption56, Optional<CountryCode>>() {
		{
		...
		@Override
		public Optional<CountryCode> getValue(CashOption56 obj) {
			return obj.getCountryOfIncomeSource();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<CountryCode> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, Optional<CashAccountIdentification5Choice>> mmCashAccountIdentification = new MMMessageAssociationEnd<CashOption56, Optional<CashAccountIdentification5Choice>>() {
		{
		...
		@Override
		public Optional<CashAccountIdentification5Choice> getValue(CashOption56 obj) {
			return obj.getCashAccountIdentification();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<CashAccountIdentification5Choice> value) {
			obj.setCashAccountIdentification(value.orElse(null));
		}
	};
	@XmlElement(name = "AmtDtls")
	protected CorporateActionAmounts42 amountDetails;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, Optional<CorporateActionAmounts42>> mmAmountDetails = new MMMessageAssociationEnd<CashOption56, Optional<CorporateActionAmounts42>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> CorporateActionAmounts42.mmObject();
		}

		@Override
		public Optional<CorporateActionAmounts42> getValue(CashOption56 obj) {
			return obj.getAmountDetails();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<CorporateActionAmounts42> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, CorporateActionDate62> mmDateDetails = new MMMessageAssociationEnd<CashOption56, CorporateActionDate62>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption56.mmObject();
			isDerived = false;
		...
		@Override
		public CorporateActionDate62 getValue(CashOption56 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(CashOption56 obj, CorporateActionDate62 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, Optional<ForeignExchangeTerms24>> mmForeignExchangeDetails = new MMMessageAssociationEnd<CashOption56, Optional<ForeignExchangeTerms24>>() {
		{
		...
		@Override
		public Optional<ForeignExchangeTerms24> getValue(CashOption56 obj) {
			return obj.getForeignExchangeDetails();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<ForeignExchangeTerms24> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, Optional<RateDetails31>> mmRateAndAmountDetails = new MMMessageAssociationEnd<CashOption56, Optional<RateDetails31>>() {
		{
			businessElementTrace_lazy = () -> CorporateActionOption.mmRelatedChoiceCorporateAction;
			componentContext_lazy = () -> com.tools20022.repository.msg.CashOption56.mmObject();
			isDerived = false;
		...
		@Override
		public Optional<RateDetails31> getValue(CashOption56 obj) {
			return obj.getRateAndAmountDetails();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<RateDetails31> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CashOption56, Optional<PriceDetails22>> mmPriceDetails = new MMMessageAssociationEnd<CashOption56, Optional<PriceDetails22>>() {
		{
		...
		@Override
		public Optional<PriceDetails22> getValue(CashOption56 obj) {
			return obj.getPriceDetails();
		}

		@Override
		public void setValue(CashOption56 obj, Optional<PriceDetails22> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CashOption56.mmCreditDebitIndicator, com.tools20022.repository.msg.CashOption56.mmNonEligibleProceedsIndicator,
						com.tools20022.repository.msg.CashOption56.mmIssuerOfferorTaxabilityIndicator, com.tools20022.repository.msg.CashOption56.mmIncomeType, com.tools20022.repository.msg.CashOption56.mmExemptionType,
						com.tools20022.repository.msg.CashOption56.mmCountryOfIncomeSource, com.tools20022.repository.msg.CashOption56.mmCashAccountIdentification, com.tools20022.repository.msg.CashOption56.mmAmountDetails,
						com.tools20022.repository.msg.CashOption56.mmDateDetails, com.tools20022.repository.msg.CashOption56.mmForeignExchangeDetails, com.tools20022.repository.msg.CashOption56.mmRateAndAmountDetails,
						com.tools20022.repository.msg.CashOption56.mmPriceDetails);
				trace_lazy = () -> CashProceedsDefinition.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintGenericCashPricePerProductGuideline.forCashOption56,
						com.tools20022.repository.constraints.ConstraintIssuerOfferorTaxabilityIndicatorUsageRule.forCashOption56, com.tools20022.repository.constraints.ConstraintExemptionTypeUsageRule.forCashOption56,
						com.tools20022.repository.constraints.ConstraintIncomeTypeUsageRule.forCashOption56);
	...
	public CashOption56 setCreditDebitIndicator(CreditDebitCode creditDebitIndicator) {
	...
	public CashOption56 setNonEligibleProceedsIndicator(NonEligibleProceedsIndicator3Choice nonEligibleProceedsIndicator) {
	...
	public CashOption56 setIssuerOfferorTaxabilityIndicator(IssuerOfferorTaxabilityIndicator1Choice issuerOfferorTaxabilityIndicator) {
	...
	public CashOption56 setIncomeType(GenericIdentification30 incomeType) {
	...
	public CashOption56 setExemptionType(List<GenericIdentification30> exemptionType) {
	...
	public CashOption56 setCountryOfIncomeSource(CountryCode countryOfIncomeSource) {
	...
	public CashOption56 setCashAccountIdentification(CashAccountIdentification5Choice cashAccountIdentification) {
		this.cashAccountIdentification = cashAccountIdentification;
		return this;
	}

	public Optional<CorporateActionAmounts42> getAmountDetails() {
		return amountDetails == null ? Optional.empty() : Optional.of(amountDetails);
	}

	public CashOption56 setAmountDetails(CorporateActionAmounts42 amountDetails) {
	...
	public CashOption56 setDateDetails(CorporateActionDate62 dateDetails) {
	...
	public CashOption56 setForeignExchangeDetails(ForeignExchangeTerms24 foreignExchangeDetails) {
	...
	public CashOption56 setRateAndAmountDetails(RateDetails31 rateAndAmountDetails) {
	...
	public CashOption56 setPriceDetails(PriceDetails22 priceDetails) {
