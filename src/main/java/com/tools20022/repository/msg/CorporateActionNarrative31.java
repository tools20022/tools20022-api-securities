		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementReversalAdviceV09.mmAdditionalInformation, CorporateActionMovementConfirmationV09.mmAdditionalInformation);
