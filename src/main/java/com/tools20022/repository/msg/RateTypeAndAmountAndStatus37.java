...
@XmlType(name = "RateTypeAndAmountAndStatus37", propOrder = {"rateType", "amount", "rateStatus"})
public class RateTypeAndAmountAndStatus37 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateTypeAndAmountAndStatus37, DeemedRateType1Choice> mmRateType = new MMMessageAssociationEnd<RateTypeAndAmountAndStatus37, DeemedRateType1Choice>() {
		{
			businessElementTrace_lazy = () -> Interest.mmInterestCalculation;
			componentContext_lazy = () -> com.tools20022.repository.msg.RateTypeAndAmountAndStatus37.mmObject();
			isDerived = false;
			xmlTag = "RateTp";
		...
		@Override
		public DeemedRateType1Choice getValue(RateTypeAndAmountAndStatus37 obj) {
			return obj.getRateType();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus37 obj, DeemedRateType1Choice value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RateTypeAndAmountAndStatus37, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<RateTypeAndAmountAndStatus37, ActiveCurrencyAnd13DecimalAmount>() {
		{
		...
		@Override
		public ActiveCurrencyAnd13DecimalAmount getValue(RateTypeAndAmountAndStatus37 obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus37 obj, ActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RateTypeAndAmountAndStatus37, Optional<RateStatus3Choice>> mmRateStatus = new MMMessageAssociationEnd<RateTypeAndAmountAndStatus37, Optional<RateStatus3Choice>>() {
		{
		...
		@Override
		public Optional<RateStatus3Choice> getValue(RateTypeAndAmountAndStatus37 obj) {
			return obj.getRateStatus();
		}

		@Override
		public void setValue(RateTypeAndAmountAndStatus37 obj, Optional<RateStatus3Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RateTypeAndAmountAndStatus37.mmRateType, com.tools20022.repository.msg.RateTypeAndAmountAndStatus37.mmAmount,
						com.tools20022.repository.msg.RateTypeAndAmountAndStatus37.mmRateStatus);
				trace_lazy = () -> Interest.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateTypeAndAmountAndStatus37";
	...
	public RateTypeAndAmountAndStatus37 setRateType(DeemedRateType1Choice rateType) {
	...
	public RateTypeAndAmountAndStatus37 setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public RateTypeAndAmountAndStatus37 setRateStatus(RateStatus3Choice rateStatus) {
