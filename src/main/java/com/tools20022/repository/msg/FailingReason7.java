...
public class FailingReason7 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> FailingReason7.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingReason7.mmCode, FailingReason7.mmAdditionalReasonInformation);
	...
	public void setCode(FailingReason7Choice code) {
		this.code = code;
	}
