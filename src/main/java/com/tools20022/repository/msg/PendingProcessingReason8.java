...
public class PendingProcessingReason8 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PendingProcessingReason8.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingReason8.mmCode, PendingProcessingReason8.mmAdditionalReasonInformation);
	...
	public void setCode(PendingProcessingReason10Choice code) {
		this.code = code;
	}
