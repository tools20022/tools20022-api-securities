...
public class PriceInformation13 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceInformation13.mmType, PriceInformation13.mmValueType, PriceInformation13.mmValue, PriceInformation13.mmSourceOfPrice, PriceInformation13.mmQuotationDate);
