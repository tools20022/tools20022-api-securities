...
public class QuantityBreakdown32 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown32, Optional<GenericIdentification37>> mmLotNumber = new MMMessageAssociationEnd<QuantityBreakdown32, Optional<GenericIdentification37>>() {
		{
			businessElementTrace_lazy = () -> LotBreakdown.mmLotNumber;
			componentContext_lazy = () -> com.tools20022.repository.msg.QuantityBreakdown32.mmObject();
			isDerived = false;
			xmlTag = "LotNb";
		...
		@Override
		public Optional<GenericIdentification37> getValue(QuantityBreakdown32 obj) {
			return obj.getLotNumber();
		}

		@Override
		public void setValue(QuantityBreakdown32 obj, Optional<GenericIdentification37> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown32, Optional<FinancialInstrumentQuantity1Choice>> mmLotQuantity = new MMMessageAssociationEnd<QuantityBreakdown32, Optional<FinancialInstrumentQuantity1Choice>>() {
		{
		...
		@Override
		public Optional<FinancialInstrumentQuantity1Choice> getValue(QuantityBreakdown32 obj) {
			return obj.getLotQuantity();
		}

		@Override
		public void setValue(QuantityBreakdown32 obj, Optional<FinancialInstrumentQuantity1Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<QuantityBreakdown32, Optional<GenericIdentification30>> mmSecuritiesSubBalanceType = new MMMessageAssociationEnd<QuantityBreakdown32, Optional<GenericIdentification30>>() {
		{
		...
		@Override
		public Optional<GenericIdentification30> getValue(QuantityBreakdown32 obj) {
			return obj.getSecuritiesSubBalanceType();
		}

		@Override
		public void setValue(QuantityBreakdown32 obj, Optional<GenericIdentification30> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.QuantityBreakdown32.mmLotNumber, com.tools20022.repository.msg.QuantityBreakdown32.mmLotQuantity,
						com.tools20022.repository.msg.QuantityBreakdown32.mmSecuritiesSubBalanceType);
	...
	public QuantityBreakdown32 setLotNumber(GenericIdentification37 lotNumber) {
	...
	public QuantityBreakdown32 setLotQuantity(FinancialInstrumentQuantity1Choice lotQuantity) {
	...
	public QuantityBreakdown32 setSecuritiesSubBalanceType(GenericIdentification30 securitiesSubBalanceType) {
