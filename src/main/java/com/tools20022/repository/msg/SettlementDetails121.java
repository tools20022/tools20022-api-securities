...
@XmlType(name = "SettlementDetails121", propOrder = {"holdIndicator", "settlementTransactionCondition", "securitiesTransactionType", "settlingCapacity", "stampDutyTaxBasis", "securitiesRTGS", "registration", "beneficialOwnership",
...
public class SettlementDetails121 {
	...
	public static final MMMessageAssociationEnd mmHoldIndicator = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> SettlementDetails121.mmObject();
			isDerived = false;
			xmlTag = "HldInd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SettlementDetails121.mmHoldIndicator, SettlementDetails121.mmSettlementTransactionCondition, SettlementDetails121.mmSecuritiesTransactionType,
						SettlementDetails121.mmSettlingCapacity, SettlementDetails121.mmStampDutyTaxBasis, SettlementDetails121.mmSecuritiesRTGS, SettlementDetails121.mmRegistration, SettlementDetails121.mmBeneficialOwnership,
						SettlementDetails121.mmExposureType, SettlementDetails121.mmCashClearingSystem, SettlementDetails121.mmTaxCapacity, SettlementDetails121.mmRepurchaseType, SettlementDetails121.mmMarketClientSide,
						SettlementDetails121.mmBlockTrade, SettlementDetails121.mmLegalRestrictions, SettlementDetails121.mmSettlementSystemMethod, SettlementDetails121.mmNettingEligibility, SettlementDetails121.mmCCPEligibility,
						SettlementDetails121.mmLetterOfGuarantee, SettlementDetails121.mmPartialSettlementIndicator, SettlementDetails121.mmEligibleForCollateral);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.mmdataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SettlementDetails121";
