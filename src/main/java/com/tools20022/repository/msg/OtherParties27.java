		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionGenerationNotificationV08.mmOtherBusinessParties, SecuritiesSettlementTransactionConfirmationV08.mmOtherBusinessParties,
						SecuritiesFinancingInstructionV08.mmOtherBusinessParties, SecuritiesFinancingConfirmationV08.mmOtherBusinessParties, SecuritiesSettlementTransactionReversalAdviceV07.mmOtherBusinessParties,
						SecuritiesSettlementTransactionInstructionV08.mmOtherBusinessParties);
