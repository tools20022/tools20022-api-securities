...
public class CashOption52 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CashOption52.mmCreditDebitIndicator, CashOption52.mmContractualPaymentIndicator, CashOption52.mmIssuerOfferorTaxabilityIndicator, CashOption52.mmIncomeType,
						CashOption52.mmExemptionType, CashOption52.mmCountryOfIncomeSource, CashOption52.mmAccount, CashOption52.mmCashParties, CashOption52.mmAmountDetails, CashOption52.mmDateDetails,
						CashOption52.mmForeignExchangeDetails, CashOption52.mmTaxVoucherDetails, CashOption52.mmRateAndAmountDetails, CashOption52.mmPriceDetails);
