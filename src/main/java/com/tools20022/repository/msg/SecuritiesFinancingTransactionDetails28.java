		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesFinancingInstructionV07.mmSecuritiesFinancingDetails, SecuritiesFinancingConfirmationV07.mmSecuritiesFinancingDetails);
