...
public class SafekeepingPlaceTypeAndText8 {
	...
	public static final MMMessageAttribute mmSafekeepingPlaceType = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SafekeepingPlaceTypeAndText8.mmObject();
			isDerived = false;
			xmlTag = "SfkpgPlcTp";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SafekeepingPlaceTypeAndText8.mmSafekeepingPlaceType, SafekeepingPlaceTypeAndText8.mmIdentification);
