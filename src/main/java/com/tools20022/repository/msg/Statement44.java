 ...
 * <li>{@linkplain com.tools20022.repository.msg.Statement44#mmQueryReference
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Statement44#mmStatementPeriod
 ...
 * <li>{@linkplain com.tools20022.repository.msg.Statement44#mmStatementBasis
...
@XmlType(name = "Statement44", propOrder = {"reportNumber", "queryReference", "statementIdentification", "statementPeriod", "frequency", "updateType", "statementBasis", "activityIndicator", "subAccountIndicator"})
public class Statement44 {
	...
	public static final MMMessageAttribute mmReportNumber = new MMMessageAttribute() {
		{
			componentContext_lazy = () -> Statement44.mmObject();
			isDerived = false;
			xmlTag = "RptNb";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Statement44.mmReportNumber, Statement44.mmQueryReference, Statement44.mmStatementIdentification, Statement44.mmStatementPeriod, Statement44.mmFrequency, Statement44.mmUpdateType,
						Statement44.mmStatementBasis, Statement44.mmActivityIndicator, Statement44.mmSubAccountIndicator);
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesTransactionPostingReportV07.mmStatementGeneralDetails);
	...
	public void setStatementBasis(StatementBasis8Choice statementBasis) {
