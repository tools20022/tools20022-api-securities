...
public class ReceivingPartiesAndAccount15 {
	...
	public static final MMMessageAssociationEnd mmDepository = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> ReceivingPartiesAndAccount15.mmObject();
			isDerived = false;
			xmlTag = "Dpstry";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ReceivingPartiesAndAccount15.mmDepository, ReceivingPartiesAndAccount15.mmParty1, ReceivingPartiesAndAccount15.mmParty2);
