...
public class ForeignExchangeTerms23 {
	...
	public static final MMMessageAttribute mmUnitCurrency = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> ForeignExchangeTerms23.mmObject();
			isDerived = false;
			xmlTag = "UnitCcy";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms23.mmUnitCurrency, ForeignExchangeTerms23.mmQuotedCurrency, ForeignExchangeTerms23.mmExchangeRate, ForeignExchangeTerms23.mmResultingAmount);
