...
@XmlType(name = "ForeignExchangeTerms26", propOrder = {"toAmount", "fromAmount", "unitCurrency", "quotedCurrency", "exchangeRate", "quotationDate", "quotingInstitution"})
public class ForeignExchangeTerms26 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.ForeignExchangeTerms26
	 * ForeignExchangeTerms26}</li>
	...
	public static final MMMessageAttribute mmToAmount = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> ForeignExchangeTerms26.mmObject();
			isDerived = false;
			xmlTag = "ToAmt";
	...
	protected PartyIdentification70Choice quotingInstitution;
	/**
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(ForeignExchangeTerms26.mmToAmount, ForeignExchangeTerms26.mmFromAmount, ForeignExchangeTerms26.mmUnitCurrency, ForeignExchangeTerms26.mmQuotedCurrency,
						ForeignExchangeTerms26.mmExchangeRate, ForeignExchangeTerms26.mmQuotationDate, ForeignExchangeTerms26.mmQuotingInstitution);
				trace_lazy = () -> CurrencyExchange.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.mmdataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ForeignExchangeTerms26";
	...
	public PartyIdentification70Choice getQuotingInstitution() {
		return quotingInstitution;
	}

	public void setQuotingInstitution(PartyIdentification70Choice quotingInstitution) {
