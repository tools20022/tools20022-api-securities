...
public class UnmatchedReason16 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> UnmatchedReason16.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedReason16.mmCode, UnmatchedReason16.mmAdditionalReasonInformation);
	...
	public void setCode(UnmatchedReason23Choice code) {
		this.code = code;
	}
