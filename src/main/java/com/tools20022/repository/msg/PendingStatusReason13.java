...
import com.tools20022.repository.choice.PendingReason48Choice;
...
@XmlType(name = "PendingStatusReason13", propOrder = {"reasonCode", "additionalReasonInformation"})
public class PendingStatusReason13 {

	final static private AtomicReference<MMMessageComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "RsnCd", required = true)
	protected PendingReason48Choice reasonCode;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.PendingStatusReason13.mmReasonCode, com.tools20022.repository.msg.PendingStatusReason13.mmAdditionalReasonInformation);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintAdditionalReasonInforrmationRule.forPendingStatusReason13);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingStatusReason13";
	...
	public PendingReason48Choice getReasonCode() {
		return reasonCode;
	}

	public PendingStatusReason13 setReasonCode(PendingReason48Choice reasonCode) {
	...
	public PendingStatusReason13 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
