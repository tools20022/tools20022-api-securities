 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.SubAccount5#mmIdentification
...
@XmlType(name = "SubAccount5", propOrder = {"identification", "name", "characteristic"})
public class SubAccount5 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.SubAccount5 SubAccount5}</li>
	...
	public static final MMMessageAttribute mmIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> SubAccount5.mmObject();
			isDerived = false;
			xmlTag = "Id";
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "Identification";
			definition = "Unique and unambiguous identification for the account between the account owner and the account servicer.";
			nextVersions_lazy = () -> Arrays.asList(SubAccount6.mmIdentification);
	...
	public static final MMMessageAttribute mmName = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SubAccount6.mmName);
	 ...
	 * <ul>
	 * <li>
	 * {@linkplain com.tools20022.repository.msg.SubAccount6#mmCharacteristic
	...
	public static final MMMessageAttribute mmCharacteristic = new MMMessageAttribute() {
		{
			...
			nextVersions_lazy = () -> Arrays.asList(SubAccount6.mmCharacteristic);
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SubAccount5.mmIdentification, SubAccount5.mmName, SubAccount5.mmCharacteristic);
				trace_lazy = () -> Account.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.mmdataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "SubAccount5";
				definition = "Business relationship between two entities; one entity is the account owner, the other entity is the account servicer.";
				nextVersions_lazy = () -> Arrays.asList(SubAccount6.mmObject());
