...
public class PartyIdentificationAndAccount102 {
	...
	public static final MMMessageAttribute mmPartyIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PartyIdentificationAndAccount102.mmObject();
			isDerived = false;
			xmlTag = "PtyId";
	...
	public static final MMMessageAssociationEnd mmSubAccount = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.SubAccount4.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PartyIdentificationAndAccount102.mmPartyIdentification, PartyIdentificationAndAccount102.mmAccountIdentification, PartyIdentificationAndAccount102.mmProcessingIdentification,
						PartyIdentificationAndAccount102.mmProcessingDate, PartyIdentificationAndAccount102.mmSubAccount, PartyIdentificationAndAccount102.mmContactPerson);
	...
	public SubAccount4 getSubAccount() {
		return subAccount;
	}

	public void setSubAccount(com.tools20022.repository.msg.SubAccount4 subAccount) {
