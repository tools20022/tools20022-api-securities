...
public class Transfer32 {
	...
	public static final MMMessageAttribute mmTransferReference = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> Transfer32.mmObject();
			isDerived = false;
			xmlTag = "TrfRef";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(Transfer32.mmTransferReference, Transfer32.mmClientReference, Transfer32.mmCounterpartyReference, Transfer32.mmBusinessFlowType, Transfer32.mmTransferReason,
						Transfer32.mmTransferDate, Transfer32.mmRequestedSettlementDate, Transfer32.mmHoldingsPlanType, Transfer32.mmFinancialInstrumentDetails, Transfer32.mmTotalUnitsNumber, Transfer32.mmOwnAccountTransferIndicator,
						Transfer32.mmNonStandardSettlementInformation, Transfer32.mmReceivingAgentDetails, Transfer32.mmDeliveringAgentDetails);
