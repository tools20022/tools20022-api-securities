		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(SecuritiesSettlementTransactionAuditTrailReportV03.mmTransactionIdentification, IntraPositionMovementStatusAdviceV05.mmTransactionIdentification);
