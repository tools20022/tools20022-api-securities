...
import com.tools20022.repository.choice.CorporateActionEventType53Choice;
 ...
 * CorporateActionGeneralInformation111.mmCorporateActionEventIdentification}</li>
 * <li>
 ...
 * CorporateActionGeneralInformation111.mmFinancialInstrumentIdentification}</li>
 * <li>
 * {@linkplain com.tools20022.repository.msg.CorporateActionGeneralInformation111#mmIntermediateSecuritiesDistributionType
 * CorporateActionGeneralInformation111.mmIntermediateSecuritiesDistributionType
 * }</li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation111", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "classActionNumber", "eventType", "financialInstrumentIdentification",
...
public class CorporateActionGeneralInformation111 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation111.mmObject();
			isDerived = false;
	...
	protected CorporateActionEventType53Choice eventType;
	/**
	...
	public static final MMMessageAssociationEnd mmEventType = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 1;
			isComposite = true;
			type_lazy = () -> CorporateActionEventType53Choice.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation111.mmCorporateActionEventIdentification, CorporateActionGeneralInformation111.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation111.mmClassActionNumber, CorporateActionGeneralInformation111.mmEventType, CorporateActionGeneralInformation111.mmFinancialInstrumentIdentification,
						CorporateActionGeneralInformation111.mmIntermediateSecuritiesDistributionType, CorporateActionGeneralInformation111.mmFractionalQuantity);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementConfirmationV08.mmCorporateActionGeneralInformation, CorporateActionMovementReversalAdviceV08.mmCorporateActionGeneralInformation);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.mmdataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionGeneralInformation111";
	...
	public CorporateActionEventType53Choice getEventType() {
		return eventType;
	}

	public void setEventType(CorporateActionEventType53Choice eventType) {
