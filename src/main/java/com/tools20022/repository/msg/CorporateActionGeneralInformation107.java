 ...
 * CorporateActionGeneralInformation107.mmCorporateActionEventIdentification}</li>
 * <li>
...
@XmlType(name = "CorporateActionGeneralInformation107", propOrder = {"corporateActionEventIdentification", "officialCorporateActionEventIdentification", "eventType", "underlyingSecurity"})
public class CorporateActionGeneralInformation107 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation107, Max35Text> mmCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation107, Max35Text>() {
		{
			businessElementTrace_lazy = () -> CorporateActionEventRegistration.mmCorporateActionEventIdentification;
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateActionGeneralInformation107.mmObject();
			isDerived = false;
		...
		@Override
		public Max35Text getValue(CorporateActionGeneralInformation107 obj) {
			return obj.getCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation107 obj, Max35Text value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CorporateActionGeneralInformation107, Optional<Max35Text>> mmOfficialCorporateActionEventIdentification = new MMMessageAttribute<CorporateActionGeneralInformation107, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(CorporateActionGeneralInformation107 obj) {
			return obj.getOfficialCorporateActionEventIdentification();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation107 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation107, CorporateActionEventType52Choice> mmEventType = new MMMessageAssociationEnd<CorporateActionGeneralInformation107, CorporateActionEventType52Choice>() {
		{
		...
		@Override
		public CorporateActionEventType52Choice getValue(CorporateActionGeneralInformation107 obj) {
			return obj.getEventType();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation107 obj, CorporateActionEventType52Choice value) {
			obj.setEventType(value);
		}
	};
	@XmlElement(name = "UndrlygScty")
	protected FinancialInstrumentAttributes81 underlyingSecurity;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateActionGeneralInformation107, Optional<FinancialInstrumentAttributes81>> mmUnderlyingSecurity = new MMMessageAssociationEnd<CorporateActionGeneralInformation107, Optional<FinancialInstrumentAttributes81>>() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> FinancialInstrumentAttributes81.mmObject();
		}

		@Override
		public Optional<FinancialInstrumentAttributes81> getValue(CorporateActionGeneralInformation107 obj) {
			return obj.getUnderlyingSecurity();
		}

		@Override
		public void setValue(CorporateActionGeneralInformation107 obj, Optional<FinancialInstrumentAttributes81> value) {
		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionInstructionV08.mmCorporateActionGeneralInformation);
				...
				constraint_lazy = () -> Arrays.asList(com.tools20022.repository.constraints.ConstraintEventTypeRule.forCorporateActionGeneralInformation107,
						com.tools20022.repository.constraints.ConstraintOfficialCorporateActionEventReference.forCorporateActionGeneralInformation107);
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionGeneralInformation107";
	...
	public CorporateActionGeneralInformation107 setCorporateActionEventIdentification(Max35Text corporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation107 setOfficialCorporateActionEventIdentification(Max35Text officialCorporateActionEventIdentification) {
	...
	public CorporateActionGeneralInformation107 setEventType(CorporateActionEventType52Choice eventType) {
		this.eventType = Objects.requireNonNull(eventType);
		return this;
	}

	public Optional<FinancialInstrumentAttributes81> getUnderlyingSecurity() {
		return underlyingSecurity == null ? Optional.empty() : Optional.of(underlyingSecurity);
	}

	public CorporateActionGeneralInformation107 setUnderlyingSecurity(FinancialInstrumentAttributes81 underlyingSecurity) {
