...
public class CorporateActionGeneralInformation107 {
	...
	public static final MMMessageAttribute mmCorporateActionEventIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionGeneralInformation107.mmObject();
			isDerived = false;
	...
	public static final MMMessageAssociationEnd mmUnderlyingSecurity = new MMMessageAssociationEnd() {
		{
			...
			minOccurs = 0;
			isComposite = true;
			type_lazy = () -> com.tools20022.repository.msg.FinancialInstrumentAttributes81.mmObject();
		}
	};
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionGeneralInformation107.mmCorporateActionEventIdentification, CorporateActionGeneralInformation107.mmOfficialCorporateActionEventIdentification,
						CorporateActionGeneralInformation107.mmEventType, CorporateActionGeneralInformation107.mmUnderlyingSecurity);
	...
	public FinancialInstrumentAttributes81 getUnderlyingSecurity() {
		return underlyingSecurity;
	}

	public void setUnderlyingSecurity(com.tools20022.repository.msg.FinancialInstrumentAttributes81 underlyingSecurity) {
