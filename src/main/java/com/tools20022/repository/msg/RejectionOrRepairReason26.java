...
@XmlType(name = "RejectionOrRepairReason26", propOrder = {"code", "additionalReasonInformation"})
public class RejectionOrRepairReason26 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionOrRepairReason26, RejectionAndRepairReason26Choice> mmCode = new MMMessageAssociationEnd<RejectionOrRepairReason26, RejectionAndRepairReason26Choice>() {
		{
			businessComponentTrace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectionOrRepairReason26.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public RejectionAndRepairReason26Choice getValue(RejectionOrRepairReason26 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionOrRepairReason26 obj, RejectionAndRepairReason26Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionOrRepairReason26, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionOrRepairReason26, Optional<Max210Text>>() {
		{
		...
		@Override
		public Optional<Max210Text> getValue(RejectionOrRepairReason26 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectionOrRepairReason26 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionOrRepairReason26.mmCode, com.tools20022.repository.msg.RejectionOrRepairReason26.mmAdditionalReasonInformation);
	...
	public RejectionOrRepairReason26 setCode(RejectionAndRepairReason26Choice code) {
	...
	public RejectionOrRepairReason26 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
