...
import com.tools20022.repository.choice.ConsentOrRejectionReason4Choice;
...
@XmlType(name = "RejectionReason29", propOrder = {"code", "additionalReasonInformation"})
public class RejectionReason29 {
	 ...
	 * componentContext} =
	 * {@linkplain com.tools20022.repository.msg.RejectionReason29
	 * RejectionReason29}</li>
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<RejectionReason29, ConsentOrRejectionReason4Choice> mmCode = new MMMessageAssociationEnd<RejectionReason29, ConsentOrRejectionReason4Choice>() {
		{
			businessElementTrace_lazy = () -> SecuritiesTradeStatusReason.mmCounterpartyStatusReason;
			componentContext_lazy = () -> com.tools20022.repository.msg.RejectionReason29.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public ConsentOrRejectionReason4Choice getValue(RejectionReason29 obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(RejectionReason29 obj, ConsentOrRejectionReason4Choice value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<RejectionReason29, Optional<Max210Text>> mmAdditionalReasonInformation = new MMMessageAttribute<RejectionReason29, Optional<Max210Text>>() {
		{
		...
		@Override
		public Optional<Max210Text> getValue(RejectionReason29 obj) {
			return obj.getAdditionalReasonInformation();
		}

		@Override
		public void setValue(RejectionReason29 obj, Optional<Max210Text> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.RejectionReason29.mmCode, com.tools20022.repository.msg.RejectionReason29.mmAdditionalReasonInformation);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectionReason29";
	...
	public RejectionReason29 setCode(ConsentOrRejectionReason4Choice code) {
	...
	public RejectionReason29 setAdditionalReasonInformation(Max210Text additionalReasonInformation) {
