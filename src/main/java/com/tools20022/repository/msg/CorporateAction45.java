 ...
 * <li>{@linkplain com.tools20022.repository.msg.CorporateAction45#mmEventStage
...
@XmlType(name = "CorporateAction45", propOrder = {"dateDetails", "eventStage", "lotteryType"})
public class CorporateAction45 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateAction45, Optional<CorporateActionDate59>> mmDateDetails = new MMMessageAssociationEnd<CorporateAction45, Optional<CorporateActionDate59>>() {
		{
			businessComponentTrace_lazy = () -> CorporateActionEvent.mmObject();
			componentContext_lazy = () -> com.tools20022.repository.msg.CorporateAction45.mmObject();
			isDerived = false;
			xmlTag = "DtDtls";
		...
		@Override
		public Optional<CorporateActionDate59> getValue(CorporateAction45 obj) {
			return obj.getDateDetails();
		}

		@Override
		public void setValue(CorporateAction45 obj, Optional<CorporateActionDate59> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateAction45, Optional<CorporateActionEventStageFormat14Choice>> mmEventStage = new MMMessageAssociationEnd<CorporateAction45, Optional<CorporateActionEventStageFormat14Choice>>() {
		{
		...
		@Override
		public Optional<CorporateActionEventStageFormat14Choice> getValue(CorporateAction45 obj) {
			return obj.getEventStage();
		}

		@Override
		public void setValue(CorporateAction45 obj, Optional<CorporateActionEventStageFormat14Choice> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<CorporateAction45, Optional<LotteryTypeFormat4Choice>> mmLotteryType = new MMMessageAssociationEnd<CorporateAction45, Optional<LotteryTypeFormat4Choice>>() {
		{
		...
		@Override
		public Optional<LotteryTypeFormat4Choice> getValue(CorporateAction45 obj) {
			return obj.getLotteryType();
		}

		@Override
		public void setValue(CorporateAction45 obj, Optional<LotteryTypeFormat4Choice> value) {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.msg.CorporateAction45.mmDateDetails, com.tools20022.repository.msg.CorporateAction45.mmEventStage,
						com.tools20022.repository.msg.CorporateAction45.mmLotteryType);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementPreliminaryAdviceCancellationAdviceV08.mmCorporateActionDetails);
				trace_lazy = () -> CorporateActionEvent.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateAction45";
	...
	public CorporateAction45 setDateDetails(CorporateActionDate59 dateDetails) {
	...
	public CorporateAction45 setEventStage(CorporateActionEventStageFormat14Choice eventStage) {
	...
	public CorporateAction45 setLotteryType(LotteryTypeFormat4Choice lotteryType) {
