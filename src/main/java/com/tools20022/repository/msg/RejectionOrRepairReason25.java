...
public class RejectionOrRepairReason25 {
	...
	public static final MMMessageAssociationEnd mmCode = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairReason25.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairReason25.mmCode, RejectionOrRepairReason25.mmAdditionalReasonInformation);
	...
	public void setCode(RejectionAndRepairReason25Choice code) {
		this.code = code;
	}
