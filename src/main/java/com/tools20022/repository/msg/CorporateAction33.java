		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementConfirmationV08.mmCorporateActionDetails, CorporateActionMovementReversalAdviceV08.mmCorporateActionDetails);
