...
@XmlType(name = "PostalAddress8", propOrder = {"addressType", "addressLine", "streetName", "buildingNumber", "postCode", "townName", "countrySubDivision", "country"})
public class PostalAddress8 {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PostalAddress8, Optional<AddressType2Code>> mmAddressType = new MMMessageAttribute<PostalAddress8, Optional<AddressType2Code>>() {
		{
			businessElementTrace_lazy = () -> PostalAddress.mmAddressType;
			componentContext_lazy = () -> com.tools20022.repository.msg.PostalAddress8.mmObject();
			isDerived = false;
			xmlTag = "AdrTp";
		...
		@Override
		public Optional<AddressType2Code> getValue(PostalAddress8 obj) {
			return obj.getAddressType();
		}

		@Override
		public void setValue(PostalAddress8 obj, Optional<AddressType2Code> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PostalAddress8, List<Max70Text>> mmAddressLine = new MMMessageAttribute<PostalAddress8, List<Max70Text>>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.msg.PostalAddress8.mmObject();
			isDerived = false;
			xmlTag = "AdrLine";
		...
		@Override
		public List<Max70Text> getValue(PostalAddress8 obj) {
			return obj.getAddressLine();
		}

		@Override
		public void setValue(PostalAddress8 obj, List<Max70Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PostalAddress8, Optional<Max70Text>> mmStreetName = new MMMessageAttribute<PostalAddress8, Optional<Max70Text>>() {
		{
		...
		@Override
		public Optional<Max70Text> getValue(PostalAddress8 obj) {
			return obj.getStreetName();
		}

		@Override
		public void setValue(PostalAddress8 obj, Optional<Max70Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PostalAddress8, Optional<Max16Text>> mmBuildingNumber = new MMMessageAttribute<PostalAddress8, Optional<Max16Text>>() {
		{
		...
		@Override
		public Optional<Max16Text> getValue(PostalAddress8 obj) {
			return obj.getBuildingNumber();
		}

		@Override
		public void setValue(PostalAddress8 obj, Optional<Max16Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PostalAddress8, Optional<Max16Text>> mmPostCode = new MMMessageAttribute<PostalAddress8, Optional<Max16Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PostalAddress8, Optional<Max35Text>> mmTownName = new MMMessageAttribute<PostalAddress8, Optional<Max35Text>>() {
		{
		...
		@Override
		public Optional<Max35Text> getValue(PostalAddress8 obj) {
			return obj.getTownName();
		}

		@Override
		public void setValue(PostalAddress8 obj, Optional<Max35Text> value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PostalAddress8, Optional<Max35Text>> mmCountrySubDivision = new MMMessageAttribute<PostalAddress8, Optional<Max35Text>>() {
		{
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PostalAddress8, CountryCode> mmCountry = new MMMessageAttribute<PostalAddress8, CountryCode>() {
		{
		...
		@Override
		public CountryCode getValue(PostalAddress8 obj) {
			return obj.getCountry();
		}

		@Override
		public void setValue(PostalAddress8 obj, CountryCode value) {
	...
	public PostalAddress8 setAddressType(AddressType2Code addressType) {
	...
	public PostalAddress8 setAddressLine(List<Max70Text> addressLine) {
	...
	public PostalAddress8 setStreetName(Max70Text streetName) {
	...
	public PostalAddress8 setBuildingNumber(Max16Text buildingNumber) {
	...
	public PostalAddress8 setPostCode(Max16Text postCode) {
	...
	public PostalAddress8 setTownName(Max35Text townName) {
	...
	public PostalAddress8 setCountrySubDivision(Max35Text countrySubDivision) {
	...
	public PostalAddress8 setCountry(CountryCode country) {
