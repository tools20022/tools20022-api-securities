...
public class CorporateActionOption119 {
	...
	final static public MMMessageComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionOption119.mmOptionNumber, CorporateActionOption119.mmOptionType, CorporateActionOption119.mmSecuritiesMovementDetails, CorporateActionOption119.mmCashMovementDetails);
				messageBuildingBlock_lazy = () -> Arrays.asList(CorporateActionMovementReversalAdviceV08.mmCorporateActionConfirmationDetails);
	...
	public void setSecuritiesMovementDetails(List<com.tools20022.repository.msg.SecuritiesOption53> securitiesMovementDetails) {
	...
	public void setCashMovementDetails(List<com.tools20022.repository.msg.CashOption45> cashMovementDetails) {
