...
public class GeneratedRepository extends ReflectionBasedRepository {
	...
	public static final MMBusinessProcessCatalogue catalogue = new MMBusinessProcessCatalogue() {
		{
			topLevelCatalogueEntry_lazy = () -> Arrays.asList(AccountManagementLatestVersion.mmObject(), CashManagementLatestVersion.mmObject(), CollateralManagementLatestVersion.mmObject(),
					...
					SecuritiesManagementLatestVersion.mmObject(), SecuritiesSettlementLatestVersion.mmObject(), SecuritiesTradeLatestVersion.mmObject(), AuthoritiesLatestVersion.mmObject(), OtherMessages.mmObject(),
					SecuritiesManagementArchive.mmObject(), AuthoritiesPreviousVersion.mmObject());
	 ...
	 * topLevelDictionaryEntry} = List of 4515 elements</li>
	 * </ul>
	 */
