...
public class Trade {
	...
	public static final MMBusinessAttribute<Trade, ISODateTime> mmTradeDateTime = new MMBusinessAttribute<Trade, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(DateAndDateTime1Choice.mmDate, DateAndDateTime1Choice.mmDateTime, TwoLegTransactionDetails1.mmTradeDate, ExpectedExecutionDetails2.mmExpectedTradeDateTime,
					...
					TransactionDetails74.mmTradeDate, TransactionDetails82.mmTradeDate, TransactionDetails80.mmTradeDate, TreasuryProfile1.mmDate, SettlementDetails102.mmTradeDate, SubscriptionExecution13.mmTradeDateTime,
					SubscriptionExecution12.mmTradeDateTime, ExpectedExecutionDetails4.mmExpectedTradeDateTime, RedemptionExecution16.mmTradeDateTime, SwitchSubscriptionLegExecution4.mmTradeDateTime, RedemptionExecution15.mmTradeDateTime,
					SwitchRedemptionLegExecution4.mmTradeDateTime, TransparencyDataReport11.mmReportingDate, TransparencyDataReport13.mmReportingDate, TransparencyDataReport15.mmReportingDate, TransparencyDataReport10.mmReportingDate,
					SecuritiesFinancingTransactionDetails35.mmTradeDate, SettlementDetails118.mmTradeDate, SecuredMarketTransaction4.mmTradeDate, ForeignExchangeSwapTransaction3.mmTradeDate, OvernightIndexSwapTransaction4.mmTradeDate,
					UnsecuredMarketTransaction4.mmTradeDate, TransferStatusAndReason5.mmTradeDate, Transfer35.mmTradeDate, Transfer35.mmTransferOrderDateForm, Transfer34.mmTransferOrderDateForm, SecuritiesTradeDetails71.mmTradeDate,
					TransactionDetails105.mmTradeDate, SecuritiesTradeDetails72.mmTradeDate, TransactionDetails104.mmTradeDate, TransactionDetails103.mmTradeDate, SecuritiesTradeDetails73.mmTradeDate, SecuritiesTradeDetails74.mmTradeDate,
					SecuritiesTradeDetails75.mmTradeDate, SecuritiesTradeDetails76.mmTradeDate, SecuritiesTradeDetails77.mmTradeDate, TransactionDetails107.mmTradeDate, SecuritiesTradeDetails78.mmTradeDate,
					SecuritiesTradeDetails79.mmTradeDate, SecuritiesTradeDetails80.mmTradeDate);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd<Trade, List<Commission>> mmTradeCommission = new MMBusinessAssociationEnd<Trade, List<Commission>>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmCommission, Order18.mmCommission, FundCashOutBreakdown3.mmCommissionDetails, FundCashInBreakdown3.mmCommissionDetails);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Trade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Trade, ISODate> mmValueDate = new MMBusinessAttribute<Trade, ISODate>() {
		{
			derivation_lazy = () -> Arrays.asList(TradingDateCode1Choice.mmProprietary, ForeignExchangeSwapTransaction3.mmSpotValueDate, TransactionDetails103.mmValueDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Trade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ValueDate";
