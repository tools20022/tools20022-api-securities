...
public class Pledgee extends SecuritiesPartyRole {
	...
	public static final MMBusinessAttribute<Pledgee, PledgeeTypeCode> mmPledgeeType = new MMBusinessAttribute<Pledgee, PledgeeTypeCode>() {
		{
			derivation_lazy = () -> Arrays.asList(PledgeeTypeAndText1.mmPledgeeType, PledgeeTypeAndAnyBICIdentifier1.mmPledgeeType);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PledgeeTypeAndText1.mmIdentification, PledgeeTypeAndAnyBICIdentifier1.mmIdentification, PledgeeFormat3Choice.mmTypeAndIdentification, PledgeeFormat3Choice.mmIdentification);
				...
				derivationComponent_lazy = () -> Arrays.asList(PledgeeTypeAndText1.mmObject(), PledgeeTypeAndAnyBICIdentifier1.mmObject(), PledgeeFormat3Choice.mmObject());
			}
