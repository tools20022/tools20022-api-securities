...
public class CorporateActionFeesAndCharges extends Charges {
	...
	public static final MMBusinessAssociationEnd mmSolicitationFee = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionRate2.mmSolicitationFee, CorporateActionAmounts1.mmSolicitationFees, CorporateActionAmounts37.mmSolicitationFees, CorporateActionAmounts36.mmSolicitationFees,
					CorporateActionAmounts38.mmSolicitationFees, RateDetails26.mmSolicitationFeeRate, RateDetails27.mmSolicitationFeeRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionFeesAndCharges.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd mmEarlySolicitationFeeRate = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(RateDetails26.mmEarlySolicitationFeeRate, RateDetails27.mmEarlySolicitationFeeRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionFeesAndCharges.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
