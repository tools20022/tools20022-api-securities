...
import com.tools20022.repository.msg.CorporateActionDate24;
import com.tools20022.repository.msg.CorporateActionDate47;
...
public class FixingCondition {
	...
	public static final MMBusinessAttribute mmFixingDateTime = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionDate24.mmForeignExchangeRateFixingDate, CorporateActionDate5.mmForeignExchangeRateFixingDate, CorporateActionDate47.mmForeignExchangeRateFixingDate);
			isDerived = false;
