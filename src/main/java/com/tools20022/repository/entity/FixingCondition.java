...
import com.tools20022.repository.msg.CorporateActionDate62;
import com.tools20022.repository.msg.CorporateActionDate65;
...
public class FixingCondition {
	...
	public static final MMBusinessAttribute<FixingCondition, ISODateTime> mmFixingDateTime = new MMBusinessAttribute<FixingCondition, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionDate5.mmForeignExchangeRateFixingDate, CorporateActionDate62.mmForeignExchangeRateFixingDate, CorporateActionDate65.mmForeignExchangeRateFixingDate);
			isDerived = false;
