...
public class TaxPartyRole extends Role {
	...
	public static final MMBusinessAssociationEnd<TaxPartyRole, List<Tax>> mmTax = new MMBusinessAssociationEnd<TaxPartyRole, List<Tax>>() {
		{
			derivation_lazy = () -> Arrays.asList(InvestmentAccount61.mmTaxReporting, InvestmentAccount63.mmTaxReporting, InvestmentAccount62.mmTaxReporting, InvestmentAccountOwnershipInformation15.mmTaxReporting,
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				subType_lazy = () -> Arrays.asList(TaxPayer.mmObject(), TaxRecipient.mmObject());
