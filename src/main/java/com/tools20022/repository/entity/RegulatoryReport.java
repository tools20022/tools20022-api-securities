...
import com.tools20022.repository.msg.RegulatoryStipulations1;
 ...
 * derivationComponent} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.msg.RegulatoryStipulations1
...
public class RegulatoryReport {
	...
	public static final MMBusinessAttribute mmType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeSwapTransaction3.mmReportedTransactionStatus);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.RegulatoryReport.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Type";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(RegulatoryStipulations1.mmObject());
			}
