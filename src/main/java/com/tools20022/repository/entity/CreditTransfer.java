		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PaymentInstrument21Choice.mmCreditTransferDetails, PaymentInstrument20Choice.mmCreditTransferDetails);
				...
				derivationComponent_lazy = () -> Arrays.asList(CreditTransfer8.mmObject());
			}
