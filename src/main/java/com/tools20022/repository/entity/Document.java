...
public class Document {
	...
	public static final MMBusinessAttribute<Document, ISODateTime> mmIssueDate = new MMBusinessAttribute<Document, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(DocumentIdentification8.mmCreationDateTime, Report4.mmCreationDateTime);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd<Document, GenericIdentification> mmDocumentIdentification = new MMBusinessAssociationEnd<Document, GenericIdentification>() {
		{
			derivation_lazy = () -> Arrays.asList(OtherCollateral7.mmLetterOfCreditIdentification, OtherCollateral5.mmLetterOfCreditIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Document.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(DocumentIdentification9.mmObject(), DocumentIdentification8.mmObject(), DocumentIdentification30.mmObject(), DocumentNumber12.mmObject(), DocumentNumber13.mmObject(),
						DocumentIdentification31.mmObject(), DocumentIdentification32.mmObject(), DocumentIdentification33.mmObject(), DocumentIdentification3Choice.mmObject());
			}
