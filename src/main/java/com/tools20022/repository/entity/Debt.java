...
public class Debt extends Security {
	...
	public static final MMBusinessAttribute mmNextCallableDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmNextCallableDate, FinancialInstrumentAttributes63.mmNextCallableDate, FinancialInstrumentAttributes64.mmNextCallableDate,
					FinancialInstrumentAttributes79.mmNextCallableDate, FinancialInstrumentAttributes81.mmNextCallableDate, FinancialInstrumentAttributes80.mmNextCallableDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmPutableDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmPutableDate, FinancialInstrumentAttributes63.mmPutableDate, FinancialInstrumentAttributes64.mmPutableDate, FinancialInstrumentAttributes79.mmPutableDate,
					FinancialInstrumentAttributes81.mmPutableDate, FinancialInstrumentAttributes80.mmPutableDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PutableDate";
	...
	public static final MMBusinessAttribute mmDatedDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmDatedDate, FinancialInstrumentAttributes63.mmDatedDate, FinancialInstrumentAttributes64.mmDatedDate, FinancialInstrumentAttributes79.mmDatedDate,
					FinancialInstrumentAttributes81.mmDatedDate, FinancialInstrumentAttributes80.mmDatedDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "DatedDate";
	...
	public static final MMBusinessAttribute mmFactor = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmPreviousFactor, FinancialInstrumentAttributes44.mmCurrentFactor, FinancialInstrumentAttributes44.mmNextFactor, FinancialInstrumentAttributes44.mmEndFactor,
					...
					FinancialInstrumentAttributes64.mmCurrentFactor, FinancialInstrumentAttributes64.mmNextFactor, CorporateActionRate66.mmPreviousFactor, CorporateActionRate66.mmNextFactor,
					FinancialInstrumentAttributes79.mmPreviousFactor, FinancialInstrumentAttributes79.mmNextFactor, FinancialInstrumentAttributes81.mmPreviousFactor, FinancialInstrumentAttributes81.mmNextFactor,
					FinancialInstrumentAttributes80.mmPreviousFactor, FinancialInstrumentAttributes80.mmNextFactor);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Factor";
	...
	public static final MMBusinessAttribute mmPoolNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmPoolNumber, FinancialInstrumentAttributes63.mmPoolNumber, FinancialInstrumentAttributes64.mmPoolNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PoolNumber";
	...
	public static final MMBusinessAttribute mmCallableIndicator = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentStipulations2.mmCallableIndicator, FinancialInstrumentAttributes44.mmCallableIndicator, FinancialInstrumentAttributes63.mmCallableIndicator,
					FinancialInstrumentAttributes64.mmCallableIndicator);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmPutableIndicator = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentStipulations2.mmPutableIndicator, FinancialInstrumentAttributes44.mmPutableIndicator, FinancialInstrumentAttributes63.mmPutableIndicator,
					FinancialInstrumentAttributes64.mmPutableIndicator);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmYieldToMaturityRate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes63.mmYieldToMaturityRate, FinancialInstrumentAttributes64.mmYieldToMaturityRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmAccruedCapitalisationAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(OtherAmounts16.mmAccruedCapitalisationAmount, OtherAmounts28.mmAccruedCapitalisationAmount, OtherAmounts30.mmAccruedCapitalisationAmount, OtherAmounts31.mmAccruedCapitalisationAmount,
					OtherAmounts29.mmAccruedCapitalisationAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Debt.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
