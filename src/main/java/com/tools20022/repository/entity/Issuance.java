...
public class Issuance {
	...
	public static final MMBusinessAttribute mmIssueDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentStipulations2.mmIssueDate, FutureOrOptionDetails1.mmAnnouncementDate, FinancialInstrumentAttributes44.mmIssueDate, FinancialInstrumentAttributes63.mmIssueDate,
					...
					FinancialInstrumentAttributes81.mmIssueDate, FinancialInstrumentAttributes80.mmIssueDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmIssueDiscountAllowance = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(OtherAmounts16.mmIssueDiscountAllowance, CorporateActionAmounts1.mmIssueDiscountAmount, OtherAmounts28.mmIssueDiscountAllowance, OtherAmounts30.mmIssueDiscountAllowance,
					OtherAmounts31.mmIssueDiscountAllowance);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd mmInterestShortfall = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionRate66.mmInterestShortfall);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd mmRealisedLoss = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionRate66.mmRealisedLoss);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "RealisedLoss";
