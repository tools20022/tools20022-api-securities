...
public class Issuance {
	...
	public static final MMBusinessAttribute<Issuance, ISODateTime> mmIssueDate = new MMBusinessAttribute<Issuance, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentStipulations2.mmIssueDate, FutureOrOptionDetails1.mmAnnouncementDate, FinancialInstrumentAttributes44.mmIssueDate, FinancialInstrumentAttributes63.mmIssueDate,
					FinancialInstrumentAttributes64.mmIssueDate, OtherCollateral7.mmIssueDate, OtherCollateral6.mmIssueDate, OtherCollateral5.mmIssueDate, FinancialInstrumentAttributes79.mmIssueDate,
					FinancialInstrumentAttributes81.mmIssueDate, FinancialInstrumentAttributes80.mmIssueDate, FinancialInstrumentAttributes91.mmIssueDate, FinancialInstrumentAttributes92.mmIssueDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute<Issuance, CurrencyAndAmount> mmIssueDiscountAllowance = new MMBusinessAttribute<Issuance, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(OtherAmounts16.mmIssueDiscountAllowance, CorporateActionAmounts1.mmIssueDiscountAmount, OtherAmounts41.mmIssueDiscountAllowance, OtherAmounts39.mmIssueDiscountAllowance,
					OtherAmounts40.mmIssueDiscountAllowance);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
	...
	public static final MMBusinessAssociationEnd<Issuance, RateAndAmount> mmInterestShortfall = new MMBusinessAssociationEnd<Issuance, RateAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionRate91.mmInterestShortfall);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<Issuance, RateAndAmount> mmRealisedLoss = new MMBusinessAssociationEnd<Issuance, RateAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionRate91.mmRealisedLoss);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "RealisedLoss";
	...
	public static final MMBusinessAttribute<Issuance, Max256Text> mmPurpose = new MMBusinessAttribute<Issuance, Max256Text>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentStipulations2.mmPurpose, FutureOrOptionDetails1.mmPurpose);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Purpose";
	...
	public static final MMBusinessAttribute<Issuance, Number> mmIssueSize = new MMBusinessAttribute<Issuance, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentStipulations2.mmIssueSize, TransparencyDataReport11.mmHoldingsExceedingTotalVotingRightThreshold);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "IssueSize";
	...
	public static final MMBusinessAttribute<Issuance, CurrencyAndAmount> mmIssuePrice = new MMBusinessAttribute<Issuance, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(FutureOrOptionDetails1.mmIssuePrice, CorporateActionPrice1.mmIssuePrice, CorporateActionPrice60.mmIssuePrice, TransparencyDataReport11.mmIssuanceSize);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Issuance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "IssuePrice";
