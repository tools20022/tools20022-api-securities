...
public class Warrant extends Security {
	...
	public static final MMBusinessAssociationEnd<Warrant, SecuritiesPricing> mmSubscriptionPrice = new MMBusinessAssociationEnd<Warrant, SecuritiesPricing>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmSubscriptionPrice, FinancialInstrumentAttributes63.mmSubscriptionPrice, FinancialInstrumentAttributes64.mmSubscriptionPrice,
					FinancialInstrumentAttributes91.mmSubscriptionPrice, FinancialInstrumentAttributes92.mmSubscriptionPrice);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd<Warrant, QuantityRatio> mmWarrantParity = new MMBusinessAssociationEnd<Warrant, QuantityRatio>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes79.mmWarrantParity);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Warrant.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "WarrantParity";
