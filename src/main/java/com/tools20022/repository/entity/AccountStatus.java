		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(AccountManagementStatusAndReason5.mmStatus, AccountStatus2.mmOther);
				...
				derivationComponent_lazy = () -> Arrays.asList(RejectionReason32.mmObject(), RejectionReason33.mmObject(), Status21Choice.mmObject(), RejectionReason31.mmObject(), AccountManagementStatusAndReason5.mmObject(),
						AccountStatus2.mmObject(), OtherAccountStatus1.mmObject(), Status25Choice.mmObject());
			}
