...
public class PaymentExecution {
	...
	public static final MMBusinessAttribute<PaymentExecution, DebitCreditCode> mmCreditDebitIndicator = new MMBusinessAttribute<PaymentExecution, DebitCreditCode>() {
		{
			derivation_lazy = () -> Arrays.asList(AmountAndDirection5.mmCreditDebit, AmountAndDirection3.mmCreditDebit, AmountAndDirection29.mmCreditDebitIndicator, AmountAndDirection28.mmCreditDebitIndicator,
					AmountAndDirection20.mmCreditDebitIndicator, AmountAndDirection27.mmCreditDebitIndicator, AmountAndDirection21.mmCreditDebitIndicator, AmountAndDirection49.mmCreditDebitIndicator,
					AmountAndDirection44.mmCreditDebitIndicator, AmountAndDirection51.mmCreditDebitIndicator, AmountAndDirection52.mmCreditDebitIndicator, AmountAndDirection47.mmCreditDebitIndicator, CashAccount33.mmCreditDebit,
					AmountAndDirection87.mmCreditDebitIndicator, AmountAndDirection88.mmCreditDebitIndicator, AmountAndDirection89.mmCreditDebitIndicator);
			isDerived = false;
