...
import com.tools20022.repository.msg.Order17;
import com.tools20022.repository.msg.Order18;
...
public class YieldCalculation {
	...
	public static final MMBusinessAssociationEnd mmRedemptionPrice = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(YieldCalculation2.mmRedemptionPrice);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmValue = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(YieldCalculation2.mmValue, SecuritiesTransactionPrice2Choice.mmYield);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.YieldCalculation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Value";
	...
	public static final MMBusinessAttribute mmCalculationType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(YieldCalculation2.mmCalculationType, Order17.mmYieldType, Order18.mmYieldType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.YieldCalculation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmValueDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(YieldCalculation2.mmValueDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.YieldCalculation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ValueDate";
	...
	public static final MMBusinessAssociationEnd mmValuePeriod = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(YieldCalculation2.mmValuePeriod);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.YieldCalculation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ValuePeriod";
	...
	public static final MMBusinessAttribute mmYieldCalculationDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(YieldCalculation2.mmCalculationDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.YieldCalculation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(YieldCalculation2.mmObject());
			}
