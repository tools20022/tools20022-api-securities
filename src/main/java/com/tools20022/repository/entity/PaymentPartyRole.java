...
public class PaymentPartyRole extends Role {
	...
	public static final MMBusinessAssociationEnd<PaymentPartyRole, List<CashAccount>> mmCashAccount = new MMBusinessAssociationEnd<PaymentPartyRole, List<CashAccount>>() {
		{
			derivation_lazy = () -> Arrays.asList(CreditTransfer8.mmDebtorAccount, CreditTransfer8.mmDebtorAgentAccount, CreditTransfer8.mmIntermediaryAgent1Account, CreditTransfer8.mmIntermediaryAgent2Account,
					CreditTransfer8.mmCreditorAccount);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(CashParties18.mmObject(), CashParties24.mmObject(), CashParties26.mmObject(), CashParties25.mmObject(), CashParties28.mmObject());
			}
