...
public class Spread {
	...
	public static final MMBusinessAttribute mmSpreadRate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(SecuritiesFinancing10.mmSpreadRate, InterestCalculation4.mmSpread);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Spread.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "SpreadRate";
	...
	public static final MMBusinessAttribute mmBasisPointSpread = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(VariableInterest1Rate.mmBasisPointSpread, FloatingRateNote2.mmBasisPointSpread, FloatingInterestRate6.mmBasisPointSpread);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Spread.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
