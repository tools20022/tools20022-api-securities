		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(SecuritiesTransactionReport4.mmInvestmentDecisionPerson);
				...
				derivationComponent_lazy = () -> Arrays.asList(DeMinimusApplicable1.mmObject(), DeMinimusNotApplicable1.mmObject(), NewIssueAllocation2.mmObject(), DeMinimus1Choice.mmObject());
			}
