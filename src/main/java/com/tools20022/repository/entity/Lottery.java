...
public class Lottery {
	...
	public static final MMBusinessAttribute mmLotteryDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionDate2.mmLotteryDate, CorporateActionDate45.mmLotteryDate, CorporateActionDate44.mmLotteryDate);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd mmIncrementalDenomination = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateAction2.mmIncrementalDenomination, CorporateActionQuantity7.mmIncrementalDenomination);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Lottery.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmLotteryType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(LotteryType1FormatChoice.mmCode, LotteryType1FormatChoice.mmProprietary, CorporateAction2.mmLotteryType, CorporateAction33.mmLotteryType, CorporateAction32.mmLotteryType,
					CorporateAction31.mmLotteryType, LotteryTypeFormat4Choice.mmCode, LotteryTypeFormat4Choice.mmProprietary, CorporateAction34.mmLotteryType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Lottery.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "LotteryType";
