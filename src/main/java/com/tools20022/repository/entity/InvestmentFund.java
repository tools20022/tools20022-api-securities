...
public class InvestmentFund {
	...
	public static final MMBusinessAssociationEnd<InvestmentFund, Country> mmDomicileCountry = new MMBusinessAssociationEnd<InvestmentFund, Country>() {
		{
			derivation_lazy = () -> Arrays.asList(SecurityIdentification1.mmCountryOfDomicile, FundParameters4.mmCountryOfDomicile, FinancialInstrument21.mmCountryOfDomicile);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd<InvestmentFund, List<InvestmentFundClass>> mmInvestmentFundClass = new MMBusinessAssociationEnd<InvestmentFund, List<InvestmentFundClass>>() {
		{
			derivation_lazy = () -> Arrays.asList(FundProcessingPassport1.mmFundDetails, FundProcessingPassport1.mmInvestmentRestrictions, FundParameters4.mmFinancialInstrumentDetails);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.InvestmentFund.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<InvestmentFund, Max35Text> mmFundType = new MMBusinessAttribute<InvestmentFund, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(InvestmentAccount64.mmFundType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.InvestmentFund.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "FundType";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(FundProcessingPassport1.mmObject(), FundParameters4.mmObject(), FundParameters3Choice.mmObject());
			}
