...
public class TradingMarket extends Market {
	...
	public static final MMBusinessAttribute mmType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(MarketType11Choice.mmCode, MarketType11Choice.mmProprietary, MarketType12Choice.mmCode, MarketType12Choice.mmProprietary, MarketType8Choice.mmCode, MarketType8Choice.mmProprietary,
					MarketIdentification20.mmType, MarketType9Choice.mmCode, MarketType9Choice.mmProprietary, MarketIdentification79.mmType, MarketIdentification80.mmType, MarketIdentification84.mmType, MarketIdentification85.mmType,
					MarketIdentification89.mmType, MarketType15Choice.mmCode, MarketType15Choice.mmProprietary, MarketIdentification92.mmCategory);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.TradingMarket.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Type";
	...
	public static final MMBusinessAttribute mmTradingCurrency = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(SettlementObligation5.mmTradingCurrency, TradeLeg8.mmTradingCurrency, TradeLeg10.mmTradingCurrency, TradeLeg9.mmTradingCurrency);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.TradingMarket.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(MarketIdentification20.mmIdentification, MarketIdentification79.mmIdentification, MarketIdentification80.mmIdentification, TradeLeg8.mmPlaceOfTrade,
						...
						MarketIdentification89.mmIdentification, SwitchExecution7.mmPlaceOfTrade, SubscriptionBulkOrder5.mmPlaceOfTrade, RedemptionMultipleExecution5.mmPlaceOfTrade, RedemptionMultipleOrder6.mmPlaceOfTrade,
						SubscriptionMultipleOrder6.mmPlaceOfTrade, SubscriptionBulkExecution4.mmPlaceOfTrade, SwitchOrder7.mmPlaceOfTrade, RedemptionBulkOrder6.mmPlaceOfTrade, SubscriptionMultipleExecution5.mmPlaceOfTrade);
				...
				derivationComponent_lazy = () -> Arrays.asList(LocalMarketAnnex2.mmObject(), MarketIdentification1Choice.mmObject(), MarketIdentification3Choice.mmObject(), MarketType11Choice.mmObject(), MarketType12Choice.mmObject(),
						PlaceOfTradeIdentification1Choice.mmObject(), MarketType8Choice.mmObject(), MarketIdentification20.mmObject(), MarketType9Choice.mmObject(), MarketIdentification79.mmObject(), MarketIdentification80.mmObject(),
						MarketIdentification84.mmObject(), MarketIdentification85.mmObject(), TradingVenueAttributes1.mmObject(), MarketIdentification89.mmObject(), MarketType15Choice.mmObject(), MarketDetail2.mmObject());
			}
