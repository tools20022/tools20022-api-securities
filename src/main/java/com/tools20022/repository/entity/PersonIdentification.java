		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Party10Choice.mmPrivateIdentification, PersonIdentification6.mmPersonIdentificationType, GenericIdentification16.mmIdentificationType, PersonOrOrganisation1Choice.mmPerson,
						PersonOrOrganisation2Choice.mmPerson, AlternateIdentification4.mmType, OtherIdentification4Choice.mmCode, GenericIdentification82.mmType, OtherIdentification3Choice.mmCode,
						GenericIdentification164.mmIdentificationType);
				...
				derivationComponent_lazy = () -> Arrays.asList(PersonIdentificationSchemeName1Choice.mmObject(), GenericPersonIdentification1.mmObject(), PersonIdentification5.mmObject(), ContactDetails2.mmObject(),
						PersonIdentificationType1Choice.mmObject(), PersonIdentification6.mmObject(), PersonIdentificationType3Choice.mmObject(), PersonIdentification10.mmObject(), IndividualPersonIdentification2Choice.mmObject(),
						PersonIdentification12.mmObject(), IndividualPersonIdentification3Choice.mmObject());
			}
