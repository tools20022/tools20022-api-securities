...
import com.tools20022.repository.choice.RegistrationProcessingStatus3Choice;
import com.tools20022.repository.choice.SecuritiesPaymentStatus5Choice;
...
import com.tools20022.repository.msg.FinancialInstrumentAttributes64;
import com.tools20022.repository.msg.FinancialInstrumentAttributes91;
...
public class SecuritiesStatus extends Status {
	...
	public static final MMBusinessAttribute<SecuritiesStatus, SecuritiesPaymentStatusCode> mmPaymentStatus = new MMBusinessAttribute<SecuritiesStatus, SecuritiesPaymentStatusCode>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes63.mmPaymentStatus, FinancialInstrumentAttributes64.mmPaymentStatus, SecuritiesPaymentStatus5Choice.mmCode, SecuritiesPaymentStatus5Choice.mmProprietary,
					FinancialInstrumentAttributes91.mmPaymentStatus, FinancialInstrumentAttributes92.mmPaymentStatus);
			isDerived = false;
	...
	public static final MMBusinessAttribute<SecuritiesStatus, RegistrationProcessingStatusCode> mmRegistrationStatus = new MMBusinessAttribute<SecuritiesStatus, RegistrationProcessingStatusCode>() {
		{
			derivation_lazy = () -> Arrays.asList(RegistrationProcessingStatus3Choice.mmCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesStatus.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(SecuritiesPaymentStatus5Choice.mmObject());
			}
