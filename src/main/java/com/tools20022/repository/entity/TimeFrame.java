...
public class TimeFrame {
	...
	public static final MMBusinessAttribute mmTradeMinus = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(TimeFrame3.mmTradeMinus);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmTradePlus = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(TimeFrame5Choice.mmTradePlus, TimeFrame4Choice.mmTradePlus);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.TimeFrame.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "TradePlus";
	...
	public static final MMBusinessAttribute mmRenunciationPlus = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(TimeFrame4Choice.mmRenunciationPlus);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.TimeFrame.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmPrepayment = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(TimeFrame5Choice.mmPrepayment);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.TimeFrame.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Prepayment";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(ProcessingCharacteristics2.mmDealingCutOffTimeFrame, ProcessingCharacteristics3.mmDealingCutOffTimeFrame);
				...
				derivationComponent_lazy = () -> Arrays.asList(TimeFrame3.mmObject(), TimeFrame5Choice.mmObject(), TimeFrame4Choice.mmObject());
			}
