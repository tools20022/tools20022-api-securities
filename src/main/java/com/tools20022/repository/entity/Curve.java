...
public class Curve {
	...
	public static final MMBusinessAttribute<Curve, BenchmarkCurveNameCode> mmName = new MMBusinessAttribute<Curve, BenchmarkCurveNameCode>() {
		{
			derivation_lazy = () -> Arrays.asList(InflationIndex1Choice.mmName, BenchmarkCurveName5Choice.mmIndex, BenchmarkCurveName5Choice.mmName, BenchmarkCurveName6Choice.mmIndex, BenchmarkCurveName6Choice.mmName);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Curve.mmObject();
