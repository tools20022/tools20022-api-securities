...
public class CorporateActionElection {
	...
	public static final MMBusinessAttribute mmExecutionRequestedDateTime = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionOption131.mmExecutionRequestedDateTime);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd mmCashAccount = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CashOption45.mmAccount, CashOption52.mmAccount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionElection.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "CashAccount";
	...
	public static final MMBusinessAttribute mmElectionType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateAction2.mmElectionType, CorporateAction31.mmElectionType, ElectionTypeFormat3Choice.mmCode, ElectionTypeFormat3Choice.mmProprietary);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionElection.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ElectionType";
