		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(ConfirmationParties3.mmBuyer, ConfirmationParties4.mmBuyer, ConfirmationParties2.mmBuyer, PartyIdentification79.mmDecisionMaker, SecuritiesTransactionReport4.mmBuyer);
