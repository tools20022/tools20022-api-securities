...
public class CurrencyExchange {
	...
	public static final MMBusinessAttribute mmOriginalAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(AmountAndDirection29.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection28.mmOriginalCurrencyAndOrderedAmount, OtherAmounts16.mmOriginalCurrencyAmount,
					CorporateActionRate2.mmOriginalAmount, CorporateActionAmounts1.mmOriginalAmount, ForeignExchangeTerms9.mmOriginalAmount, AmountAndDirection27.mmOriginalCurrencyAndOrderedAmount,
					AmountAndDirection46.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection49.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection48.mmOriginalCurrencyAndOrderedAmount,
					...
					CorporateActionAmounts36.mmOriginalAmount, CorporateActionAmounts38.mmOriginalAmount, ForeignExchangeSwapTransaction3.mmTransactionNominalAmount);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmUnitCurrency = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms19.mmUnitCurrency, ForeignExchangeTerms6.mmUnitCurrency, ForeignExchangeTerms18.mmUnitCurrency, ForeignExchangeTerms8.mmUnitCurrency,
					ForeignExchangeTerms9.mmUnitCurrency, ForeignExchangeTerms17.mmUnitCurrency, ForeignExchangeTerms22.mmUnitCurrency, ForeignExchangeTerms23.mmUnitCurrency, ForeignExchangeTerms24.mmUnitCurrency,
					ForeignExchangeTerms26.mmUnitCurrency, ForeignExchangeTerms33.mmUnitCurrency, ForeignExchangeTerms32.mmUnitCurrency, FundOrderData5.mmUnitCurrency, FundOrderData6.mmUnitCurrency);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "UnitCurrency";
	...
	public static final MMBusinessAttribute mmQuotedCurrency = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms19.mmQuotedCurrency, ForeignExchangeTerms6.mmQuotedCurrency, ForeignExchangeTerms18.mmQuotedCurrency, ForeignExchangeTerms8.mmQuotedCurrency,
					ForeignExchangeTerms9.mmQuotedCurrency, ForeignExchangeTerms17.mmQuotedCurrency, ForeignExchangeTerms22.mmQuotedCurrency, ForeignExchangeTerms23.mmQuotedCurrency, ForeignExchangeTerms24.mmQuotedCurrency,
					ForeignExchangeTerms26.mmQuotedCurrency, ForeignExchangeTerms33.mmQuotedCurrency, ForeignExchangeTerms32.mmQuotedCurrency, FundOrderData5.mmQuotedCurrency, FundOrderData6.mmQuotedCurrency);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "QuotedCurrency";
	...
	public static final MMBusinessAttribute mmExchangeRate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms19.mmExchangeRate, ForeignExchangeTerms6.mmExchangeRate, ForeignExchangeTerms18.mmExchangeRate, ForeignExchangeTerms8.mmExchangeRate,
					ForeignExchangeTerms9.mmExchangeRate, SecuritiesAccount21.mmForeignExchangeRate, ForeignExchangeTerms17.mmExchangeRate, ForeignExchange1.mmExchangeSpotRate, ForeignExchangeTerms22.mmExchangeRate,
					ForeignExchangeTerms23.mmExchangeRate, ForeignExchangeTerms24.mmExchangeRate, ForeignExchangeTerms26.mmExchangeRate, CollateralValuation5.mmExchangeRate, ForeignExchangeTerms33.mmExchangeRate,
					ForeignExchangeTerms32.mmExchangeRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ExchangeRate";
	...
	public static final MMBusinessAttribute mmResultingAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms18.mmConvertedAmount, OtherAmounts16.mmConvertedAmount, ForeignExchangeTerms8.mmResultingAmount, ForeignExchangeTerms9.mmResultingAmount,
					ForeignExchangeTerms17.mmResultingAmount, ForeignExchangeTerms23.mmResultingAmount, ForeignExchangeTerms24.mmResultingAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmQuotationDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms6.mmQuotationDate, ForeignExchangeTerms22.mmQuotationDate, ForeignExchangeTerms26.mmQuotationDate, ForeignExchangeTerms33.mmQuotationDate,
					ForeignExchangeTerms32.mmQuotationDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "QuotationDate";
	...
	public static final MMBusinessAttribute mmTargetCurrency = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchange1.mmForeignCurrency, CashAccount33.mmSettlementCurrency, PaymentInstrument13.mmSettlementCurrency);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "TargetCurrency";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(ForeignExchangeTerms19.mmObject(), ForeignExchangeTerms6.mmObject(), ForeignExchangeTerms18.mmObject(), ForeignExchangeTerms8.mmObject(), ForeignExchangeTerms9.mmObject(),
						ForeignExchangeTerms17.mmObject(), CurrencyDesignation1.mmObject(), ForeignExchange1.mmObject(), ForeignExchangeTerms22.mmObject(), ForeignExchangeTerms23.mmObject(), ForeignExchangeTerms24.mmObject(),
						ForeignExchangeTerms26.mmObject(), ForeignExchangeTerms33.mmObject(), ForeignExchangeTerms32.mmObject());
			}
