...
public class CurrencyExchange {
	...
	public static final MMBusinessAttribute<CurrencyExchange, CurrencyAndAmount> mmOriginalAmount = new MMBusinessAttribute<CurrencyExchange, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(AmountAndDirection29.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection28.mmOriginalCurrencyAndOrderedAmount, OtherAmounts16.mmOriginalCurrencyAmount,
					...
					AmountAndDirection49.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection44.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection51.mmOriginalCurrencyAndOrderedAmount,
					ForeignExchangeSwapTransaction3.mmTransactionNominalAmount, AmountAndDirection87.mmOriginalCurrencyAndOrderedAmount, AmountAndDirection88.mmOriginalCurrencyAndOrderedAmount,
	...
	public static final MMBusinessAttribute<CurrencyExchange, CurrencyCode> mmUnitCurrency = new MMBusinessAttribute<CurrencyExchange, CurrencyCode>() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms19.mmUnitCurrency, ForeignExchangeTerms6.mmUnitCurrency, ForeignExchangeTerms18.mmUnitCurrency, ForeignExchangeTerms8.mmUnitCurrency,
					...
					ForeignExchangeTerms33.mmUnitCurrency, ForeignExchangeTerms32.mmUnitCurrency, FundOrderData5.mmUnitCurrency, FundOrderData6.mmUnitCurrency);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "UnitCurrency";
	...
	public static final MMBusinessAttribute<CurrencyExchange, CurrencyCode> mmQuotedCurrency = new MMBusinessAttribute<CurrencyExchange, CurrencyCode>() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms19.mmQuotedCurrency, ForeignExchangeTerms6.mmQuotedCurrency, ForeignExchangeTerms18.mmQuotedCurrency, ForeignExchangeTerms8.mmQuotedCurrency,
					...
					ForeignExchangeTerms33.mmQuotedCurrency, ForeignExchangeTerms32.mmQuotedCurrency, FundOrderData5.mmQuotedCurrency, FundOrderData6.mmQuotedCurrency);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "QuotedCurrency";
	...
	public static final MMBusinessAttribute<CurrencyExchange, BaseOneRate> mmExchangeRate = new MMBusinessAttribute<CurrencyExchange, BaseOneRate>() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms19.mmExchangeRate, ForeignExchangeTerms6.mmExchangeRate, ForeignExchangeTerms18.mmExchangeRate, ForeignExchangeTerms8.mmExchangeRate,
					...
					ForeignExchangeTerms23.mmExchangeRate, ForeignExchangeTerms24.mmExchangeRate, CollateralValuation5.mmExchangeRate, ForeignExchangeTerms33.mmExchangeRate, ForeignExchangeTerms32.mmExchangeRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
	...
	public static final MMBusinessAttribute<CurrencyExchange, ISODateTime> mmQuotationDate = new MMBusinessAttribute<CurrencyExchange, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms6.mmQuotationDate, ForeignExchangeTerms22.mmQuotationDate, ForeignExchangeTerms33.mmQuotationDate, ForeignExchangeTerms32.mmQuotationDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CurrencyExchange.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "QuotationDate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(ForeignExchangeTerms19.mmObject(), ForeignExchangeTerms6.mmObject(), ForeignExchangeTerms18.mmObject(), ForeignExchangeTerms8.mmObject(), ForeignExchangeTerms9.mmObject(),
						...
						ForeignExchangeTerms33.mmObject(), ForeignExchangeTerms32.mmObject());
			}
