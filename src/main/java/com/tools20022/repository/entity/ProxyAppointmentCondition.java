...
public class ProxyAppointmentCondition {
	...
	public static final MMBusinessAttribute mmRegistrationMethod = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ProxyAppointmentInformation3.mmRegistrationMethod);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ProxyAppointmentCondition.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Proxy2Choice.mmProxy);
				...
				derivationComponent_lazy = () -> Arrays.asList(Proxy2Choice.mmObject(), ProxyAppointmentInformation3.mmObject());
			}
