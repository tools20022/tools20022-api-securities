...
public class AdditionalRight {
	...
	public static final MMBusinessAttribute<AdditionalRight, AdditionalRightCode> mmType = new MMBusinessAttribute<AdditionalRight, AdditionalRightCode>() {
		{
			derivation_lazy = () -> Arrays.asList(AdditionalRightCode1Choice.mmCode, AdditionalRightCode1Choice.mmProprietary, AdditionalRights2.mmAdditionalRight);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.AdditionalRight.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Type";
	...
	public static final MMBusinessAttribute<AdditionalRight, Max350Text> mmAdditionalRightThreshold = new MMBusinessAttribute<AdditionalRight, Max350Text>() {
		{
			derivation_lazy = () -> Arrays.asList(AdditionalRightThreshold1Choice.mmAdditionalRightThreshold, AdditionalRights2.mmAdditionalRightThreshold);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.AdditionalRight.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(AdditionalRightCode1Choice.mmObject(), AdditionalRightThreshold1Choice.mmObject(), AdditionalRights2.mmObject());
			}
