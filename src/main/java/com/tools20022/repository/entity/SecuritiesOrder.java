...
public class SecuritiesOrder extends Order {
	...
	public static final MMBusinessAttribute<SecuritiesOrder, CashMarginOrderCode> mmCashMargin = new MMBusinessAttribute<SecuritiesOrder, CashMarginOrderCode>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmCashMargin, Order18.mmCashMargin);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
	...
	public static final MMBusinessAttribute<SecuritiesOrder, SideCode> mmSide = new MMBusinessAttribute<SecuritiesOrder, SideCode>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmSide, Order18.mmSide, TradeLeg8.mmBuySellIndicator, TradeLeg10.mmBuySellIndicator, TradeLeg9.mmBuySellIndicator);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Side";
	...
	public static final MMBusinessAttribute<SecuritiesOrder, PositionEffectCode> mmPositionEffect = new MMBusinessAttribute<SecuritiesOrder, PositionEffectCode>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmPositionEffect, Order18.mmPositionEffect, InvestmentAccount61.mmProcessingOrder, InvestmentAccount63.mmProcessingOrder, InvestmentAccount62.mmProcessingOrder);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
	...
	public static final MMBusinessAttribute<SecuritiesOrder, CurrencyCode> mmSettlementCurrency = new MMBusinessAttribute<SecuritiesOrder, CurrencyCode>() {
		{
			derivation_lazy = () -> Arrays.asList(FundCashOutBreakdown3.mmSettlementCurrency, FundCashInBreakdown3.mmSettlementCurrency);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<SecuritiesOrder, EligibilityCode> mmOrderOriginatorEligibility = new MMBusinessAttribute<SecuritiesOrder, EligibilityCode>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmOrderOriginatorEligibility, Order18.mmOrderOriginatorEligibility, InvestmentAccount58.mmOrderOriginatorEligibility);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<SecuritiesOrder, SecuritiesQuantity> mmOrderedQuantity = new MMBusinessAssociationEnd<SecuritiesOrder, SecuritiesQuantity>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmConfirmationQuantity, Order18.mmConfirmationQuantity, PartialFill2.mmConfirmationQuantity, PartialFill2.mmOriginalOrderedQuantity, PartialFill2.mmPreviouslyExecutedQuantity,
					RedemptionOrder14.mmAmountOrUnitsOrPercentage, SubscriptionOrder15.mmAmountOrUnits, RedemptionOrder15.mmAmountOrUnitsOrPercentage, SubscriptionOrder14.mmAmountOrUnits);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
	...
	public static final MMBusinessAssociationEnd<SecuritiesOrder, TradingMarket> mmPlaceOfTrade = new MMBusinessAssociationEnd<SecuritiesOrder, TradingMarket>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmPlaceOfTrade, Order18.mmPlaceOfTrade);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
	...
	public static final MMBusinessAttribute<SecuritiesOrder, CurrencyAndAmount> mmOrderedAmount = new MMBusinessAttribute<SecuritiesOrder, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmGrossTradeAmount, Order18.mmGrossTradeAmount, TradeLeg8.mmGrossAmount, TradeLeg10.mmGrossAmount, TradeLeg9.mmGrossAmount, InvestmentFundsOrderBreakdown2.mmAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
	...
	public static final MMBusinessAttribute<SecuritiesOrder, Max3Number> mmGiveUpNumberOfDays = new MMBusinessAttribute<SecuritiesOrder, Max3Number>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmGiveUpNumberOfDays, Order18.mmGiveUpNumberOfDays);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<SecuritiesOrder, Optional<TradeRegulatoryConditionsCode>> mmTradeRegulatoryConditionsType = new MMBusinessAttribute<SecuritiesOrder, Optional<TradeRegulatoryConditionsCode>>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmTradeRegulatoryConditionsType, Order18.mmTradeRegulatoryConditionsType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<SecuritiesOrder, SecuritiesPricing> mmOrderPrice = new MMBusinessAssociationEnd<SecuritiesOrder, SecuritiesPricing>() {
		{
			derivation_lazy = () -> Arrays.asList(PartialFill2.mmDealPrice);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
	...
	public static final MMBusinessAttribute<SecuritiesOrder, ISODateTime> mmOrderDate = new MMBusinessAttribute<SecuritiesOrder, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmOrderBookingDate, Order18.mmOrderBookingDate, Unit8.mmOrderDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
	...
	public static final MMBusinessAttribute<SecuritiesOrder, OrderQuantityTypeCode> mmQuantityType = new MMBusinessAttribute<SecuritiesOrder, OrderQuantityTypeCode>() {
		{
			derivation_lazy = () -> Arrays.asList(FundCashOutBreakdown3.mmOriginalOrderQuantityType, FundCashInBreakdown3.mmOriginalOrderQuantityType, QuantityType1Choice.mmCode, QuantityType1Choice.mmProprietary);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesOrder.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "QuantityType";
	...
	public static final MMBusinessAttribute<SecuritiesOrder, Max35Text> mmClientOrderIdentification = new MMBusinessAttribute<SecuritiesOrder, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(Order17.mmClientOrderIdentification, Order17.mmSecondaryClientOrderIdentification, Order18.mmClientOrderIdentification, Order18.mmSecondaryClientOrderIdentification,
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Order17.mmBusinessProcessType, Order17.mmPartialFillDetails, Order18.mmBusinessProcessType, Order18.mmPartialFillDetails);
				...
				derivationComponent_lazy = () -> Arrays.asList(BusinessProcessType1Choice.mmObject(), Order17.mmObject(), Order18.mmObject(), PartialFill2.mmObject());
			}
