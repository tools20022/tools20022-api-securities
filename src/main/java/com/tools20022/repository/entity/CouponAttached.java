...
public class CouponAttached {
	...
	public static final MMBusinessAttribute<CouponAttached, ISODate> mmDate = new MMBusinessAttribute<CouponAttached, ISODate>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmCouponDate, FinancialInstrumentAttributes63.mmCouponDate, FinancialInstrumentAttributes64.mmCouponDate, FinancialInstrumentAttributes91.mmCouponDate,
					FinancialInstrumentAttributes92.mmCouponDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute<CouponAttached, Max3NumericText> mmNumber = new MMBusinessAttribute<CouponAttached, Max3NumericText>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmCouponAttachedNumber, CorporateAction2.mmCouponNumber, FinancialInstrumentAttributes63.mmCouponAttachedNumber,
					FinancialInstrumentAttributes64.mmCouponAttachedNumber, FinancialInstrumentAttributes91.mmCouponAttachedNumber, FinancialInstrumentAttributes92.mmCouponAttachedNumber, CorporateAction41.mmCouponNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CouponAttached.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Number";
