...
public class CouponAttached {
	...
	public static final MMBusinessAttribute mmDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmCouponDate, FinancialInstrumentAttributes63.mmCouponDate, FinancialInstrumentAttributes64.mmCouponDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmCouponAttachedNumber, CorporateAction2.mmCouponNumber, FinancialInstrumentAttributes63.mmCouponAttachedNumber,
					FinancialInstrumentAttributes64.mmCouponAttachedNumber, CorporateAction31.mmCouponNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CouponAttached.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Number";
