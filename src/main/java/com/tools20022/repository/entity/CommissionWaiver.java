...
public class CommissionWaiver {
	...
	public static final MMBusinessAttribute mmInstructionBasis = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(WaivingInstruction1Choice.mmCode, WaivingInstruction1Choice.mmProprietary, CommissionWaiver4.mmInstructionBasis, WaivingInstruction2Choice.mmCode, WaivingInstruction2Choice.mmProprietary);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CommissionWaiver.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmWaivedRate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CommissionWaiver4.mmWaivedRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CommissionWaiver.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "WaivedRate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(WaivingInstruction1Choice.mmObject(), CommissionWaiver4.mmObject(), WaivingInstruction2Choice.mmObject());
			}
