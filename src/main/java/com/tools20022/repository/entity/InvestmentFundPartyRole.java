		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				subType_lazy = () -> Arrays.asList(Grantor.mmObject(), Settlor.mmObject(), FundOrderDesk.mmObject());
				...
				derivationComponent_lazy = () -> Arrays.asList(Role5Choice.mmObject(), Role6Choice.mmObject());
			}
