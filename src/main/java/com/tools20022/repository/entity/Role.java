...
public class Role {
	...
	public static final MMBusinessAssociationEnd<Role, ContactPersonRole> mmContactPersonRole = new MMBusinessAssociationEnd<Role, ContactPersonRole>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionNarrative10.mmPartyContactNarrative, MeetingContactPerson2.mmContactPerson, CorporateActionNarrative27.mmPartyContactNarrative,
					CorporateActionNarrative30.mmPartyContactNarrative, CorporateActionNarrative31.mmPartyContactNarrative, CorporateActionNarrative28.mmPartyContactNarrative, AccountParties15.mmSeniorManagingOfficial,
					AccountParties15.mmProtector, AccountParties16.mmSeniorManagingOfficial, AccountParties16.mmProtector, Intermediary41.mmContactPerson);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Role.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Role, PartyRoleCode> mmPartyRole = new MMBusinessAttribute<Role, PartyRoleCode>() {
		{
			derivation_lazy = () -> Arrays.asList(Role4Choice.mmCode, Role4Choice.mmProprietary, Intermediary27.mmRole, Role5Choice.mmCode, Role5Choice.mmProprietary, Role6Choice.mmCode, Role6Choice.mmProprietary,
					InvestmentPlan14.mmInstalmentManagerRole, InvestmentPlan15.mmInstalmentManagerRole, InvestmentAccountOwnershipInformation15.mmCompanyLink, InvestmentAccountOwnershipInformation14.mmCompanyLink);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Role.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PartyRole";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(OtherParties18.mmObject(), Role4Choice.mmObject(), OtherParties27.mmObject(), OtherParties26.mmObject(), OtherParties28.mmObject());
			}
