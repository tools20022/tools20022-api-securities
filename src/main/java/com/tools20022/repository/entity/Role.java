...
public class Role {
	...
	public static final MMBusinessAssociationEnd mmContactPersonRole = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionNarrative10.mmPartyContactNarrative, MeetingContactPerson2.mmContactPerson, CorporateActionNarrative27.mmPartyContactNarrative, Intermediary34.mmContactPerson,
					...
					AccountParties15.mmProtector, AccountParties16.mmSeniorManagingOfficial, AccountParties16.mmProtector);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Role.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
