		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(ConfirmationParties3.mmSeller, ConfirmationParties4.mmSeller, ConfirmationParties2.mmSeller, SecuritiesTransactionReport4.mmSeller);
