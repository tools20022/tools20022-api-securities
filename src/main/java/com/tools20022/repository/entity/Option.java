...
public class Option extends Derivative {
	...
	public static final MMBusinessAttribute<Option, Number> mmPositionLimit = new MMBusinessAttribute<Option, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(FutureOrOptionDetails1.mmPositionLimit);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Option.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PositionLimit";
	...
	public static final MMBusinessAttribute<Option, Number> mmStrikeMultiplier = new MMBusinessAttribute<Option, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(DerivativeInstrument5.mmPriceMultiplier, DerivativeInstrument6.mmPriceMultiplier);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Option.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Option, OptionStyleCode> mmOptionStyle = new MMBusinessAttribute<Option, OptionStyleCode>() {
		{
			derivation_lazy = () -> Arrays.asList(OptionStyle6Choice.mmCode, OptionStyle6Choice.mmProprietary, FinancialInstrumentAttributes44.mmOptionStyle, OptionStyle8Choice.mmCode, OptionStyle8Choice.mmProprietary,
					FinancialInstrumentAttributes63.mmOptionStyle, FinancialInstrumentAttributes64.mmOptionStyle, DerivativeInstrument5.mmOptionExerciseStyle, DerivativeInstrument6.mmOptionExerciseStyle,
					FinancialInstrumentAttributes79.mmOptionStyle, FinancialInstrumentAttributes80.mmOptionStyle, FinancialInstrumentAttributes91.mmOptionStyle, FinancialInstrumentAttributes92.mmOptionStyle);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Option.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "OptionStyle";
	...
	public static final MMBusinessAttribute<Option, ISODateTime> mmEarliestExerciseDate = new MMBusinessAttribute<Option, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(OptionDateOrPeriod1Choice.mmEarliestExerciseDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Option.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Option, OptionDefinitionTypeCode> mmOptionType = new MMBusinessAttribute<Option, OptionDefinitionTypeCode>() {
		{
			derivation_lazy = () -> Arrays.asList(OptionType4Choice.mmCode, OptionType4Choice.mmProprietary, FinancialInstrumentAttributes44.mmOptionType, Option12.mmType, FinancialInstrumentAttributes63.mmOptionType,
					FinancialInstrumentAttributes64.mmOptionType, OptionType6Choice.mmCode, OptionType6Choice.mmProprietary, DerivativeInstrument5.mmOptionType, DerivativeInstrument6.mmOptionType,
					FinancialInstrumentAttributes91.mmOptionType, FinancialInstrumentAttributes92.mmOptionType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Option.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "OptionType";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(UnsecuredMarketTransaction4.mmCallPutOption);
				...
				derivationComponent_lazy = () -> Arrays.asList(OptionStyle6Choice.mmObject(), OptionType4Choice.mmObject(), Option12.mmObject(), OptionDateOrPeriod1Choice.mmObject(), OptionStyle8Choice.mmObject(),
						OptionType6Choice.mmObject());
			}
