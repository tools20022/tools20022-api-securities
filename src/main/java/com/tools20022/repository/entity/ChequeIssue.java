		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PaymentInstrument19Choice.mmChequeDetails, PaymentInstrument19Choice.mmBankersDraftDetails, PaymentInstrument21Choice.mmChequeDetails,
						PaymentInstrument21Choice.mmBankersDraftDetails, PaymentInstrument20Choice.mmChequeDetails, PaymentInstrument20Choice.mmBankersDraftDetails);
				...
				derivationComponent_lazy = () -> Arrays.asList(Cheque4.mmObject(), Cheque9.mmObject());
			}
