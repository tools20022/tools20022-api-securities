...
import com.tools20022.repository.choice.CashSettlementSystem3Choice;
import com.tools20022.repository.choice.CashSettlementSystem4Choice;
...
public class CashClearingSystem extends ClearingSystem {
	...
	public static final MMBusinessAttribute mmType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CashSettlementSystem3Choice.mmCode, CashSettlementSystem3Choice.mmProprietary, CashSettlementSystem4Choice.mmCode, CashSettlementSystem4Choice.mmProprietary);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystem.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Type";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(ClearingSystemIdentification2Choice.mmObject(), CashSettlementSystem4Choice.mmObject());
			}
