...
import com.tools20022.repository.msg.PaymentCard25;
import java.util.*;
...
public class PaymentCard {
	...
	public static final MMBusinessAttribute<PaymentCard, CardTypeCode> mmType = new MMBusinessAttribute<PaymentCard, CardTypeCode>() {
		{
			derivation_lazy = () -> Arrays.asList(PaymentCard18.mmType, PaymentCard25.mmType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentCard.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Type";
	...
	public static final MMBusinessAttribute<PaymentCard, Max35Text> mmNumber = new MMBusinessAttribute<PaymentCard, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(PaymentCard18.mmNumber, PaymentCard25.mmNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentCard.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Number";
	...
	public static final MMBusinessAttribute<PaymentCard, ISOYearMonth> mmStartDate = new MMBusinessAttribute<PaymentCard, ISOYearMonth>() {
		{
			derivation_lazy = () -> Arrays.asList(PaymentCard18.mmStartDate, PaymentCard25.mmStartDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentCard.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "StartDate";
	...
	public static final MMBusinessAttribute<PaymentCard, ISOYearMonth> mmExpiryDate = new MMBusinessAttribute<PaymentCard, ISOYearMonth>() {
		{
			derivation_lazy = () -> Arrays.asList(PaymentCard18.mmExpiryDate, PaymentCard25.mmExpiryDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentCard.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ExpiryDate";
	...
	public static final MMBusinessAttribute<PaymentCard, Max35Text> mmSecurityCode = new MMBusinessAttribute<PaymentCard, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(PaymentCard18.mmSecurityCode, PaymentCard25.mmSecurityCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentCard.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "SecurityCode";
	...
	public static final MMBusinessAttribute<PaymentCard, Max35Text> mmSequenceNumber = new MMBusinessAttribute<PaymentCard, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(PaymentCard18.mmSequenceNumber, PaymentCard25.mmSequenceNumber);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentCard.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "SequenceNumber";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(PaymentCard18.mmObject(), PaymentCard25.mmObject());
			}
