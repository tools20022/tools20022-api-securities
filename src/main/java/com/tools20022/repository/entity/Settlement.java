...
import com.tools20022.repository.choice.CentralCounterPartyEligibility3Choice;
import com.tools20022.repository.choice.CentralCounterPartyEligibility4Choice;
...
public class Settlement {
	...
	public static final MMBusinessAttribute mmCentralCounterpartyEligibilityIndicator = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CentralCounterPartyEligibility3Choice.mmIndicator, CentralCounterPartyEligibility4Choice.mmIndicator, CentralCounterPartyEligibility4Choice.mmProprietary);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd mmStandingSettlementInstruction = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(SettlementDetails43.mmFXStandingInstruction, InterestAmount1.mmStandardSettlementInstructions, InterestAmount2.mmStandardSettlementInstructions, SettlementDetails97.mmFXStandingInstruction,
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(CentralCounterPartyEligibility3Choice.mmObject(), CentralCounterPartyEligibility4Choice.mmObject());
			}
