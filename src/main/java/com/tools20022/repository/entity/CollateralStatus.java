...
public class CollateralStatus extends Status {
	...
	public static final MMBusinessAttribute mmResponseStatus = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ResponseStatus5Choice.mmCode, Status19Choice.mmResponseStatus, OtherCollateralResponse2.mmResponseType, CashCollateralResponse2.mmResponseType);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmSettlement = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CollateralValuation5.mmSettlementStatus);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CollateralStatus.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Settlement";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(CollateralCancellationType1Choice.mmObject(), CollateralCancellationReason1.mmObject(), RejectionStatus2.mmObject(), CollateralCancellationStatus1.mmObject(),
						CollateralConfirmation1.mmObject(), InterestResponse1.mmObject(), SecuritiesCollateralResponse1.mmObject(), OtherCollateralResponse2.mmObject(), CashCollateralResponse2.mmObject());
			}
