...
public class CashEntry extends Entry {
	...
	public static final MMBusinessAssociationEnd<CashEntry, List<CashAccount>> mmCashAccount = new MMBusinessAssociationEnd<CashEntry, List<CashAccount>>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionCashMovements2.mmAccountDetails, CashMovement1.mmAccountDetails, CashMovement2.mmAccountDetails, CashMovement3.mmAccountDetails);
			isDerived = false;
	...
	public static final MMBusinessAttribute<CashEntry, CurrencyAndAmount> mmAmount = new MMBusinessAttribute<CashEntry, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionCashMovements2.mmPostingAmount, AmountAndDirection53.mmAmount, AmountAndDirection61.mmAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashEntry.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Amount";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(CorporateActionCashMovements2.mmObject(), AmountAndDirection53.mmObject(), AmountAndDirection61.mmObject());
			}
