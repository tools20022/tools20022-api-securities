...
public class BuyIn extends ObligationFulfilment {
	...
	public static final MMBusinessAttribute mmBuyinDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(BuyIn2.mmDate, BuyIn4.mmExpectedBuyInDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.BuyIn.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "BuyinDate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(BuyIn3.mmObject(), CashCompensation1.mmObject(), BuyIn2.mmObject(), BuyIn4.mmObject());
			}
