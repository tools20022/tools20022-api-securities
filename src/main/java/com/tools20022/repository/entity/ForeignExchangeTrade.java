...
public class ForeignExchangeTrade extends TreasuryTrade {
	...
	public static final MMBusinessAssociationEnd<ForeignExchangeTrade, CurrencyExchange> mmAgreedRate = new MMBusinessAssociationEnd<ForeignExchangeTrade, CurrencyExchange>() {
		{
			derivation_lazy = () -> Arrays.asList(AmountAndDirection29.mmForeignExchangeDetails, AmountAndDirection28.mmForeignExchangeDetails, AmountAndDirection27.mmForeignExchangeDetails, FundCashForecast7.mmForeignExchangeRate,
					EstimatedFundCashForecast6.mmForeignExchangeRate, FundCashForecast6.mmForeignExchangeRate, EstimatedFundCashForecast5.mmForeignExchangeRate, AmountAndDirection49.mmForeignExchangeDetails,
					AmountAndDirection44.mmForeignExchangeDetails, AmountAndDirection47.mmForeignExchangeDetails, SwitchExecution7.mmForeignExchangeDetails, SwitchOrder7.mmForeignExchangeDetails, RedemptionOrder14.mmForeignExchangeDetails,
					...
					ReceiveInformation18.mmForeignExchangeDetails, DeliverInformation19.mmForeignExchangeDetails, ReceiveInformation19.mmForeignExchangeDetails, DeliverInformation18.mmForeignExchangeDetails,
					AmountAndDirection87.mmForeignExchangeDetails, AmountAndDirection88.mmForeignExchangeDetails, AmountAndDirection89.mmForeignExchangeDetails);
			isDerived = false;
	...
	public static final MMBusinessAttribute<ForeignExchangeTrade, CurrencyAndAmount> mmBuyAmount = new MMBusinessAttribute<ForeignExchangeTrade, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms33.mmToAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ForeignExchangeTrade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "BuyAmount";
	...
	public static final MMBusinessAttribute<ForeignExchangeTrade, CurrencyAndAmount> mmSellAmount = new MMBusinessAttribute<ForeignExchangeTrade, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms33.mmFromAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ForeignExchangeTrade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "SellAmount";
