...
public class ForeignExchangeTrade extends TreasuryTrade {
	...
	public static final MMBusinessAssociationEnd mmAgreedRate = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(AmountAndDirection29.mmForeignExchangeDetails, AmountAndDirection28.mmForeignExchangeDetails, AmountAndDirection27.mmForeignExchangeDetails, FundCashForecast7.mmForeignExchangeRate,
					EstimatedFundCashForecast6.mmForeignExchangeRate, FundCashForecast6.mmForeignExchangeRate, EstimatedFundCashForecast5.mmForeignExchangeRate, AmountAndDirection46.mmForeignExchangeDetails,
					AmountAndDirection49.mmForeignExchangeDetails, AmountAndDirection48.mmForeignExchangeDetails, AmountAndDirection44.mmForeignExchangeDetails, AmountAndDirection45.mmForeignExchangeDetails,
					AmountAndDirection47.mmForeignExchangeDetails, ReceiveInformation17.mmForeignExchangeDetails, ReceiveInformation16.mmForeignExchangeDetails, DeliverInformation16.mmForeignExchangeDetails,
					DeliverInformation17.mmForeignExchangeDetails, SwitchExecution7.mmForeignExchangeDetails, SwitchOrder7.mmForeignExchangeDetails, RedemptionOrder14.mmForeignExchangeDetails,
					SubscriptionExecution13.mmForeignExchangeDetails, SubscriptionExecution12.mmForeignExchangeDetails, SubscriptionOrder15.mmForeignExchangeDetails, RedemptionOrder15.mmForeignExchangeDetails,
					RedemptionExecution16.mmForeignExchangeDetails, SubscriptionOrder14.mmForeignExchangeDetails, RedemptionExecution15.mmForeignExchangeDetails, ForeignExchangeSwapTransaction3.mmForeignExchange);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmBuyAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms26.mmToAmount, ForeignExchangeTerms33.mmToAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ForeignExchangeTrade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "BuyAmount";
	...
	public static final MMBusinessAttribute mmSellAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ForeignExchangeTerms26.mmFromAmount, ForeignExchangeTerms33.mmFromAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ForeignExchangeTrade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "SellAmount";
