...
public class Scheme {
	...
	public static final MMBusinessAttribute mmNameShort = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(GenericIdentification1.mmSchemeName, GenericIdentification13.mmSchemeName, GenericIdentification20.mmSchemeName, GenericIdentification47.mmSchemeName,
					PersonIdentificationSchemeName1Choice.mmProprietary, GenericIdentification19.mmSchemeName, GenericIdentification27.mmSchemeName, GenericIdentification38.mmSchemeName, GenericIdentification29.mmSchemeName,
					SecuritiesCertificate3.mmSchemeName, GenericIdentification36.mmSchemeName, GenericIdentification30.mmSchemeName, GenericIdentification40.mmSchemeName, GenericIdentification56.mmSchemeName,
					SecuritiesCertificate4.mmSchemeName, ProprietaryQuantity8.mmSchemeName, ProprietaryQuantity7.mmSchemeName);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialIdentificationSchemeName1Choice.mmCode, FinancialIdentificationSchemeName1Choice.mmProprietary, AccountSchemeName1Choice.mmCode, AccountSchemeName1Choice.mmProprietary,
					...
					IdentificationSource3Choice.mmCode, GenericIdentification49.mmIdentificationType, IdentificationSource5Choice.mmDomesticIdentificationSource);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Scheme.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Code";
	...
	public static final MMBusinessAssociationEnd mmIdentification = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(OtherIdentification1.mmType, OtherIdentification4.mmType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Scheme.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Identification";
