...
public class RateAndAmount {
	...
	public static final MMBusinessAttribute mmAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(RelatedTaxType1.mmAmount, GrossDividendRate2.mmAmount, CorporateActionAmounts1.mmFullyFrankedAmount, TaxCreditRateFormat7Choice.mmAmount, RateAndAmountFormat39Choice.mmAmount,
					CorporateActionAmounts37.mmFullyFrankedAmount, SolicitationFeeRateFormat7Choice.mmAmount, TaxCreditRateFormat8Choice.mmAmount, CorporateActionAmounts36.mmFullyFrankedAmount, RateFormat20Choice.mmAmount,
					GrossDividendRateFormat19Choice.mmAmount, AmountAndRateStatus1.mmAmount, GrossDividendRateFormat21Choice.mmAmount, GrossDividendRateFormat20Choice.mmAmount, GrossDividendRateFormat22Choice.mmAmount,
					SolicitationFeeRateFormat8Choice.mmAmount, CorporateActionAmounts38.mmFullyFrankedAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.RateAndAmount.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Amount";
	...
	public static final MMBusinessAttribute mmRate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(RateFormat3Choice.mmRate, RateOrAbsoluteValue1Choice.mmRateValue, RateFormat1Choice.mmRate, RateFormat12Choice.mmRate, TaxCreditRateFormat7Choice.mmRate, RateAndAmountFormat39Choice.mmRate,
					SolicitationFeeRateFormat7Choice.mmRate, TaxCreditRateFormat8Choice.mmRate, RateFormat20Choice.mmRate, SolicitationFeeRateFormat8Choice.mmRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.RateAndAmount.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Rate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(GrossDividendRateFormat19Choice.mmAmountAndRateStatus, AmountAndRateStatus1.mmRateStatus, NetDividendRateFormat21Choice.mmAmountAndRateStatus,
						...
						NetDividendRateFormat24Choice.mmAmountAndRateStatus, GrossDividendRateFormat22Choice.mmAmountAndRateStatus);
				...
				derivationComponent_lazy = () -> Arrays.asList(RateFormat3Choice.mmObject(), RateFormat7Choice.mmObject(), RateOrAbsoluteValue1Choice.mmObject(), RateFormat1Choice.mmObject(), RelatedTaxType1.mmObject(),
						RateFormat12Choice.mmObject(), TaxCreditRateFormat7Choice.mmObject(), RateAndAmountFormat39Choice.mmObject(), SolicitationFeeRateFormat7Choice.mmObject(), TaxCreditRateFormat8Choice.mmObject(),
						RateFormat20Choice.mmObject(), AmountAndRateStatus1.mmObject(), SolicitationFeeRateFormat8Choice.mmObject());
			}
