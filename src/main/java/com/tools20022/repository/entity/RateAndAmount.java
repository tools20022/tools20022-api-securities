...
public class RateAndAmount {
	...
	public static final MMBusinessAttribute<RateAndAmount, CurrencyAndAmount> mmAmount = new MMBusinessAttribute<RateAndAmount, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(RelatedTaxType1.mmAmount, GrossDividendRate2.mmAmount, CorporateActionAmounts1.mmFullyFrankedAmount, RateAndAmountFormat39Choice.mmAmount, SolicitationFeeRateFormat7Choice.mmAmount,
					RateFormat20Choice.mmAmount, AmountAndRateStatus1.mmAmount, SolicitationFeeRateFormat8Choice.mmAmount, CorporateActionAmounts42.mmFullyFrankedAmount, CorporateActionAmounts43.mmFullyFrankedAmount,
					GrossDividendRateFormat27Choice.mmAmount, RateFormat22Choice.mmAmount, GrossDividendRateFormat29Choice.mmAmount, GrossDividendRateFormat28Choice.mmAmount, CorporateActionAmounts44.mmFullyFrankedAmount,
					GrossDividendRateFormat30Choice.mmAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.RateAndAmount.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Amount";
	...
	public static final MMBusinessAttribute<RateAndAmount, PercentageRate> mmRate = new MMBusinessAttribute<RateAndAmount, PercentageRate>() {
		{
			derivation_lazy = () -> Arrays.asList(RateFormat3Choice.mmRate, RateOrAbsoluteValue1Choice.mmRateValue, RateFormat1Choice.mmRate, RateFormat12Choice.mmRate, RateAndAmountFormat39Choice.mmRate,
					SolicitationFeeRateFormat7Choice.mmRate, RateFormat20Choice.mmRate, SolicitationFeeRateFormat8Choice.mmRate, RateFormat22Choice.mmRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.RateAndAmount.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Rate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(AmountAndRateStatus1.mmRateStatus, GrossDividendRateFormat27Choice.mmAmountAndRateStatus, NetDividendRateFormat29Choice.mmAmountAndRateStatus,
						NetDividendRateFormat32Choice.mmAmountAndRateStatus, GrossDividendRateFormat29Choice.mmAmountAndRateStatus, NetDividendRateFormat30Choice.mmAmountAndRateStatus, GrossDividendRateFormat28Choice.mmAmountAndRateStatus,
						NetDividendRateFormat31Choice.mmAmountAndRateStatus, GrossDividendRateFormat30Choice.mmAmountAndRateStatus);
				...
				derivationComponent_lazy = () -> Arrays.asList(RateFormat3Choice.mmObject(), RateFormat7Choice.mmObject(), RateOrAbsoluteValue1Choice.mmObject(), RateFormat1Choice.mmObject(), RelatedTaxType1.mmObject(),
						RateFormat12Choice.mmObject(), RateAndAmountFormat39Choice.mmObject(), SolicitationFeeRateFormat7Choice.mmObject(), RateFormat20Choice.mmObject(), AmountAndRateStatus1.mmObject(),
						SolicitationFeeRateFormat8Choice.mmObject(), RateFormat22Choice.mmObject());
			}
