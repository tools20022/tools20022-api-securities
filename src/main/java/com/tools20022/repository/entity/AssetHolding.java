...
public class AssetHolding {
	...
	public static final MMBusinessAttribute<AssetHolding, ActiveOrHistoricCurrencyAndAmount> mmHoldingValue = new MMBusinessAttribute<AssetHolding, ActiveOrHistoricCurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(BalanceAmounts1.mmHoldingValue, BalanceAmounts1.mmPreviousHoldingValue, BalanceAmounts2.mmHoldingValue, AggregateBalancePerSafekeepingPlace4.mmHoldingValue,
					...
					AggregateBalanceInformation4.mmPreviousHoldingValue, DebtInstrument2.mmNominalValuePerUnit, FinancialInstrument61.mmAverageAcquisitionPrice, FinancialInstrument65.mmAverageAcquisitionPrice);
			isDerived = false;
	...
	public static final MMBusinessAttribute<AssetHolding, CurrencyAndAmount> mmBookValue = new MMBusinessAttribute<AssetHolding, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(BalanceAmounts1.mmBookValue, BalanceAmounts2.mmBookValue, AggregateBalancePerSafekeepingPlace4.mmBookValue, AggregateBalanceInformation3.mmBookValue, BalanceAmounts3.mmBookValue,
					AggregateBalancePerSafekeepingPlace3.mmBookValue, AggregateBalanceInformation4.mmBookValue, OtherAmounts16.mmBookValue, OtherAmounts16.mmRemainingBookValue, TransferStatusAndReason5.mmAveragePrice,
					Transfer35.mmAveragePrice, Transfer35.mmNewAveragePrice, Transfer34.mmAveragePrice, FinancialInstrument60.mmAverageAcquisitionPrice, FinancialInstrument60.mmTotalBookValue, FinancialInstrument61.mmTotalBookValue,
					FinancialInstrument65.mmTotalBookValue, OtherAmounts41.mmBookValue, OtherAmounts40.mmBookValue);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.AssetHolding.mmObject();
	...
	public static final MMBusinessAttribute<AssetHolding, CurrencyAndAmount> mmFaceAmount = new MMBusinessAttribute<AssetHolding, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentQuantity1Choice.mmFaceAmount, OriginalAndCurrentQuantities1.mmFaceAmount, FinancialInstrumentQuantity19Choice.mmFaceAmount,
					FinancialInstrumentQuantity20Choice.mmFaceAmount, FinancialInstrumentQuantityChoice.mmFaceAmount, FinancialInstrumentQuantity18Choice.mmFaceAmount, FinancialInstrumentAttributes44.mmFaceAmount,
					UnitOrFaceAmount1Choice.mmFaceAmount, UnitOrFaceAmountOrCode1Choice.mmFaceAmount, Quantity18Choice.mmOriginalAndCurrentFaceAmount, OriginalAndCurrentQuantities6.mmFaceAmount,
	...
	public static final MMBusinessAttribute<AssetHolding, CurrencyAndAmount> mmAmortisedFaceValue = new MMBusinessAttribute<AssetHolding, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentQuantity1Choice.mmAmortisedValue, OriginalAndCurrentQuantities1.mmAmortisedValue, FinancialInstrumentQuantity19Choice.mmAmortisedValue,
					FinancialInstrumentQuantity20Choice.mmAmortisedValue, FinancialInstrumentQuantityChoice.mmAmortisedValue, OtherAmounts16.mmRemainingFaceValue, OriginalAndCurrentQuantities6.mmAmortisedValue,
					FinancialInstrumentQuantity25Choice.mmMonetaryValue);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.AssetHolding.mmObject();
	...
	public static final MMBusinessAttribute<AssetHolding, ActiveCurrencyAndAmount> mmMarketValue = new MMBusinessAttribute<AssetHolding, ActiveCurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(OtherAmounts16.mmNetMarketValue, Collateral3.mmMarketValue, Collateral6.mmMarketValue, OtherCollateral7.mmMarketValue, OtherCollateral6.mmMarketValue, SecuritiesCollateral6.mmMarketValue,
					SecuritiesCollateral5.mmMarketValue, OtherCollateral5.mmMarketValue, SecuritiesCollateral7.mmMarketValue, SecuritiesCollateral8.mmMarketValue, FinancialInstrumentAttributes93.mmMarketPrice);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.AssetHolding.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "MarketValue";
	...
	public static final MMBusinessAssociationEnd<AssetHolding, List<HaircutValuation>> mmHaircut = new MMBusinessAssociationEnd<AssetHolding, List<HaircutValuation>>() {
		{
			derivation_lazy = () -> Arrays.asList(SecuritiesFinancing10.mmSecuritiesHaircut, AggregateBalanceInformation30.mmValuationHaircutDetails, SecuritiesFinancingTransactionDetails27.mmSecuritiesHaircut,
					SecuritiesFinancingTransactionDetails35.mmSecuritiesHaircut, Collateral18.mmHaircut, SecuritiesFinancingTransactionDetails37.mmSecuritiesHaircut);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.AssetHolding.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Haircut";
