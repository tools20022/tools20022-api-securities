...
public class Country {
	...
	public static final MMBusinessAttribute mmCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress1.mmCountry, LocalMarketAnnex2.mmCountry, StructuredLongPostalAddress1.mmCountry, PostalAddress6.mmCountry, DateAndPlaceOfBirth.mmCountryOfBirth,
					PartyIdentification44Choice.mmCountry, SafekeepingPlaceFormatChoice.mmIdentificationAsCountry, PartyIdentification15.mmCountry, PostalAddress8.mmCountry, AlternatePartyIdentification5.mmCountry,
					PartyIdentificationAndAccount79.mmCountryOfResidence, AlternatePartyIdentification6.mmCountry, PartyIdentification68Choice.mmCountry, PartyIdentification42.mmCountryOfResidence,
					PlaceOfTradeIdentification1Choice.mmCountry, BeneficialOwner1.mmNationality, PostalAddress2.mmCountry, AlternatePartyIdentification4.mmCountry, PartyIdentification34Choice.mmCountry,
					PartyIdentification75Choice.mmCountry, BeneficialOwner2.mmNationality, AlternatePartyIdentification7.mmCountry, PartyIdentificationAndAccount108.mmNationality, PartyIdentification93Choice.mmCountry,
					PartyIdentification93.mmDomicileCountry, PartyIdentification93.mmNonDomicileCountry, Organisation21.mmTaxationCountry, Organisation21.mmRegistrationCountry, PostalAddress21.mmCountry,
					CountryAndResidentialStatusType2.mmCountry, PartyIdentification102Choice.mmCountry, AlternatePartyIdentification8.mmCountry, CountryCodeAndName3.mmCode, PersonIdentification12.mmCountryOfBranch,
					RedemptionBulkExecution5.mmPlaceOfTrade, Organisation30.mmRegistrationCountry, Organisation29.mmRegistrationCountry);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Country.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Code";
	...
	public static final MMBusinessAttribute mmName = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CountryCodeAndName3.mmName);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Country.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Name";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(CountryCodeAndName3.mmObject());
			}
