	...
	public static final MMBusinessAttribute<Country, CountryCode> mmCode = new MMBusinessAttribute<Country, CountryCode>() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress1.mmCountry, LocalMarketAnnex2.mmCountry, StructuredLongPostalAddress1.mmCountry, PostalAddress6.mmCountry, DateAndPlaceOfBirth.mmCountryOfBirth,
					...
					PartyIdentification93.mmDomicileCountry, PartyIdentification93.mmNonDomicileCountry, PostalAddress21.mmCountry, CountryAndResidentialStatusType2.mmCountry, PartyIdentification102Choice.mmCountry,
					AlternatePartyIdentification8.mmCountry, CountryCodeAndName3.mmCode, PersonIdentification12.mmCountryOfBranch, RedemptionBulkExecution5.mmPlaceOfTrade, Organisation30.mmRegistrationCountry,
					Organisation29.mmRegistrationCountry, Organisation31.mmTaxationCountry, Organisation31.mmRegistrationCountry);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Country.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Code";
