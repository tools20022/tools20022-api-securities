...
public class CollateralSubstitution {
	...
	public static final MMBusinessAttribute<CollateralSubstitution, CollateralSubstitutionTypeCode> mmType = new MMBusinessAttribute<CollateralSubstitution, CollateralSubstitutionTypeCode>() {
		{
			derivation_lazy = () -> Arrays.asList(CollateralSubstitution5.mmCollateralSubstitutionType, CollateralSubstitution4.mmCollateralSubstitutionType);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(CollateralSubstitutionResponse1.mmObject(), CollateralSubstitutionResponse2.mmObject(), SubstitutionResponse1.mmObject(), CollateralSubstitution5.mmObject(),
						CollateralSubstitution4.mmObject());
			}
