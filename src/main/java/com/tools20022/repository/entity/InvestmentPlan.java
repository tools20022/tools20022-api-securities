...
public class InvestmentPlan {
	...
	public static final MMBusinessAttribute<InvestmentPlan, FrequencyCode> mmFrequency = new MMBusinessAttribute<InvestmentPlan, FrequencyCode>() {
		{
			derivation_lazy = () -> Arrays.asList(InvestmentPlan14.mmFrequency, InvestmentPlan15.mmFrequency);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd<InvestmentPlan, List<Instalment>> mmInstalment = new MMBusinessAssociationEnd<InvestmentPlan, List<Instalment>>() {
		{
			derivation_lazy = () -> Arrays.asList(InvestmentPlan14.mmInitialAmount, InvestmentPlan15.mmInitialAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.InvestmentPlan.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Instalment";
	...
	public static final MMBusinessAttribute<InvestmentPlan, PlanStatusCode> mmPlanStatus = new MMBusinessAttribute<InvestmentPlan, PlanStatusCode>() {
		{
			derivation_lazy = () -> Arrays.asList(PlanStatus2Choice.mmCode, InvestmentPlan14.mmPlanStatus, InvestmentPlan15.mmPlanStatus);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.InvestmentPlan.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PlanStatus";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(InvestmentPlan14.mmQuantity, InvestmentPlan15.mmQuantity);
				...
				derivationComponent_lazy = () -> Arrays.asList(PlanStatus2Choice.mmObject(), InvestmentPlan14.mmObject(), InvestmentPlan15.mmObject());
			}
