...
public class SecuritiesRelatedFees extends Charges {
	...
	public static final MMBusinessAttribute<SecuritiesRelatedFees, CurrencyAndAmount> mmRegulatoryFeesAmount = new MMBusinessAttribute<SecuritiesRelatedFees, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(OtherAmounts16.mmRegulatoryAmount, CorporateActionAmounts1.mmRegulatoryFeesAmount, OtherAmounts29.mmRegulatoryAmount, OtherAmounts41.mmRegulatoryAmount, OtherAmounts39.mmRegulatoryAmount,
					OtherAmounts40.mmRegulatoryAmount, CorporateActionAmounts42.mmRegulatoryFeesAmount, CorporateActionAmounts43.mmRegulatoryFeesAmount, CorporateActionAmounts44.mmRegulatoryFeesAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesRelatedFees.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<SecuritiesRelatedFees, CurrencyAndAmount> mmShippingFeesAmount = new MMBusinessAttribute<SecuritiesRelatedFees, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionAmounts1.mmShippingFeesAmount, OtherAmounts29.mmShippingAmount, OtherAmounts41.mmShippingAmount, OtherAmounts39.mmShippingAmount, OtherAmounts40.mmShippingAmount,
					CorporateActionAmounts42.mmShippingFeesAmount, CorporateActionAmounts43.mmShippingFeesAmount, CorporateActionAmounts44.mmShippingFeesAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesRelatedFees.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<SecuritiesRelatedFees, CurrencyAndAmount> mmResearchFee = new MMBusinessAttribute<SecuritiesRelatedFees, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(OtherAmounts41.mmResearchFee, OtherAmounts39.mmResearchFee, OtherAmounts40.mmResearchFee);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.SecuritiesRelatedFees.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ResearchFee";
