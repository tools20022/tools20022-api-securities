...
public class CashAccount extends Account {
	...
	public static final MMBusinessAttribute mmCashAccountType = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CashAccount22.mmAccountTypeDescription, CashAccount33.mmCashAccountPurpose);
			isDerived = false;
	...
	public static final MMBusinessAssociationEnd mmRelatedInvestmentAccount = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CashAccount33.mmInvestmentAccountType);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashAccount.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd mmCommission = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(FeeAndTax1.mmCommercialAgreementReference);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashAccount.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Commission";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Account8Choice.mmCashAccount, ConfirmationPartyDetails4.mmCashDetails, CashProceeds1.mmAccountDetails, CorporateActionStandingInstruction1.mmCashDistributionDetails,
						CorporateActionOption116.mmCashAccount, CashSettlement1.mmCashAccountDetails, CashSettlement2.mmCashAccountDetails);
				...
				derivationComponent_lazy = () -> Arrays.asList(CashAccount21.mmObject(), CashAccount22.mmObject(), Account8Choice.mmObject(), CashAccount19.mmObject(), CashAccount18.mmObject(), CashAccount17.mmObject(),
						CashAccount34.mmObject(), CashAccount33.mmObject());
			}
