...
public class Agreement {
	...
	public static final MMBusinessAttribute mmDateSigned = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays
					.asList(Agreement3.mmDate, Agreement4.mmAgreementDate, InvestmentAccount61.mmAccountSignatureDateTime, InvestmentAccount63.mmAccountSignatureDateTime, InvestmentAccount62.mmAccountSignatureDateTime);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmDescription = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Agreement3.mmDescription, Agreement4.mmAgreementDetails);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Agreement.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Description";
