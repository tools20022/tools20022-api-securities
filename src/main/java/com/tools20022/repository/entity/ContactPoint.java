...
public class ContactPoint {
	...
	public static final MMBusinessAttribute mmBICAddress = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ContactAttributes1.mmIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ContactPoint.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "BICAddress";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(ContactAttributes1.mmObject(), CommunicationAddress4.mmObject(), LocationFormat1Choice.mmObject(), CommunicationAddress6.mmObject());
			}
