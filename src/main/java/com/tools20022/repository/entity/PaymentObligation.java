...
public class PaymentObligation extends Obligation {
	...
	public static final MMBusinessAssociationEnd mmPaymentOffset = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(InvestmentPlan14.mmCashSettlement, SwitchExecution7.mmCashSettlementDetails, SwitchOrder7.mmCashSettlementDetails, RedemptionOrder14.mmCashSettlementDetails,
					InvestmentPlan15.mmModifiedCashSettlement, SubscriptionExecution13.mmCashSettlementDetails, SubscriptionExecution12.mmCashSettlementDetails, SubscriptionOrder15.mmCashSettlementDetails,
					RedemptionOrder15.mmCashSettlementDetails, RedemptionExecution16.mmCashSettlementDetails, SubscriptionOrder14.mmCashSettlementDetails, RedemptionExecution15.mmCashSettlementDetails);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmPurpose = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Purpose3Choice.mmSecuritiesPurposeCode, Purpose3Choice.mmProprietary);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentObligation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Purpose";
	...
	public static final MMBusinessAttribute mmAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FailedMovement1.mmCashAmount, CashCompensation1.mmSettlementAmount, InitialAmount1Choice.mmAmount, SecuredMarketTransaction4.mmTransactionNominalAmount,
					OvernightIndexSwapTransaction4.mmTransactionNominalAmount, UnsecuredMarketTransaction4.mmTransactionNominalAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentObligation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Amount";
	...
	public static final MMBusinessAssociationEnd mmExchangeRateInformation = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(SecuritiesTradeDetails51.mmFXAdditionalDetails, SecuritiesTradeDetails53.mmFXAdditionalDetails, SecuritiesTradeDetails55.mmFXAdditionalDetails,
					SecuritiesTradeDetails56.mmFXAdditionalDetails, SecuritiesTradeDetails52.mmFXAdditionalDetails, SecuritiesTradeDetails50.mmFXAdditionalDetails, SecuritiesTradeDetails67.mmFXAdditionalDetails);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.PaymentObligation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(Purpose3Choice.mmObject());
			}
