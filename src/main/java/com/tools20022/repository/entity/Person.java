...
public class Person extends Party {
	...
	public static final MMBusinessAttribute<Person, GenderCode> mmGender = new MMBusinessAttribute<Person, GenderCode>() {
		{
			derivation_lazy = () -> Arrays.asList(IndividualPerson8.mmGender, IndividualPerson30.mmGender, IndividualPerson33.mmGender, IndividualPerson35.mmGender, IndividualPerson34.mmGender);
			isDerived = false;
	...
	public static final MMBusinessAttribute<Person, ISODateTime> mmBirthDate = new MMBusinessAttribute<Person, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(IndividualPerson8.mmBirthDate, DateAndPlaceOfBirth.mmBirthDate, PartyAdditionalIdentification2Choice.mmBirthDate, PersonIdentification10.mmBirthDate, IndividualPerson30.mmBirthDate,
					IndividualPerson32.mmBirthDate, IndividualPerson31.mmBirthDate, IndividualPerson33.mmBirthDate, IndividualPerson35.mmBirthDate, IndividualPerson34.mmBirthDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "BirthDate";
	...
	public static final MMBusinessAssociationEnd<Person, com.tools20022.repository.entity.Location> mmPlaceOfBirth = new MMBusinessAssociationEnd<Person, com.tools20022.repository.entity.Location>() {
		{
			derivation_lazy = () -> Arrays.asList(IndividualPerson33.mmCountryOfBirth, IndividualPerson33.mmProvinceOfBirth, IndividualPerson33.mmCityOfBirth, IndividualPerson34.mmCountryOfBirth, IndividualPerson34.mmProvinceOfBirth,
					IndividualPerson34.mmCityOfBirth);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PlaceOfBirth";
	...
	public static final MMBusinessAttribute<Person, Max35Text> mmProfession = new MMBusinessAttribute<Person, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(IndividualPerson33.mmProfession, IndividualPerson34.mmProfession);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Profession";
	...
	public static final MMBusinessAttribute<Person, ResidentialStatusCode> mmResidentialStatus = new MMBusinessAttribute<Person, ResidentialStatusCode>() {
		{
			derivation_lazy = () -> Arrays.asList(CountryAndResidentialStatusType2.mmResidentialStatus, IndividualPerson32.mmCountryAndResidentialStatus, IndividualPerson31.mmCountryAndResidentialStatus,
					InvestmentAccountOwnershipInformation15.mmCountryAndResidentialStatus, InvestmentAccountOwnershipInformation14.mmCountryAndResidentialStatus);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<Person, List<Country>> mmNationality = new MMBusinessAssociationEnd<Person, List<Country>>() {
		{
			derivation_lazy = () -> Arrays.asList(SecuritiesAccount10.mmAccountOwnerNationality, IndividualPerson33.mmModifiedCitizenship, IndividualPerson34.mmCitizenship, CitizenshipInformation2.mmNationality);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Nationality";
	...
	public static final MMBusinessAttribute<Person, YesNoIndicator> mmMinorIndicator = new MMBusinessAttribute<Person, YesNoIndicator>() {
		{
			derivation_lazy = () -> Arrays.asList(CitizenshipInformation2.mmMinorIndicator);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "MinorIndicator";
	...
	public static final MMBusinessAttribute<Person, Max35Text> mmBusinessFunctionTitle = new MMBusinessAttribute<Person, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(IndividualPerson33.mmBusinessFunction, IndividualPerson34.mmBusinessFunction);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<Person, List<PersonIdentification>> mmPersonIdentification = new MMBusinessAssociationEnd<Person, List<PersonIdentification>>() {
		{
			derivation_lazy = () -> Arrays.asList(IndividualPerson25.mmIdentification, IndividualPerson26.mmIdentification, OwnerIdentification2Choice.mmIndividualOwnerIdentification, AccountOwner2Choice.mmIndividualOwnerIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Person, CivilStatusCode> mmCivilStatus = new MMBusinessAttribute<Person, CivilStatusCode>() {
		{
			derivation_lazy = () -> Arrays.asList(IndividualPerson33.mmCivilStatus, IndividualPerson34.mmCivilStatus);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "CivilStatus";
	...
	public static final MMBusinessAttribute<Person, ISODateTime> mmDeathDate = new MMBusinessAttribute<Person, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(IndividualPerson33.mmDeathDate, IndividualPerson34.mmDeathDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Person.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "DeathDate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Instruction3.mmMeetingAttendee, MeetingNotice4.mmContactPersonDetails, RedemptionMultipleExecution5.mmBeneficiaryDetails, RedemptionMultipleOrder6.mmBeneficiaryDetails,
						SubscriptionMultipleOrder6.mmBeneficiaryDetails, SubscriptionMultipleExecution5.mmBeneficiaryDetails, SubscriptionExecution12.mmBeneficiaryDetails, SubscriptionOrder15.mmBeneficiaryDetails,
						RedemptionOrder15.mmBeneficiaryDetails, Party33Choice.mmIndividualPerson, IndividualPerson33.mmFamilyInformation, Party32Choice.mmIndividualPerson, RedemptionExecution16.mmBeneficiaryDetails,
						SecuritiesTransactionReport4.mmExecutingPerson, IndividualPerson34.mmFamilyInformation);
				...
				derivationComponent_lazy = () -> Arrays.asList(IndividualPerson8.mmObject(), DateAndPlaceOfBirth.mmObject(), PartyAdditionalIdentification2Choice.mmObject(), IndividualPerson25.mmObject(), IndividualPerson26.mmObject(),
						IndividualPerson30.mmObject(), IndividualPerson29.mmObject(), IndividualPerson32.mmObject(), IndividualPerson31.mmObject(), IndividualPerson33.mmObject(), IndividualPerson35.mmObject(),
						IndividualPerson34.mmObject(), CitizenshipInformation2.mmObject());
			}
