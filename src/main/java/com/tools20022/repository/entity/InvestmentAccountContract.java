...
public class InvestmentAccountContract extends AccountContract {
	...
	public static final MMBusinessAttribute<InvestmentAccountContract, Max35Text> mmLetterIntentReference = new MMBusinessAttribute<InvestmentAccountContract, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(InvestmentAccount61.mmLetterIntentDetails, InvestmentAccount63.mmLetterIntentDetails, InvestmentAccount62.mmLetterIntentDetails);
			isDerived = false;
	...
	public static final MMBusinessAttribute<InvestmentAccountContract, Max35Text> mmAccumulationRightReference = new MMBusinessAttribute<InvestmentAccountContract, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(InvestmentAccount61.mmAccumulationRightReference, InvestmentAccount63.mmAccumulationRightReference, InvestmentAccount62.mmAccumulationRightReference,
					SubscriptionExecution13.mmAccumulationRightReference, SubscriptionExecution12.mmAccumulationRightReference, SubscriptionOrder15.mmAccumulationRightReference, SubscriptionOrder14.mmAccumulationRightReference);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.InvestmentAccountContract.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
