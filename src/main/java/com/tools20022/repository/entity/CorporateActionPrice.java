...
public class CorporateActionPrice {
	...
	public static final MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing> mmCashInLieuOfSharePrice = new MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionPrice1.mmCashInLieuOfSharePrice, CorporateActionPrice59.mmCashInLieuOfSharePrice, CorporateActionPrice56.mmCashInLieuOfSharePrice,
					CorporateActionPrice61.mmCashInLieuOfSharePrice, CorporateActionPrice68.mmCashInLieuOfSharePrice);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionPrice.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing> mmOverSubscriptionDepositPrice = new MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionPrice1.mmOverSubscriptionDepositPrice, CorporateActionPrice61.mmOverSubscriptionDepositPrice, CorporateActionPrice68.mmOverSubscriptionDepositPrice);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionPrice.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing> mmMinimumMultipleCashToInstruct = new MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionPrice68.mmMinimumMultipleCashToInstruct);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionPrice.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing> mmMaximumCashToInstruct = new MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionPrice68.mmMaximumCashToInstruct);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionPrice.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing> mmMinimumCashToInstruct = new MMBusinessAssociationEnd<CorporateActionPrice, SecuritiesPricing>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionPrice68.mmMinimumCashToInstruct);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CorporateActionPrice.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(CorporateActionPrice2.mmObject(), CorporateActionPrice1.mmObject(), CorporateActionPrice4.mmObject(), CorporateActionPrice59.mmObject(), CorporateActionPrice56.mmObject(),
						CorporateActionPrice60.mmObject(), CorporateActionPrice61.mmObject(), CorporateActionPrice57.mmObject(), CorporateActionPrice68.mmObject());
			}
