...
import com.tools20022.repository.msg.RegistrationParameters4;
...
public class BasicSecuritiesRegistration {
	...
	public static final MMBusinessAttribute mmCertificationIdentification = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(RegistrationParameters3.mmCertificationIdentification, RegistrationParameters4.mmCertificationIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.BasicSecuritiesRegistration.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmCertificationDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(RegistrationParameters3.mmCertificationDateTime, RegistrationParameters4.mmCertificationDateTime);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.BasicSecuritiesRegistration.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(RegistrationParameters3.mmObject(), RegistrationParameters4.mmObject(), Registration9Choice.mmObject(), RegistrationReason5.mmObject(), Registration10Choice.mmObject());
			}
