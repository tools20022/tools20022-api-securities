...
public class HaircutValuation {
	...
	public static final MMBusinessAttribute mmHaircut = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(BasicCollateralValuation1Details.mmValuationHaircut, FinancialInstrumentStipulations2.mmHaircut, CashCollateral3.mmHaircut, CashCollateral4.mmHaircut, CashCollateral2.mmHaircut,
					CashCollateral5.mmHaircut, OtherCollateral7.mmHaircut, CollateralValuation5.mmCurrencyHaircut, OtherCollateral6.mmHaircut, SecuritiesCollateral6.mmHaircut, SecuritiesCollateral5.mmHaircut, OtherCollateral5.mmHaircut,
					SecuritiesCollateral7.mmHaircut, SecuritiesCollateral8.mmHaircut);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.HaircutValuation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Haircut";
