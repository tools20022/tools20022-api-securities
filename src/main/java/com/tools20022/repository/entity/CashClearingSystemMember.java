...
public class CashClearingSystemMember {
	...
	public static final MMBusinessAttribute mmCHIPSUniversalIdentification = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmCHIPSUniversalIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmNewZealandNCC = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmNewZealandNCCIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "NewZealandNCC";
	...
	public static final MMBusinessAttribute mmIrishNSC = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmIrishNSCIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "IrishNSC";
	...
	public static final MMBusinessAttribute mmUKSortCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmUKDomesticSortCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "UKSortCode";
	...
	public static final MMBusinessAttribute mmCHIPSParticipantIdentification = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmCHIPSParticipantIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmSwissBC = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmSwissBCIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "SwissBC";
	...
	public static final MMBusinessAttribute mmFedwireRoutingNumber = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmFedwireRoutingNumberIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmPortugueseNCC = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmPortugueseNCCIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "PortugueseNCC";
	...
	public static final MMBusinessAttribute mmRussianCentralBankIdentificationCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmRussianCentralBankIdentificationCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmItalianDomesticIdentificationCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmItalianDomesticIdentificationCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmAustrianBankleitzahl = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmAustrianBankleitzahlIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmSwissSIC = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmSwissSICIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "SwissSIC";
	...
	public static final MMBusinessAttribute mmGermanBankleitzahl = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmGermanBankleitzahlIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmSpanishDomesticInterbankingCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmSpanishDomesticInterbankingIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmSouthAfricanNCC = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmSouthAfricanNCCIdentification);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmHongKongBankCode = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmHongKongBankCode);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashClearingSystemMember.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(ClearingSystemMemberIdentificationChoice.mmObject(), ClearingSystemMemberIdentification2.mmObject());
			}
