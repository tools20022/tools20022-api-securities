		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(Forms.mmObject(), ValuationDealingProcessingCharacteristics2.mmObject(), InvestmentRestrictions2.mmObject(), ProcessingCharacteristics2.mmObject(),
						ProcessingCharacteristics3.mmObject());
			}
