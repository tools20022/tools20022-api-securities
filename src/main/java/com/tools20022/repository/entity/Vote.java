...
import com.tools20022.repository.msg.Vote7;
...
public class Vote {
	...
	public static final MMBusinessAttribute<Vote, Number> mmFor = new MMBusinessAttribute<Vote, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(Vote7.mmFor, Vote6.mmFor, Vote8.mmFor);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Vote.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "For";
	...
	public static final MMBusinessAttribute<Vote, Number> mmAgainst = new MMBusinessAttribute<Vote, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(Vote7.mmAgainst, Vote6.mmAgainst, Vote8.mmAgainst);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Vote.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Against";
	...
	public static final MMBusinessAttribute<Vote, Number> mmAbstain = new MMBusinessAttribute<Vote, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(Vote7.mmAbstain, Vote6.mmAbstain, Vote8.mmAbstain);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Vote.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Abstain";
	...
	public static final MMBusinessAttribute<Vote, Number> mmWithhold = new MMBusinessAttribute<Vote, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(Vote7.mmWithhold, Vote6.mmWithhold, Vote8.mmWithhold);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Vote.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Withhold";
	...
	public static final MMBusinessAttribute<Vote, Number> mmWithManagement = new MMBusinessAttribute<Vote, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(Vote6.mmWithManagement, Vote8.mmWithManagement);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Vote.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "WithManagement";
	...
	public static final MMBusinessAttribute<Vote, Number> mmAgainstManagement = new MMBusinessAttribute<Vote, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(Vote6.mmAgainstManagement, Vote8.mmAgainstManagement);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Vote.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Vote, Number> mmNoAction = new MMBusinessAttribute<Vote, Number>() {
		{
			derivation_lazy = () -> Arrays.asList(Vote7.mmNoAction, Vote6.mmNoAction, Vote8.mmNoAction);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Vote.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "NoAction";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(Vote7.mmObject(), Vote6.mmObject(), Vote8.mmObject());
			}
