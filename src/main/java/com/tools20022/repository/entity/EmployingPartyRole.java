		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(IndividualPerson25.mmEmployingParty, IndividualPerson26.mmEmployingParty, IndividualPerson33.mmEmployingCompany, IndividualPerson34.mmEmployingCompany);
