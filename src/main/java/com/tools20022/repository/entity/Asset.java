	...
	public static final MMBusinessAttribute<Asset, ISODateTime> mmExpiryDate = new MMBusinessAttribute<Asset, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentStipulations2.mmExpirationDate, FinancialInstrumentAttributes44.mmExpiryDate, FinancialInstrumentAttributes63.mmExpiryDate, FinancialInstrumentAttributes64.mmExpiryDate,
					OtherCollateral7.mmExpiryDate, OtherCollateral6.mmExpiryDate, OtherCollateral5.mmExpiryDate, FinancialInstrumentAttributes79.mmExpiryDate, FinancialInstrumentAttributes81.mmExpiryDate,
					FinancialInstrumentAttributes91.mmExpiryDate, FinancialInstrumentAttributes92.mmExpiryDate, FinancialInstrumentAttributes93.mmExpiryDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute<Asset, ISODateTime> mmMaturityDate = new MMBusinessAttribute<Asset, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstrumentStipulations2.mmMaturityDate, FinancialInstrumentAttributes44.mmMaturityDate, CorporateActionDate2.mmMaturityDate, CashCollateral3.mmMaturityDate,
					...
					FinancialInstrumentAttributes64.mmMaturityDate, SecuritiesCollateral6.mmMaturityDate, SecuritiesCollateral5.mmMaturityDate, SecuritiesCollateral7.mmMaturityDate, DebtInstrument4.mmMaturityDate,
					...
					FinancialInstrumentAttributes81.mmMaturityDate, FinancialInstrumentAttributes80.mmMaturityDate, SecuritiesCollateral8.mmMaturityDate, SecuredMarketTransaction4.mmMaturityDate,
					ForeignExchangeSwapTransaction3.mmMaturityDate, OvernightIndexSwapTransaction4.mmMaturityDate, UnsecuredMarketTransaction4.mmMaturityDate, FinancialInstrumentAttributes91.mmMaturityDate,
					FinancialInstrumentAttributes92.mmMaturityDate, CorporateActionDate61.mmNewMaturityDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Asset.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "MaturityDate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(FinancialInstrumentAttributes44.mmObject(), OtherTypeOfCollateral2.mmObject(), FinancialInstrumentAttributes63.mmObject(), FinancialInstrumentAttributes64.mmObject(),
						OtherCollateral7.mmObject(), OtherCollateral6.mmObject(), OtherCollateral5.mmObject(), FinancialInstrumentAttributes79.mmObject(), FinancialInstrumentAttributes81.mmObject(),
						FinancialInstrumentAttributes80.mmObject(), FinancialInstrumentAttributes91.mmObject(), FinancialInstrumentAttributes92.mmObject(), FinancialInstrumentAttributes93.mmObject());
			}
