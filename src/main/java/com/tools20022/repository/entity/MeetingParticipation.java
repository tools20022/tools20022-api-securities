...
public class MeetingParticipation {
	...
	public static final MMBusinessAttribute mmTotalNumberOfSecuritiesOutstanding = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Participation4.mmTotalNumberOfSecuritiesOutstanding, MeetingNotice4.mmTotalNumberOfSecuritiesOutstanding);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmTotalNumberOfVotingRights = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Participation4.mmTotalNumberOfVotingRights, MeetingNotice4.mmTotalNumberOfVotingRights);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.MeetingParticipation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute mmCalculationDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Participation4.mmCalculationDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.MeetingParticipation.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(Participation4.mmObject());
			}
