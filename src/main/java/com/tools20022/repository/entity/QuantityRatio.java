...
public class QuantityRatio {
	...
	public static final MMBusinessAttribute mmQuantity1 = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(QuantityToQuantityRatio1.mmQuantity1);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.QuantityRatio.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Quantity1";
	...
	public static final MMBusinessAttribute mmQuantity2 = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(QuantityToQuantityRatio1.mmQuantity2);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.QuantityRatio.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Quantity2";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(RatioFormat2Choice.mmQuantityToQuantity, RatioFormat1Choice.mmQuantityToQuantity, RatioFormat19Choice.mmQuantityToQuantity, RatioFormat17Choice.mmQuantityToQuantity,
						RatioFormat18Choice.mmQuantityToQuantity, RatioFormat20Choice.mmQuantityToQuantity);
				...
				derivationComponent_lazy = () -> Arrays.asList(QuantityToQuantityRatio1.mmObject());
			}
