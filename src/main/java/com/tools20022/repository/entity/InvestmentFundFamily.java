...
public class InvestmentFundFamily {
	...
	public static final MMBusinessAttribute<InvestmentFundFamily, Max350Text> mmFundFamilyName = new MMBusinessAttribute<InvestmentFundFamily, Max350Text>() {
		{
			derivation_lazy = () -> Arrays.asList(InvestmentAccount61.mmFundFamilyName, InvestmentAccount63.mmFundFamilyName, InvestmentAccount62.mmFundFamilyName, InvestmentAccount64.mmFundFamilyName);
			isDerived = false;
