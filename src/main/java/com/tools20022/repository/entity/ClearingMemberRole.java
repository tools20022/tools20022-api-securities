...
public class ClearingMemberRole extends SystemPartyRole {
	...
	public static final MMBusinessAssociationEnd mmClearingAccount = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(PartyIdentificationAndAccount78.mmClearingAccount, PartyIdentificationAndAccount31.mmClearingAccount, TradeLeg8.mmSafekeepingAccount, TradeLegStatement3.mmClearingAccount,
	...
	public static final MMBusinessAssociationEnd mmMarginAccount = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(TradeLeg9.mmMarginAccount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ClearingMemberRole.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "MarginAccount";
	...
	public static final MMBusinessAssociationEnd mmDeliveryAccount = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(SettlementObligation7.mmDeliveryAccount, NetPosition3.mmDeliveryAccount, TradeLeg9.mmDeliveryAccount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.ClearingMemberRole.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
