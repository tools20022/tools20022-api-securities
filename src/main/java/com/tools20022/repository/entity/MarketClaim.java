...
import com.tools20022.repository.msg.CorporateActionAmounts37;
import com.tools20022.repository.msg.CorporateActionAmounts38;
import com.tools20022.repository.msg.CorporateActionDate44;
...
public class MarketClaim {
	...
	public static final MMBusinessAttribute mmMarketClaimAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionAmounts1.mmMarketClaimAmount, CorporateActionAmounts37.mmMarketClaimAmount, CorporateActionAmounts38.mmMarketClaimAmount);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmMarketClaimTrackingEndDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionDate44.mmMarketClaimTrackingEndDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.MarketClaim.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
