...
import com.tools20022.repository.msg.CorporateActionAmounts43;
import com.tools20022.repository.msg.CorporateActionAmounts44;
...
public class MarketClaim {
	...
	public static final MMBusinessAttribute<MarketClaim, CurrencyAndAmount> mmMarketClaimAmount = new MMBusinessAttribute<MarketClaim, CurrencyAndAmount>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionAmounts1.mmMarketClaimAmount, CorporateActionAmounts43.mmMarketClaimAmount, CorporateActionAmounts44.mmMarketClaimAmount);
			isDerived = false;
	...
	public static final MMBusinessAttribute<MarketClaim, ISODateTime> mmMarketClaimTrackingEndDate = new MMBusinessAttribute<MarketClaim, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(CorporateActionDate61.mmMarketClaimTrackingEndDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.MarketClaim.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
