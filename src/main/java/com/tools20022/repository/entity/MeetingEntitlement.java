...
import com.tools20022.repository.msg.EligibilityDates1;
...
public class MeetingEntitlement {
	...
	public static final MMBusinessAttribute mmEntitlementFixingDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(EligibilityDates1.mmEntitlementFixingDate, EntitlementAssessment3.mmEntitlementFixingDate, HoldingBalance7.mmDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmEntitlementRatio = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(Entitlement1Choice.mmEntitlementRatio);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.MeetingEntitlement.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(Entitlement1Choice.mmEntitlementDescription, EntitlementAssessment3.mmEntitlement, Resolution3.mmEntitlement);
				...
				derivationComponent_lazy = () -> Arrays.asList(EntitlementAssessment3.mmObject());
			}
