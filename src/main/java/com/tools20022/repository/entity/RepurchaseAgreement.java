		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(SecuredMarketTransaction4.mmFloatingRateRepurchaseAgreement);
				...
				derivationComponent_lazy = () -> Arrays.asList(SecuredMarketTransaction4.mmObject());
			}
