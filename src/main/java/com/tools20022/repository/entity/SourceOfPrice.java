...
public class SourceOfPrice extends InformationPartyRole {
	...
	public static final MMBusinessAssociationEnd mmMarketIdentification = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(PriceInformation11.mmSourceOfPrice, PriceInformation12.mmSourceOfPrice, PriceInformation13.mmSourceOfPrice);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PriceSourceFormatChoice.mmNonLocalMarketPlace, PriceInformation2.mmSourceOfPrice, Price6.mmSource);
