...
public class AccountPartyRole extends Role {
	...
	public static final MMBusinessAssociationEnd<AccountPartyRole, List<Account>> mmAccount = new MMBusinessAssociationEnd<AccountPartyRole, List<Account>>() {
		{
			derivation_lazy = () -> Arrays.asList(Intermediary11.mmAccount, Intermediary27.mmAccount, Intermediary32.mmAccount, Intermediary36.mmAccount, Intermediary33.mmAccount, Intermediary41.mmAccount, Intermediary42.mmAccount);
			isDerived = false;
