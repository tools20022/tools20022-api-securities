...
public class CollateralValuation {
	...
	public static final MMBusinessAssociationEnd mmCollateral = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(CollateralValuation5.mmValuationAmounts);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmCollateralValuationDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CashCollateral3.mmValueDate, CashCollateral4.mmValueDate, CashCollateral2.mmValueDate, CashCollateral5.mmValueDate, OtherCollateral7.mmValueDate, OtherCollateral6.mmValueDate,
					SecuritiesCollateral6.mmValueDate, SecuritiesCollateral5.mmValueDate, OtherCollateral5.mmValueDate, SecuritiesCollateral7.mmValueDate, SecuritiesCollateral8.mmValueDate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CollateralValuation.mmObject();
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	...
	public static final MMBusinessAttribute mmReportedCurrencyAndAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CollateralAmount1.mmReportedCurrencyAndAmount);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CollateralValuation.mmObject();
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
	...
	public static final MMBusinessAttribute mmAdjustedRate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(CollateralValuation5.mmAdjustedRate);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CollateralValuation.mmObject();
			registrationStatus = MMRegistrationStatus.PROVISIONALLY_REGISTERED;
			name = "AdjustedRate";
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(SecuredCollateral2Choice.mmSingleCollateral, SecuredCollateral2Choice.mmMultipleCollateral, SecuredCollateral2Choice.mmPoolCollateral, SecuredCollateral2Choice.mmOtherCollateral);
				...
				derivationComponent_lazy = () -> Arrays.asList(CollateralValuation5.mmObject(), CollateralValuation7.mmObject(), SecuredCollateral2Choice.mmObject(), CollateralValuation6.mmObject());
			}
