		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				definition = "Transaction is a pre-advice, that is, for matching purposes only.";
				derivation_lazy = () -> Arrays.asList(SecuritiesTransactionType5Code.mmObject(), SecuritiesFinancingTransactionType2Code.mmObject(), SecuritiesTransactionType19Code.mmObject(), SecuritiesTransactionType20Code.mmObject(),
						SecuritiesTransactionType21Code.mmObject());
