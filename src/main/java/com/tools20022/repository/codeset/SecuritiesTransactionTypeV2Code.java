		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				definition = "Transaction is a pre-advice, that is, for matching purposes only.";
				derivation_lazy = () -> Arrays.asList(SecuritiesTransactionType5Code.mmObject(), SecuritiesTransactionType8Code.mmObject(), SecuritiesTransactionType17Code.mmObject(), SecuritiesFinancingTransactionType2Code.mmObject(),
