		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(SecuritiesBalanceType11Code.mmObject(), SecuritiesBalanceType12Code.mmObject(), SecuritiesBalanceType7Code.mmObject(), SecuritiesBalanceType13Code.mmObject());
