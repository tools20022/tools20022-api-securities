 ...
 * <li>{@linkplain com.tools20022.repository.codeset.TransactionType2Code
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(InvestmentFundTransactionInType1Code.mmObject(), InvestmentFundTransactionOutType1Code.mmObject(), TransactionType2Code.mmObject(), TransactionType1Code.mmObject(),
						InvestmentFundTransactionType1Code.mmObject());
