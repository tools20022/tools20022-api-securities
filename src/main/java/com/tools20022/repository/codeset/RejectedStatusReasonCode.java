		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				definition = "Cash settlement date is not recognised or is invalid.";
				derivation_lazy = () -> Arrays.asList(RejectedStatusReason6Code.mmObject(), RejectedStatusReason8Code.mmObject(), MessageRejectedReason1Code.mmObject(), CancellationRejectedReason1Code.mmObject(),
						TransferRejectedStatusReason2Code.mmObject(), RejectedStatusReason11Code.mmObject());
