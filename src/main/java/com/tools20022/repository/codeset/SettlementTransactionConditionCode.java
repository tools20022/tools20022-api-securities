		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				definition = "Collateral position is available for other purposes (for example, onwards delivery).";
				derivation_lazy = () -> Arrays.asList(SettlementTransactionCondition6Code.mmObject(), SettlementTransactionCondition8Code.mmObject(), SettlementTransactionCondition5Code.mmObject(),
						SettlementTransactionCondition3Code.mmObject(), SettlementTransactionCondition4Code.mmObject(), SettlementTransactionCondition10Code.mmObject(), SettlementTransactionCondition11Code.mmObject());
