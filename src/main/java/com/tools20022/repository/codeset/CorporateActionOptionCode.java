		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(CorporateActionOption9Code.mmObject(), CorporateActionOption10Code.mmObject(), CorporateActionOption7Code.mmObject(), CorporateActionOption8Code.mmObject(),
						CorporateActionOption5Code.mmObject());
