		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(EventFrequency5Code.mmObject(), EventFrequency1Code.mmObject(), EventFrequency3Code.mmObject(), EventFrequency4Code.mmObject(), EventFrequency7Code.mmObject(),
						EventFrequency6Code.mmObject(), EventFrequency8Code.mmObject(), EventFrequency10Code.mmObject(), EventFrequency9Code.mmObject());
