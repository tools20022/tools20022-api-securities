		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				definition = "Price will not be paid.";
				derivation_lazy = () -> Arrays.asList(PriceValueType1Code.mmObject(), PriceRateType3Code.mmObject(), PriceValueType9Code.mmObject(), PriceValueType5Code.mmObject(), PriceValueType10Code.mmObject(),
						PriceValueType8Code.mmObject(), PriceValueType2Code.mmObject(), PriceValueType7Code.mmObject(), PriceValueType6Code.mmObject());
