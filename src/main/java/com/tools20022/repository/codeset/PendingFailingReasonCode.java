		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(PendingProcessingReason1Code.mmObject(), PendingReason6Code.mmObject(), PendingProcessingReason2Code.mmObject(), PendingReason1Code.mmObject(), FailingReason1Code.mmObject(),
						PendingReason2Code.mmObject(), FailingReason2Code.mmObject(), PendingProcessingReason3Code.mmObject(), PendingReason9Code.mmObject(), PendingReason4Code.mmObject(), PendingReason7Code.mmObject(),
						PendingReason8Code.mmObject(), PendingReason10Code.mmObject(), FailingReason3Code.mmObject());
