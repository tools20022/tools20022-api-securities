 ...
 * =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.codeset.Quantity1Code
 * Quantity1Code}</li>
		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				name = "QuantityCode";
				definition = "Quantity is unknown by the sender or has not been established.";
				derivation_lazy = () -> Arrays.asList(Quantity1Code.mmObject(), Quantity4Code.mmObject(), Quantity5Code.mmObject());
