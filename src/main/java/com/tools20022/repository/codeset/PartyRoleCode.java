		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(InvestmentFundRole2Code.mmObject(), InvestmentFundRole6Code.mmObject(), InvestmentFundRole7Code.mmObject(), InternalPartyRole1Code.mmObject(), PartyRole1Code.mmObject());
