		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(SecuritiesBalanceType10Code.mmObject(), SecuritiesBalanceType6Code.mmObject(), CashBalanceType1Code.mmObject(), SecuritiesBalanceType9Code.mmObject(), BalanceType13Code.mmObject());
