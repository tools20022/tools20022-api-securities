		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(AcknowledgementReason5Code.mmObject(), AcknowledgementReason6Code.mmObject(), AcknowledgementReason3Code.mmObject(), AcknowledgementReason7Code.mmObject());
