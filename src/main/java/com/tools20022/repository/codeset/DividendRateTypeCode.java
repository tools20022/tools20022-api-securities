		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				derivation_lazy = () -> Arrays.asList(GrossDividendRateType1Code.mmObject(), NetDividendRateType1Code.mmObject(), DividendRateType1Code.mmObject(), GrossDividendRateType5Code.mmObject(),
						GrossDividendRateType4Code.mmObject(), NetDividendRateType4Code.mmObject(), NetDividendRateType5Code.mmObject());
