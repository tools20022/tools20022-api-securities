		...
		mmObject_lazy.compareAndSet(null, new MMCodeSet() {
			{
				...
				name = "RateTypeCode";
				definition = "Any and all rate is sought.";
				derivation_lazy = () -> Arrays.asList(RateValueType6Code.mmObject(), RateValueType7Code.mmObject(), RateType5Code.mmObject(), RateType12Code.mmObject(), RateType13Code.mmObject(), RateType10Code.mmObject(),
						RateValueType2Code.mmObject());
