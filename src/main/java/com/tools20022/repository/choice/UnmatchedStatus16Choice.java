...
public class UnmatchedStatus16Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> UnmatchedStatus16Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedStatus16Choice.mmNoSpecifiedReason, UnmatchedStatus16Choice.mmReason);
	...
	public void setReason(List<UnmatchedReason15> reason) {
		this.reason = reason;
	}
}