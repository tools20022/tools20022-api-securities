...
@XmlType(name = "PendingReason28Choice", propOrder = {"code", "proprietary"})
public class PendingReason28Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason28Choice, PendingReason6Code> mmCode = new MMMessageAttribute<PendingReason28Choice, PendingReason6Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason28Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public PendingReason6Code getValue(PendingReason28Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingReason28Choice obj, PendingReason6Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason28Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<PendingReason28Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason28Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification30 getValue(PendingReason28Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PendingReason28Choice obj, GenericIdentification30 value) {
	...
	public PendingReason28Choice setCode(PendingReason6Code code) {
	...
	public PendingReason28Choice setProprietary(GenericIdentification30 proprietary) {
