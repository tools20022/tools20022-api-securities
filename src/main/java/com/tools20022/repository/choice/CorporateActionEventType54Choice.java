...
public class CorporateActionEventType54Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType54Choice.mmCode, CorporateActionEventType54Choice.mmProprietary);
	...
	public void setCode(CorporateActionEventType23Code code) {
		this.code = code;
	}
