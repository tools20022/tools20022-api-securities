...
@XmlType(name = "CorporateActionEventType56Choice", propOrder = {"code", "proprietary"})
public class CorporateActionEventType56Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CorporateActionEventType56Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CorporateActionEventType56Choice.mmCode, CorporateActionEventType56Choice.mmProprietary);
