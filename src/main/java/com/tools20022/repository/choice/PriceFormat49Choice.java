...
public class PriceFormat49Choice {
	...
	public static final MMMessageAssociationEnd mmPercentagePrice = new MMMessageAssociationEnd() {
		{
			...
			componentContext_lazy = () -> PriceFormat49Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PriceFormat49Choice.mmPercentagePrice, PriceFormat49Choice.mmAmountPrice, PriceFormat49Choice.mmNotSpecifiedPrice, PriceFormat49Choice.mmAmountPricePerFinancialInstrumentQuantity,
						PriceFormat49Choice.mmAmountPricePerAmount, PriceFormat49Choice.mmIndexPoints);
