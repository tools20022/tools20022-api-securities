...
public class RepairStatus14Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RepairStatus14Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepairStatus14Choice.mmNoSpecifiedReason, RepairStatus14Choice.mmReason);
	...
	public void setReason(List<RepairReason10> reason) {
		this.reason = reason;
	}
}