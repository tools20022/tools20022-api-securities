...
public class FinancialInstrumentQuantity19Choice {
	...
	public static final MMMessageAttribute mmUnit = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FinancialInstrumentQuantity19Choice.mmObject();
			isDerived = false;
			xmlTag = "Unit";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FinancialInstrumentQuantity19Choice.mmUnit, FinancialInstrumentQuantity19Choice.mmFaceAmount, FinancialInstrumentQuantity19Choice.mmAmortisedValue,
						FinancialInstrumentQuantity19Choice.mmCode);
