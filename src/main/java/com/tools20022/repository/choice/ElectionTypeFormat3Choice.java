...
@XmlType(name = "ElectionTypeFormat3Choice", propOrder = {"code", "proprietary"})
public class ElectionTypeFormat3Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.ElectionTypeFormat3Choice.mmCode, com.tools20022.repository.choice.ElectionTypeFormat3Choice.mmProprietary);
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "ElectionTypeFormat3Choice";
	...
	public ElectionTypeFormat3Choice setCode(ElectionMovementType2Code code) {
	...
	public ElectionTypeFormat3Choice setProprietary(GenericIdentification30 proprietary) {
