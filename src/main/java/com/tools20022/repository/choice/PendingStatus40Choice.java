...
public class PendingStatus40Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus40Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus40Choice.mmNoSpecifiedReason, PendingStatus40Choice.mmReason);
	...
	public void setReason(List<PendingReason18> reason) {
		this.reason = reason;
	}
}