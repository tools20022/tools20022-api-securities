...
public class RejectedStatus23Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectedStatus23Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedStatus23Choice.mmNoSpecifiedReason, RejectedStatus23Choice.mmReason);
	...
	public void setReason(List<RejectedStatusReason21> reason) {
		this.reason = reason;
	}
}