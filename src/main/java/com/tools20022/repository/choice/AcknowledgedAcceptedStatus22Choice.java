...
public class AcknowledgedAcceptedStatus22Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> AcknowledgedAcceptedStatus22Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(AcknowledgedAcceptedStatus22Choice.mmNoSpecifiedReason, AcknowledgedAcceptedStatus22Choice.mmReason);
	...
	public void setReason(List<AcknowledgementReason10> reason) {
		this.reason = reason;
	}
}