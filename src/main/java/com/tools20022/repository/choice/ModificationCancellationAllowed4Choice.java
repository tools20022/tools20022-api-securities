...
@XmlType(name = "ModificationCancellationAllowed4Choice", propOrder = {"indicator", "proprietary"})
public class ModificationCancellationAllowed4Choice {
	...
	public ModificationCancellationAllowed4Choice setIndicator(YesNoIndicator indicator) {
	...
	public ModificationCancellationAllowed4Choice setProprietary(GenericIdentification30 proprietary) {
