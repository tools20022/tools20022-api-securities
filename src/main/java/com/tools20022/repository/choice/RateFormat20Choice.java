 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.RateFormat20Choice#mmRate
 * RateFormat20Choice.mmRate}</li>
 * <li>{@linkplain com.tools20022.repository.choice.RateFormat20Choice#mmAmount
 * RateFormat20Choice.mmAmount}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.RateFormat20Choice#mmNotSpecifiedRate
 * RateFormat20Choice.mmNotSpecifiedRate}</li>
 * </ul>
 * </li>
...
@XmlType(name = "RateFormat20Choice", propOrder = {"rate", "amount", "notSpecifiedRate"})
public class RateFormat20Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RateFormat20Choice.mmRate, com.tools20022.repository.choice.RateFormat20Choice.mmAmount,
						com.tools20022.repository.choice.RateFormat20Choice.mmNotSpecifiedRate);
				trace_lazy = () -> RateAndAmount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RateFormat20Choice";
	...
	public RateFormat20Choice setRate(PercentageRate rate) {
	...
	public RateFormat20Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public RateFormat20Choice setNotSpecifiedRate(RateValueType7Code notSpecifiedRate) {
