...
@XmlType(name = "CancellationReason19Choice", propOrder = {"code", "proprietary"})
public class CancellationReason19Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationReason19Choice, CancelledStatusReason13Code> mmCode = new MMMessageAttribute<CancellationReason19Choice, CancelledStatusReason13Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancellationReason19Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
			...
			nextVersions_lazy = () -> Arrays.asList(CancellationReason32Choice.mmCode, CancellationReason31Choice.mmCode);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public CancelledStatusReason13Code getValue(CancellationReason19Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(CancellationReason19Choice obj, CancelledStatusReason13Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<CancellationReason19Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<CancellationReason19Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmCancellationReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.CancellationReason19Choice.mmObject();
			isDerived = false;
			...
			name = "Proprietary";
			definition = "Specifies the reason why the related instruction is cancelled, or the related cancellation request is executed.";
			nextVersions_lazy = () -> Arrays.asList(CancellationReason32Choice.mmProprietary, CancellationReason31Choice.mmProprietary);
			maxOccurs = 1;
			minOccurs = 1;
		...
		@Override
		public GenericIdentification30 getValue(CancellationReason19Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(CancellationReason19Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CancellationReason19Choice.mmCode, com.tools20022.repository.choice.CancellationReason19Choice.mmProprietary);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CancellationReason19Choice";
				definition = "Choice of format for the cancellation reason.";
				nextVersions_lazy = () -> Arrays.asList(CancellationReason32Choice.mmObject(), CancellationReason31Choice.mmObject());
			}
		});
	...
	public CancellationReason19Choice setCode(CancelledStatusReason13Code code) {
	...
	public CancellationReason19Choice setProprietary(GenericIdentification30 proprietary) {
