...
import com.tools20022.repository.codeset.RejectionReason46Code;
...
@XmlType(name = "RejectedReason22Choice", propOrder = {"code", "proprietary"})
public class RejectedReason22Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected RejectionReason46Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.RejectedReason22Choice.mmCode, com.tools20022.repository.choice.RejectedReason22Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "RejectedReason22Choice";
	...
	public RejectionReason46Code getCode() {
		return code;
	}

	public RejectedReason22Choice setCode(RejectionReason46Code code) {
	...
	public RejectedReason22Choice setProprietary(GenericIdentification30 proprietary) {
