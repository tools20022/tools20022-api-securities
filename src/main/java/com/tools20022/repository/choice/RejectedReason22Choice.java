...
public class RejectedReason22Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectedReason22Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectedReason22Choice.mmCode, RejectedReason22Choice.mmProprietary);
	...
	public void setCode(RejectionReason46Code code) {
		this.code = code;
	}
