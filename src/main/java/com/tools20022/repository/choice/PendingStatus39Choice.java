...
public class PendingStatus39Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus39Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus39Choice.mmNoSpecifiedReason, PendingStatus39Choice.mmReason);
	...
	public void setReason(List<PendingReason17> reason) {
		this.reason = reason;
	}
}