...
public class RejectionOrRepairStatus30Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus30Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus30Choice.mmNoSpecifiedReason, RejectionOrRepairStatus30Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason24> reason) {
		this.reason = reason;
	}
}