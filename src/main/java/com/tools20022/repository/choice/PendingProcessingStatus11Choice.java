...
public class PendingProcessingStatus11Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingProcessingStatus11Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingProcessingStatus11Choice.mmNoSpecifiedReason, PendingProcessingStatus11Choice.mmReason);
	...
	public void setReason(List<PendingProcessingReason8> reason) {
		this.reason = reason;
	}
}