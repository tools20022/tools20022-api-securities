...
import com.tools20022.repository.msg.PendingProcessingReason8;
...
@XmlType(name = "PendingProcessingStatus11Choice", propOrder = {"noSpecifiedReason", "reason"})
public class PendingProcessingStatus11Choice {
	...
	protected List<PendingProcessingReason8> reason;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingProcessingStatus11Choice.mmNoSpecifiedReason, com.tools20022.repository.choice.PendingProcessingStatus11Choice.mmReason);
				trace_lazy = () -> SecuritiesTradeStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingProcessingStatus11Choice";
	...
	public PendingProcessingStatus11Choice setNoSpecifiedReason(NoReasonCode noSpecifiedReason) {
		this.noSpecifiedReason = Objects.requireNonNull(noSpecifiedReason);
		return this;
	}

	public List<PendingProcessingReason8> getReason() {
		return reason == null ? reason = new ArrayList<>() : reason;
	}

	public PendingProcessingStatus11Choice setReason(List<PendingProcessingReason8> reason) {
