...
@XmlType(name = "RevaluationIndicator3Choice", propOrder = {"indicator", "proprietary"})
public class RevaluationIndicator3Choice {
	...
	public RevaluationIndicator3Choice setIndicator(YesNoIndicator indicator) {
	...
	public RevaluationIndicator3Choice setProprietary(GenericIdentification30 proprietary) {
