...
public class RejectionStatus20Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionStatus20Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionStatus20Choice.mmNoSpecifiedReason, RejectionStatus20Choice.mmReason);
	...
	public void setReason(RejectionReason29 reason) {
		this.reason = reason;
	}
}