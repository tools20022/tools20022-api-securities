...
import com.tools20022.repository.codeset.EventFrequency9Code;
 ...
 * <ul>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementFrequencyReason2Choice#mmCode
 * StatementFrequencyReason2Choice.mmCode}</li>
 * <li>
 * {@linkplain com.tools20022.repository.choice.StatementFrequencyReason2Choice#mmProprietary
 * StatementFrequencyReason2Choice.mmProprietary}</li>
 * </ul>
 * </li>
 ...
 * definition} =
 * "Choice of formats for the specification of the statement frequency."</li>
 * </ul>
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = "StatementFrequencyReason2Choice", propOrder = {"code", "proprietary"})
public class StatementFrequencyReason2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected EventFrequency9Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	 ...
	 * definition} = "Statement frequency expressed as a code."</li>
	 * </ul>
	 */
	 ...
	 * <li>
	 * {@linkplain com.tools20022.metamodel.MMRepositoryConcept#getDefinition
	 * definition} = "Statement frequency expressed as a proprietary code."</li>
	 * </ul>
	 */
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.StatementFrequencyReason2Choice.mmCode, com.tools20022.repository.choice.StatementFrequencyReason2Choice.mmProprietary);
				trace_lazy = () -> ReportingService.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "StatementFrequencyReason2Choice";
	...
	public EventFrequency9Code getCode() {
		return code;
	}

	public StatementFrequencyReason2Choice setCode(EventFrequency9Code code) {
	...
	public StatementFrequencyReason2Choice setProprietary(GenericIdentification47 proprietary) {
