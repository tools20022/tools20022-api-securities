...
public class FailingStatus10Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FailingStatus10Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingStatus10Choice.mmNoSpecifiedReason, FailingStatus10Choice.mmReason);
	...
	public void setReason(List<FailingReason8> reason) {
		this.reason = reason;
	}
}