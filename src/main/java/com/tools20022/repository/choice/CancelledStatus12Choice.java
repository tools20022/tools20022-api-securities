...
public class CancelledStatus12Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CancelledStatus12Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CancelledStatus12Choice.mmNoSpecifiedReason, CancelledStatus12Choice.mmReason);
	...
	public void setReason(List<CancelledStatusReason11> reason) {
		this.reason = reason;
	}
}