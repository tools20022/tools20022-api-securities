...
public class PendingStatus38Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus38Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus38Choice.mmNoSpecifiedReason, PendingStatus38Choice.mmReason);
	...
	public void setReason(List<PendingReason16> reason) {
		this.reason = reason;
	}
}