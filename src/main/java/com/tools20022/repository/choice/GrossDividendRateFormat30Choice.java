...
@XmlType(name = "GrossDividendRateFormat30Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class GrossDividendRateFormat30Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GrossDividendRateFormat30Choice.mmAmount, com.tools20022.repository.choice.GrossDividendRateFormat30Choice.mmAmountAndRateStatus,
						com.tools20022.repository.choice.GrossDividendRateFormat30Choice.mmRateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.GrossDividendRateFormat30Choice.mmNotSpecifiedRate);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GrossDividendRateFormat30Choice";
	...
	public GrossDividendRateFormat30Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public GrossDividendRateFormat30Choice setAmountAndRateStatus(AmountAndRateStatus1 amountAndRateStatus) {
	...
	public GrossDividendRateFormat30Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus40 rateTypeAndAmountAndRateStatus) {
	...
	public GrossDividendRateFormat30Choice setNotSpecifiedRate(RateType13Code notSpecifiedRate) {
