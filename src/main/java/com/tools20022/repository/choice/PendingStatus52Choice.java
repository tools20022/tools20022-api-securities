...
public class PendingStatus52Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus52Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus52Choice.mmNoSpecifiedReason, PendingStatus52Choice.mmReason);
	...
	public void setReason(List<PendingStatusReason13> reason) {
		this.reason = reason;
	}
}