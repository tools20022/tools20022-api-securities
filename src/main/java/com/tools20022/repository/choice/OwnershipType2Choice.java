...
import com.tools20022.repository.codeset.AccountOwnershipType4Code;
 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.OwnershipType2Choice#mmCode
...
@XmlType(name = "OwnershipType2Choice", propOrder = {"code", "proprietary"})
public class OwnershipType2Choice {

	final static private AtomicReference<MMChoiceComponent> mmObject_lazy = new AtomicReference<>();
	@XmlElement(name = "Cd", required = true)
	protected AccountOwnershipType4Code code;
	/**
	 * 
	 <p>
	 * <strong>Constant fields:</strong>
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.OwnershipType2Choice.mmCode, com.tools20022.repository.choice.OwnershipType2Choice.mmProprietary);
				trace_lazy = () -> InvestmentAccount.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "OwnershipType2Choice";
	...
	public AccountOwnershipType4Code getCode() {
		return code;
	}

	public OwnershipType2Choice setCode(AccountOwnershipType4Code code) {
	...
	public OwnershipType2Choice setProprietary(GenericIdentification47 proprietary) {
