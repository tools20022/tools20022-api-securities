...
public class OwnershipType2Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> OwnershipType2Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(OwnershipType2Choice.mmCode, OwnershipType2Choice.mmProprietary);
	...
	public void setCode(AccountOwnershipType4Code code) {
		this.code = code;
	}
