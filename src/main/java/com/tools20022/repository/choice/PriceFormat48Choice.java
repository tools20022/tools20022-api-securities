...
public class PriceFormat48Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat48Choice, PercentagePrice1> mmPercentagePrice = new MMMessageAssociationEnd<PriceFormat48Choice, PercentagePrice1>() {
		{
			businessElementTrace_lazy = () -> SecuritiesPricing.mmRate;
			componentContext_lazy = () -> com.tools20022.repository.choice.PriceFormat48Choice.mmObject();
			isDerived = false;
			xmlTag = "PctgPric";
		...
		@Override
		public PercentagePrice1 getValue(PriceFormat48Choice obj) {
			return obj.getPercentagePrice();
		}

		@Override
		public void setValue(PriceFormat48Choice obj, PercentagePrice1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat48Choice, AmountPrice3> mmAmountPrice = new MMMessageAssociationEnd<PriceFormat48Choice, AmountPrice3>() {
		{
		...
		@Override
		public AmountPrice3 getValue(PriceFormat48Choice obj) {
			return obj.getAmountPrice();
		}

		@Override
		public void setValue(PriceFormat48Choice obj, AmountPrice3 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat48Choice, AmountPricePerFinancialInstrumentQuantity6> mmAmountPricePerFinancialInstrumentQuantity = new MMMessageAssociationEnd<PriceFormat48Choice, AmountPricePerFinancialInstrumentQuantity6>() {
		{
		...
		@Override
		public AmountPricePerFinancialInstrumentQuantity6 getValue(PriceFormat48Choice obj) {
			return obj.getAmountPricePerFinancialInstrumentQuantity();
		}

		@Override
		public void setValue(PriceFormat48Choice obj, AmountPricePerFinancialInstrumentQuantity6 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<PriceFormat48Choice, AmountPricePerAmount2> mmAmountPricePerAmount = new MMMessageAssociationEnd<PriceFormat48Choice, AmountPricePerAmount2>() {
		{
		...
		@Override
		public AmountPricePerAmount2 getValue(PriceFormat48Choice obj) {
			return obj.getAmountPricePerAmount();
		}

		@Override
		public void setValue(PriceFormat48Choice obj, AmountPricePerAmount2 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PriceFormat48Choice, DecimalNumber> mmIndexPoints = new MMMessageAttribute<PriceFormat48Choice, DecimalNumber>() {
		{
		...
		@Override
		public DecimalNumber getValue(PriceFormat48Choice obj) {
			return obj.getIndexPoints();
		}

		@Override
		public void setValue(PriceFormat48Choice obj, DecimalNumber value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PriceFormat48Choice.mmPercentagePrice, com.tools20022.repository.choice.PriceFormat48Choice.mmAmountPrice,
						com.tools20022.repository.choice.PriceFormat48Choice.mmAmountPricePerFinancialInstrumentQuantity, com.tools20022.repository.choice.PriceFormat48Choice.mmAmountPricePerAmount,
						com.tools20022.repository.choice.PriceFormat48Choice.mmIndexPoints);
	...
	public PriceFormat48Choice setPercentagePrice(PercentagePrice1 percentagePrice) {
	...
	public PriceFormat48Choice setAmountPrice(AmountPrice3 amountPrice) {
	...
	public PriceFormat48Choice setAmountPricePerFinancialInstrumentQuantity(AmountPricePerFinancialInstrumentQuantity6 amountPricePerFinancialInstrumentQuantity) {
	...
	public PriceFormat48Choice setAmountPricePerAmount(AmountPricePerAmount2 amountPricePerAmount) {
	...
	public PriceFormat48Choice setIndexPoints(DecimalNumber indexPoints) {
