...
public class RejectionOrRepairStatus29Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RejectionOrRepairStatus29Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RejectionOrRepairStatus29Choice.mmNoSpecifiedReason, RejectionOrRepairStatus29Choice.mmReason);
	...
	public void setReason(List<RejectionOrRepairReason23> reason) {
		this.reason = reason;
	}
}