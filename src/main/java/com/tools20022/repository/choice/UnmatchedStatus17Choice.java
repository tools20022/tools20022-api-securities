...
public class UnmatchedStatus17Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> UnmatchedStatus17Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(UnmatchedStatus17Choice.mmNoSpecifiedReason, UnmatchedStatus17Choice.mmReason);
	...
	public void setReason(List<UnmatchedReason16> reason) {
		this.reason = reason;
	}
}