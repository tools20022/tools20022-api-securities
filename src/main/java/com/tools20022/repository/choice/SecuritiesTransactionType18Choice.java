...
@XmlType(name = "SecuritiesTransactionType18Choice", propOrder = {"code", "proprietary"})
public class SecuritiesTransactionType18Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(SecuritiesTransactionType18Choice.mmCode, SecuritiesTransactionType18Choice.mmProprietary);
