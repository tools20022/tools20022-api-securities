...
@XmlType(name = "CentralCounterPartyEligibility4Choice", propOrder = {"indicator", "proprietary"})
public class CentralCounterPartyEligibility4Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CentralCounterPartyEligibility4Choice.mmIndicator, com.tools20022.repository.choice.CentralCounterPartyEligibility4Choice.mmProprietary);
				trace_lazy = () -> Settlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CentralCounterPartyEligibility4Choice";
	...
	public CentralCounterPartyEligibility4Choice setIndicator(YesNoIndicator indicator) {
	...
	public CentralCounterPartyEligibility4Choice setProprietary(GenericIdentification30 proprietary) {
