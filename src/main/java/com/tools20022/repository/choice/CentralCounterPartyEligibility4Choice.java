...
public class CentralCounterPartyEligibility4Choice {
	...
	public static final MMMessageAttribute mmIndicator = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> CentralCounterPartyEligibility4Choice.mmObject();
			isDerived = false;
			xmlTag = "Ind";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(CentralCounterPartyEligibility4Choice.mmIndicator, CentralCounterPartyEligibility4Choice.mmProprietary);
