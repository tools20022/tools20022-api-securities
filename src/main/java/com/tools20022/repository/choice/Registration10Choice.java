 ...
 * messageElement} =
 * <ul>
 * <li>{@linkplain com.tools20022.repository.choice.Registration10Choice#mmCode
...
@XmlType(name = "Registration10Choice", propOrder = {"code", "proprietary"})
public class Registration10Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.Registration10Choice.mmCode, com.tools20022.repository.choice.Registration10Choice.mmProprietary);
				trace_lazy = () -> BasicSecuritiesRegistration.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "Registration10Choice";
	...
	public Registration10Choice setCode(Registration2Code code) {
	...
	public Registration10Choice setProprietary(GenericIdentification30 proprietary) {
