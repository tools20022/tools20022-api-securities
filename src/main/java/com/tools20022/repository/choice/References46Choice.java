...
public class References46Choice {
	...
	public static final MMMessageAttribute mmSecuritiesSettlementTransactionIdentification = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> References46Choice.mmObject();
			isDerived = false;
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(References46Choice.mmSecuritiesSettlementTransactionIdentification, References46Choice.mmIntraPositionMovementIdentification,
						References46Choice.mmIntraBalanceMovementIdentification, References46Choice.mmAccountServicerTransactionIdentification, References46Choice.mmMarketInfrastructureTransactionIdentification,
						References46Choice.mmPoolIdentification, References46Choice.mmCommonIdentification, References46Choice.mmTradeIdentification, References46Choice.mmOtherTransactionIdentification);
