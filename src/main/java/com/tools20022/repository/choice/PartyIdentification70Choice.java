...
@XmlType(name = "PartyIdentification70Choice", propOrder = {"anyBIC", "proprietaryIdentification", "nameAndAddress"})
public class PartyIdentification70Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification70Choice, AnyBICIdentifier> mmAnyBIC = new MMMessageAttribute<PartyIdentification70Choice, AnyBICIdentifier>() {
		{
			businessElementTrace_lazy = () -> OrganisationIdentification.mmAnyBIC;
			componentContext_lazy = () -> com.tools20022.repository.choice.PartyIdentification70Choice.mmObject();
			isDerived = false;
			xmlTag = "AnyBIC";
		...
		@Override
		public AnyBICIdentifier getValue(PartyIdentification70Choice obj) {
			return obj.getAnyBIC();
		}

		@Override
		public void setValue(PartyIdentification70Choice obj, AnyBICIdentifier value) {
			obj.setAnyBIC(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification70Choice, GenericIdentification1> mmProprietaryIdentification = new MMMessageAttribute<PartyIdentification70Choice, GenericIdentification1>() {
		{
		...
		@Override
		public GenericIdentification1 getValue(PartyIdentification70Choice obj) {
			return obj.getProprietaryIdentification();
		}

		@Override
		public void setValue(PartyIdentification70Choice obj, GenericIdentification1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PartyIdentification70Choice, NameAndAddress5> mmNameAndAddress = new MMMessageAttribute<PartyIdentification70Choice, NameAndAddress5>() {
		{
		...
		@Override
		public NameAndAddress5 getValue(PartyIdentification70Choice obj) {
			return obj.getNameAndAddress();
		}

		@Override
		public void setValue(PartyIdentification70Choice obj, NameAndAddress5 value) {
	...
	public PartyIdentification70Choice setAnyBIC(AnyBICIdentifier anyBIC) {
	...
	public PartyIdentification70Choice setProprietaryIdentification(GenericIdentification1 proprietaryIdentification) {
	...
	public PartyIdentification70Choice setNameAndAddress(NameAndAddress5 nameAndAddress) {
