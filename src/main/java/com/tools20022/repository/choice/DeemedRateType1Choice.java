...
@XmlType(name = "DeemedRateType1Choice", propOrder = {"code", "proprietary"})
public class DeemedRateType1Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.DeemedRateType1Choice.mmCode, com.tools20022.repository.choice.DeemedRateType1Choice.mmProprietary);
				trace_lazy = () -> Tax.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "DeemedRateType1Choice";
	...
	public DeemedRateType1Choice setCode(DeemedRateType1Code code) {
	...
	public DeemedRateType1Choice setProprietary(GenericIdentification30 proprietary) {
