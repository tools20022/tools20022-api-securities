...
@XmlType(name = "PendingReason32Choice", propOrder = {"code", "proprietary"})
public class PendingReason32Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason32Choice, PendingReason4Code> mmCode = new MMMessageAttribute<PendingReason32Choice, PendingReason4Code>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason32Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public PendingReason4Code getValue(PendingReason32Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(PendingReason32Choice obj, PendingReason4Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<PendingReason32Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<PendingReason32Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> StatusReason.mmPendingReason;
			componentContext_lazy = () -> com.tools20022.repository.choice.PendingReason32Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification30 getValue(PendingReason32Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(PendingReason32Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.PendingReason32Choice.mmCode, com.tools20022.repository.choice.PendingReason32Choice.mmProprietary);
				trace_lazy = () -> CorporateActionStatusReason.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "PendingReason32Choice";
	...
	public PendingReason32Choice setCode(PendingReason4Code code) {
	...
	public PendingReason32Choice setProprietary(GenericIdentification30 proprietary) {
