...
@XmlType(name = "AutomaticBorrowing7Choice", propOrder = {"code", "proprietary"})
public class AutomaticBorrowing7Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AutomaticBorrowing7Choice, AutoBorrowing2Code> mmCode = new MMMessageAttribute<AutomaticBorrowing7Choice, AutoBorrowing2Code>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAutomaticBorrowing;
			componentContext_lazy = () -> com.tools20022.repository.choice.AutomaticBorrowing7Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
		...
		@Override
		public AutoBorrowing2Code getValue(AutomaticBorrowing7Choice obj) {
			return obj.getCode();
		}

		@Override
		public void setValue(AutomaticBorrowing7Choice obj, AutoBorrowing2Code value) {
			obj.setCode(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<AutomaticBorrowing7Choice, GenericIdentification30> mmProprietary = new MMMessageAttribute<AutomaticBorrowing7Choice, GenericIdentification30>() {
		{
			businessElementTrace_lazy = () -> SecuritiesSettlement.mmAutomaticBorrowing;
			componentContext_lazy = () -> com.tools20022.repository.choice.AutomaticBorrowing7Choice.mmObject();
			isDerived = false;
		...
		@Override
		public GenericIdentification30 getValue(AutomaticBorrowing7Choice obj) {
			return obj.getProprietary();
		}

		@Override
		public void setValue(AutomaticBorrowing7Choice obj, GenericIdentification30 value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.AutomaticBorrowing7Choice.mmCode, com.tools20022.repository.choice.AutomaticBorrowing7Choice.mmProprietary);
				trace_lazy = () -> SecuritiesSettlement.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "AutomaticBorrowing7Choice";
	...
	public AutomaticBorrowing7Choice setCode(AutoBorrowing2Code code) {
	...
	public AutomaticBorrowing7Choice setProprietary(GenericIdentification30 proprietary) {
