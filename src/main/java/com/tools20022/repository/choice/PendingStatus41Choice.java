...
public class PendingStatus41Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> PendingStatus41Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(PendingStatus41Choice.mmNoSpecifiedReason, PendingStatus41Choice.mmReason);
	...
	public void setReason(List<PendingStatusReason9> reason) {
		this.reason = reason;
	}
}