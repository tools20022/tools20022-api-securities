...
public class DeniedReason14Choice {
	...
	public static final MMMessageAttribute mmCode = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> DeniedReason14Choice.mmObject();
			isDerived = false;
			xmlTag = "Cd";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(DeniedReason14Choice.mmCode, DeniedReason14Choice.mmProprietary);
	...
	public void setCode(DeniedReason7Code code) {
		this.code = code;
	}
