...
public class RepairStatus13Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> RepairStatus13Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(RepairStatus13Choice.mmNoSpecifiedReason, RepairStatus13Choice.mmReason);
	...
	public void setReason(List<RepairReason9> reason) {
		this.reason = reason;
	}
}