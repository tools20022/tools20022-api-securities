...
public class FailingStatus9Choice {
	...
	public static final MMMessageAttribute mmNoSpecifiedReason = new MMMessageAttribute() {
		{
			...
			componentContext_lazy = () -> FailingStatus9Choice.mmObject();
			isDerived = false;
			xmlTag = "NoSpcfdRsn";
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(FailingStatus9Choice.mmNoSpecifiedReason, FailingStatus9Choice.mmReason);
	...
	public void setReason(List<FailingReason7> reason) {
		this.reason = reason;
	}
}