...
@XmlType(name = "GrossDividendRateFormat27Choice", propOrder = {"amount", "amountAndRateStatus", "rateTypeAndAmountAndRateStatus", "notSpecifiedRate"})
public class GrossDividendRateFormat27Choice {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GrossDividendRateFormat27Choice, ActiveCurrencyAnd13DecimalAmount> mmAmount = new MMMessageAttribute<GrossDividendRateFormat27Choice, ActiveCurrencyAnd13DecimalAmount>() {
		{
			businessElementTrace_lazy = () -> RateAndAmount.mmAmount;
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat27Choice.mmObject();
			isDerived = false;
			xmlTag = "Amt";
		...
		@Override
		public ActiveCurrencyAnd13DecimalAmount getValue(GrossDividendRateFormat27Choice obj) {
			return obj.getAmount();
		}

		@Override
		public void setValue(GrossDividendRateFormat27Choice obj, ActiveCurrencyAnd13DecimalAmount value) {
			obj.setAmount(value);
		}
	};
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat27Choice, AmountAndRateStatus1> mmAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat27Choice, AmountAndRateStatus1>() {
		{
		...
		@Override
		public AmountAndRateStatus1 getValue(GrossDividendRateFormat27Choice obj) {
			return obj.getAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat27Choice obj, AmountAndRateStatus1 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAssociationEnd<GrossDividendRateFormat27Choice, RateTypeAndAmountAndStatus38> mmRateTypeAndAmountAndRateStatus = new MMMessageAssociationEnd<GrossDividendRateFormat27Choice, RateTypeAndAmountAndStatus38>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat27Choice.mmObject();
			isDerived = false;
		...
		@Override
		public RateTypeAndAmountAndStatus38 getValue(GrossDividendRateFormat27Choice obj) {
			return obj.getRateTypeAndAmountAndRateStatus();
		}

		@Override
		public void setValue(GrossDividendRateFormat27Choice obj, RateTypeAndAmountAndStatus38 value) {
	 ...
	 * </ul>
	 */
	public static final MMMessageAttribute<GrossDividendRateFormat27Choice, RateType13Code> mmNotSpecifiedRate = new MMMessageAttribute<GrossDividendRateFormat27Choice, RateType13Code>() {
		{
			componentContext_lazy = () -> com.tools20022.repository.choice.GrossDividendRateFormat27Choice.mmObject();
			isDerived = false;
			xmlTag = "NotSpcfdRate";
		...
		@Override
		public RateType13Code getValue(GrossDividendRateFormat27Choice obj) {
			return obj.getNotSpecifiedRate();
		}

		@Override
		public void setValue(GrossDividendRateFormat27Choice obj, RateType13Code value) {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.GrossDividendRateFormat27Choice.mmAmount, com.tools20022.repository.choice.GrossDividendRateFormat27Choice.mmAmountAndRateStatus,
						com.tools20022.repository.choice.GrossDividendRateFormat27Choice.mmRateTypeAndAmountAndRateStatus, com.tools20022.repository.choice.GrossDividendRateFormat27Choice.mmNotSpecifiedRate);
				trace_lazy = () -> Dividend.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "GrossDividendRateFormat27Choice";
	...
	public GrossDividendRateFormat27Choice setAmount(ActiveCurrencyAnd13DecimalAmount amount) {
	...
	public GrossDividendRateFormat27Choice setAmountAndRateStatus(AmountAndRateStatus1 amountAndRateStatus) {
	...
	public GrossDividendRateFormat27Choice setRateTypeAndAmountAndRateStatus(RateTypeAndAmountAndStatus38 rateTypeAndAmountAndRateStatus) {
	...
	public GrossDividendRateFormat27Choice setNotSpecifiedRate(RateType13Code notSpecifiedRate) {
