...
@XmlType(name = "CorporateActionOption18Choice", propOrder = {"code", "proprietary"})
public class CorporateActionOption18Choice {
	...
	final static public MMChoiceComponent mmObject() {
		mmObject_lazy.compareAndSet(null, new MMChoiceComponent() {
			{
				messageElement_lazy = () -> Arrays.asList(com.tools20022.repository.choice.CorporateActionOption18Choice.mmCode, com.tools20022.repository.choice.CorporateActionOption18Choice.mmProprietary);
				trace_lazy = () -> CorporateActionOption.mmObject();
				dataDictionary_lazy = () -> GeneratedRepository.dataDict;
				registrationStatus = MMRegistrationStatus.REGISTERED;
				name = "CorporateActionOption18Choice";
	...
	public CorporateActionOption18Choice setCode(CorporateActionOption7Code code) {
	...
	public CorporateActionOption18Choice setProprietary(GenericIdentification30 proprietary) {
