...
import com.tools20022.repository.datatype.Max1Number.InternalXmlAdapter;
...
public class Max1Number {
	...
	public Max1Number(BigDecimal value) {
		this.value = value;
	}
	...
	protected static class InternalXmlAdapter extends XmlAdapter<BigDecimal, Max1Number> {
		@Override
		public Max1Number unmarshal(BigDecimal value) {
			return new Max1Number(value);
		}

		@Override
		public BigDecimal marshal(Max1Number typedData) {
